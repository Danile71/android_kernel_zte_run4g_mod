...
ifneq ($(filter rel_customer_operator%, $(MTK_RELEASE_PACKAGE)),)
  $(call dep-err-common, Please remove rel_customer_operator_* from MTK_RELEASE_PACKAGE)
endif
...
ifeq (yes,$(strip $(MTK_DX_HDCP_SUPPORT)))
  ...
  ifneq (yes, $(strip $(TRUSTONIC_TEE_SUPPORT)))
    $(call dep-err-ona-or-offb,TRUSTONIC_TEE_SUPPORT,MTK_DX_HDCP_SUPPORT)
  endif
endif
ifeq (yes,$(strip $(MTK_PLAYREADY_SUPPORT)))
  ifneq (yes, $(strip $(MTK_PERSIST_PARTITION_SUPPORT)))
...
#########################################################
ifneq ($(filter yes,$(MTK_DM_APP) $(MTK_DEVREG_APP)),)
  ifneq ($(strip $(MTK_DM_AGENT_SUPPORT)), yes)
    $(call dep-err-common, please set MTK_DM_APP and MTK_DEVREG_APP as no or set MTK_DM_AGENT_SUPPORT as yes)
  endif
endif
ifeq ($(strip $(MTK_DM_AGENT_SUPPORT)), yes)
  ifeq ($(filter yes,$(MTK_DM_APP) $(MTK_DEVREG_APP)),)
    $(call dep-err-common, please set MTK_DM_APP or MTK_DEVREG_APP as yes or set MTK_DM_AGENT_SUPPORT as no)
  endif
endif
...
ifeq (OP01_SPEC0200_SEGC,$(OPTR_SPEC_SEG_DEF))
  ifeq (yes, $(strip $(MTK_SIM_SWITCH)))
    ifneq (2,$(MTK_SIM_SWITCH_POLICY))
       $(call dep-err-common,pelease set MTK_SIM_SWITCH_POLICY as 2 when OPTR_SPEC_SEG_DEF=OP01_SPEC0200_SEGC and MTK_SIM_SWITCH=yes)
    endif
  endif
endif
ifeq (yes, $(strip $(MTK_SIM_SWITCH)))
  ifeq (2,$(MTK_SIM_SWITCH_POLICY))
    ifneq (yes,$(MTK_RILD_READ_IMSI))
       $(call dep-err-common,pelease set MTK_RILD_READ_IMSI as yes when MTK_SIM_SWITCH=yes and MTK_SIM_SWITCH_POLICY=2)
    endif
  endif
endif
#######################################################
ifeq (OP01_SPEC0200_SEGC,$(OPTR_SPEC_SEG_DEF))
  ifneq (yes, $(strip $(MTK_NFC_OMAAC_SUPPORT)))
    $(call dep-err-common,pelease turn on MTK_NFC_OMAAC_SUPPORT or set OPTR_SPEC_SEG_DEF as not OP01_SPEC0200_SEGC)
  endif
endif
#######################################################
ifeq (yes,$(strip $(MTK_VOICE_UNLOCK_SUPPORT)))
  ifeq (yes,$(strip $(MTK_VOW_SUPPORT)))
    $(call dep-err-common, please turn off MTK_VOICE_UNLOCK_SUPPORT or MTK_VOW_SUPPORT)
  endif
endif
#######################################################
ifeq (yes,$(strip $(MTK_SENSOR_HUB_SUPPORT)))
  ifeq (yes,$(strip $(MTK_VOW_SUPPORT)))
    $(call dep-err-common, please turn off MTK_SENSOR_HUB_SUPPORT or MTK_VOW_SUPPORT)
  endif
endif
#######################################################
ifeq (OP01_SPEC0200_SEGC,$(OPTR_SPEC_SEG_DEF))
  ifeq (yes, $(strip $(MTK_OPERAMAX_SUPPORT)))
    $(call dep-err-common,pelease set OPTR_SPEC_SEG_DEF as non OP01_SPEC0200_SEGC or set MTK_OPERAMAX_SUPPORT as no)
  endif
endif
...
ifeq ($(MTK_INTERNAL), no)
  ifeq ($(strip $(MTK_TABLET_HARDWARE)),mt8752)
    ifneq ($(strip $(MTK_PLATFORM_OPTIMIZE)),yes)
      $(call dep-err-common,please set MTK_PLATFORM_OPTIMIZE as yes when MTK_INTERNAL=no and MTK_TABLET_HARDWARE=mt8752)
    endif
  endif
endif
