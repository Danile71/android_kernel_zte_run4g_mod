...
#my $ChangeHistory = "3.7 TRUSTONIC TEE support\n";
#my $ChangeHistory = "3.8 PlayReady HDCP support\n";
#my $ChangeHistory = "3.9 DRM Key mamagement support\n";
...
{
    #EMMC LK fastboot partition move to alps\mediatek\platform\mt6752\lk\include\platform\partition_fastboot.h
    &GenLK_PartitionC();
