...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl \
                      $(MTK_ROOT_CONFIG_OUT)/init.mt6752.rc:root/init.mt6752.rc \
...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/init.volte.rc:root/init.volte.rc 
endif

ifeq ($(MTK_LOSSLESS_BT_AUDIO_SUPPORT),yes)
PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_policy.conf:system/etc/audio_policy.conf 
else
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/audio_policy.conf:system/etc/audio_policy.conf 
endif
