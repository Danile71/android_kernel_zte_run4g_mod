...
#define STK8BA50_I2C_SLAVE_ADDR		0x30 
...
/*----------------------------------------------------------------------------*/
typedef enum{
    STK8BA50_CUST_ACTION_SET_CUST = 1,
    STK8BA50_CUST_ACTION_SET_CALI,
    STK8BA50_CUST_ACTION_RESET_CALI
}CUST_ACTION;
/*----------------------------------------------------------------------------*/
typedef struct
{
...
{
    uint16_t    action;
    int32_t     data[STK8BA50_AXES_NUM];
}STK8BA50_SET_CALI;
/*----------------------------------------------------------------------------*/
typedef STK8BA50_CUST STK8BA50_RESET_CALI;
/*----------------------------------------------------------------------------*/
typedef union
{
    uint32_t                data[10];
    STK8BA50_CUST         cust;
    STK8BA50_SET_CUST     setCust;
    STK8BA50_SET_CALI     setCali;
    STK8BA50_RESET_CALI   resetCali;
}STK8BA50_CUST_DATA;	 
#endif
