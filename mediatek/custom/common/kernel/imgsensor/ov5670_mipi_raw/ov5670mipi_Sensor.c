...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0302, 0x64); //;78
	...
	write_cmos_sensor(0x380c, 0x07); // ;06
	write_cmos_sensor(0x380d, 0xdc); // ;8c
	...
	write_cmos_sensor(0x4837, 0x14); // ;11
