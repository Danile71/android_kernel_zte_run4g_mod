...
#endif //CUSTOM_KERNEL_IN_POCKET_SENSOR
...
#endif //CUSTOM_KERNEL_ACTIVITY_SENSOR
...
#endif //CUSTOM_KERNEL_SHAKE_SENSOR
...
#endif //CUSTOM_KERNEL_PICK_UP_SENSOR
...
#endif //CUSTOM_KERNEL_FACE_DOWN_SENSOR
...
#endif //#ifdef CUSTOM_KERNEL_IN_POCKET_SENSOR
#ifdef CUSTOM_KERNEL_PEDOMETER
...
#endif //#ifdef CUSTOM_KERNEL_PEDOMETER
#ifdef CUSTOM_KERNEL_ACTIVITY_SENSOR
...
#endif //#ifdef CUSTOM_KERNEL_ACTIVITY_SENSOR
#ifdef CUSTOM_KERNEL_SHAKE_SENSOR
...
#endif //#ifdef CUSTOM_KERNEL_SHAKE_SENSOR
#ifdef CUSTOM_KERNEL_PICK_UP_SENSOR
...
#endif //#ifdef CUSTOM_KERNEL_PICK_UP_SENSOR
#ifdef CUSTOM_KERNEL_FACE_DOWN_SENSOR
...
#endif //#ifdef CUSTOM_KERNEL_FACE_DOWN_SENSOR
...
static int SCP_sensorHub_ReadSensorData(int handle, hwm_sensor_data *sensorData)
{
	...
	//{
	    ...
	    if (rp != wp)
	    {
            ...
            //SCP_LOG("sensorData = %p, curData = %p\n", sensorData, curData);
            //SCP_LOG("curData.data[0] = %d, curData.data[1] = %d, curData.data[2] = %d\n", sensorData->values[0], sensorData->values[1], sensorData->values[2]);
    ...
    switch (sensorType)
    {
        ...
        case ID_ACTIVITY://there are 6 values in activity
            ...
            *(req.get_data_rsp.int16_Data+3),  *(req.get_data_rsp.int16_Data+4), *(req.get_data_rsp.int16_Data+5));
            SCP_LOG("ID_ACTIVITY 64, value=%d value1=%d value2=%d value3=%d value4=%d value5=%d\n", 
        ...
        case SENSOR_HUB_NOTIFY:
            ...
            switch(rsp->notify_rsp.event)
            {
                case SCP_NOTIFY:
                    ...
                    else if (ID_PICK_UP == rsp->notify_rsp.sensorType)
                    {
...
static int pkup_open_report_data(int open)
{
    ...
    return SCP_sensor_enable(ID_PICK_UP, open);
}
static int pkup_get_data(u16 *value , int *status)
{
    ...
    return SCP_sensor_get_data16(ID_PICK_UP, value, status);
}
static int SCP_sensorHub_pick_up_init()
{
    ...
    SCP_sensorHub_rsp_registration(ID_PICK_UP, SCP_sensorHub_notify_handler);
    return 0;
}
