...
#define PRINTF_EMERG(fmt, ...)  printk(KERN_EMERG "MSTARTP " pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_ALERT(fmt, ...)  printk(KERN_ALERT "MSTARTP " pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_CRIT(fmt, ...)   printk(KERN_CRIT "MSTARTP " pr_fmt(fmt), ##__VA_ARGS__) 
#define PRINTF_ERR(fmt, ...)    printk(KERN_ERR "MSTARTP " pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_WARN(fmt, ...)   printk(KERN_WARNING "MSTARTP " pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_NOTICE(fmt, ...) printk(KERN_NOTICE "MSTARTP " pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_INFO(fmt, ...)   printk(KERN_INFO "MSTARTP " pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_DEBUG(fmt, ...)  printk(KERN_DEBUG "MSTARTP " pr_fmt(fmt), ##__VA_ARGS__) 
