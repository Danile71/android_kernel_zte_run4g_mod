...
static MUINT32 cycleCtr_Main = -1;

WorkPerCycle getWorkPerCycle_Main_M1() //M = fps/30 = 1, -> 30 fps
{
    ...
    cycleCtr_Main = (cycleCtr_Main+1)%M1_CYCLE_NUM;
    return WPC_M1[cycleCtr_Main];    
}

WorkPerCycle getWorkPerCycle_Main_M2() //M = fps/30 = 2, -> 60 fps
{
    ...
    cycleCtr_Main = (cycleCtr_Main+1)%M2_CYCLE_NUM;
    return WPC_M2[cycleCtr_Main];    
}

WorkPerCycle getWorkPerCycle_Main_M3() //M = fps/30 = 3, -> 90 fps
{
    ...
    cycleCtr_Main = (cycleCtr_Main+1)%M3_CYCLE_NUM;
    return WPC_M3[cycleCtr_Main];    
}

WorkPerCycle getWorkPerCycle_Main_M4() //M = fps/30 = 4, -> 120 fps
{
    ...
    cycleCtr_Main = (cycleCtr_Main+1)%M4_CYCLE_NUM;
    return WPC_M4[cycleCtr_Main];    
}

WorkPerCycle getWorkPerCycle_Main_M5() //M = fps/30 = 5, -> 150 fps
{
    ...
    cycleCtr_Main = (cycleCtr_Main+1)%M5_CYCLE_NUM;
    return WPC_M5[cycleCtr_Main];    
}

WorkPerCycle getWorkPerCycle_Main_M6() //M = fps/30 = 6, -> 180 fps
{
    ...
    cycleCtr_Main = (cycleCtr_Main+1)%M6_CYCLE_NUM;
    return WPC_M6[cycleCtr_Main];    
}




WorkPerCycle getWorkPerCycle_Main(int normalizeM) // M = fps/30
{
    typedef WorkPerCycle(*FUNC_PTR)(); 
    static FUNC_PTR arr[MAX_FRAME_PER_CYCLE] = 
    {
        getWorkPerCycle_Main_M1, //for 30 fps
        getWorkPerCycle_Main_M2, //for 60 fps
        getWorkPerCycle_Main_M3, //for 90 fps
        getWorkPerCycle_Main_M4, //for 120 fps
        getWorkPerCycle_Main_M5, //for 150 fps
        getWorkPerCycle_Main_M6  //for 180 fps
    };
