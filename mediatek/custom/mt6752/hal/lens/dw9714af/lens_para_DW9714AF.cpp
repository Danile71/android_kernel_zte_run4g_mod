...
const NVRAM_LENS_PARA_STRUCT DW9714AF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
        ...
        {1,                                       // FV 0:disable, 1:enable
         0,100000,{ 40, 40, 30}, { 25, 20, 15},   //    chg; chgT lower to sensitive, chgN bigger to stable   
        ...
        // video params
        {1,                                       // vdo FV
         0,100000,{ 40, 40, 30}, { 30, 25, 25},   //    chg; chgT lower to sensitive, chgN bigger to stable   
