...
const NVRAM_LENS_PARA_STRUCT GAF001AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // AF NVRAM
    {
        ...
        {1,                                       // FV 0:disable, 1:enable
         ...
         1, 50000, { 25, 25, 25}, { 20, 15, 10} },//    stb; stbT should fix, stbN bigger to stable         
...
UINT32 GAF001AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &GAF001AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pGAF001AF_getDefaultData = GAF001AF_getDefaultData;
