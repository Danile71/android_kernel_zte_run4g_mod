...
const NVRAM_LENS_PARA_STRUCT GAF002AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 GAF002AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &GAF002AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pGAF002AF_getDefaultData = GAF002AF_getDefaultData;
