...
const NVRAM_LENS_PARA_STRUCT LC898122AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // AF NVRAM
    {
        ...
        {1,                                       // FV 0:disable, 1:enable
         0,  100, { 40, 40, 30}, { 10, 5, 5},     //    chg; chgT lower to sensitive, chgN bigger to stable   
...
UINT32 LC898122AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &LC898122AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pLC898122AF_getDefaultData = LC898122AF_getDefaultData;
