...
#define PFX "OV8865_camera_sensor_"
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.cap1 = {//24fps 600M bps/lane
		...
		.grabwindow_height = 2448,
		.mipi_data_lp2hs_settle_dc = 23,
		.max_framerate = 234,	//less than 13M(include 13M),cap1 max framerate is 24fps,16M max framerate is 20fps, 20M max framerate is 15fps  
	},
	.normal_video = {
		.pclk = 148800000,
