...
bool AudioCompensationFilter::Init(void)
{
    ...
    //enable overlap
    if(eFilterType == AUDIO_COMP_FLT_AUDIO)//For DRC effect
        mpBloudHandle->bEnableOLA = 0;
    else
...
void AudioCompensationFilter::LoadACFParameter()
{
    ...
    ALOGE("Error: The module doesn't support Besloudness V5");
//for compile success
