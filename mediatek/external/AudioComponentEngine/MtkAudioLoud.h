...
class MtkAudioLoud : public AudioComponentEngineBase
{
    public:
        ...
        ACE_ERRID SetOutputGain(int32_t gain, uint32_t ramp_sample_cnt);
        ACE_ERRID SetNotchFilterParam(uint32_t fc, uint32_t bw, int32_t th);
    ...
    private:
        ...
        int BLOUD_HD_Get_Sampling_Rate_Index(unsigned int sampling_rate);
