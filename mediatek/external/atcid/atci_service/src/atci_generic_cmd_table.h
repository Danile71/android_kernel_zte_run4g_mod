...
#ifdef ENABLE_BLUETOOTH_AT_CMD
#include "atci_bt_cmd.h"
#endif
...
#ifdef ENABLE_BLUETOOTH_AT_CMD
        {"AT%BTAD", AT_ACTION_OP | AT_READ_OP | AT_TEST_OP | AT_SET_OP,bt_btad_cmd_handler},
...
static mmi_cmd_type mmi_cmd_table[] = {
        ...
        {"AT%FMR", AT_ACTION_OP | AT_READ_OP | AT_TEST_OP | AT_SET_OP},
        ...
        {"AT+CKPD", AT_TEST_OP | AT_SET_OP},
//        {"AT%BTAD", AT_ACTION_OP | AT_READ_OP | AT_TEST_OP | AT_SET_OP},
//        {"AT%BTTM", AT_ACTION_OP | AT_READ_OP | AT_TEST_OP | AT_SET_OP},
        {"AT+CPMS", AT_READ_OP | AT_TEST_OP | AT_SET_OP},
        {"AT+CMSS", AT_TEST_OP | AT_SET_OP},
        {"AT+CMGL", AT_ACTION_OP | AT_READ_OP | AT_TEST_OP | AT_SET_OP},
        {"AT+CMGR", AT_ACTION_OP | AT_READ_OP | AT_TEST_OP | AT_SET_OP},
        {"AT+CMGF", AT_READ_OP | AT_TEST_OP | AT_SET_OP},
        {"AT+DATACONNECT", AT_READ_OP | AT_TEST_OP | AT_SET_OP},
    };
