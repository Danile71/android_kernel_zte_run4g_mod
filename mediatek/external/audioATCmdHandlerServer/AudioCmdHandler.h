...
class AudioCmdHandler : public MediaPlayerListener
{
    public:
		...
		ACHStatus DLCustSPHMagiParamToNV(void *pParam);
		ACHStatus ULCustSPHMagiParamFromNV(void *pParam, int *len);
		ACHStatus DLCustSPHHACParamToNV(void *pParam);
		ACHStatus ULCustSPHHACParamFromNV(void *pParam, int *len);
...
#else
        ACHStatus DLCustAudioFLTParamToNV(void *pParam,AudioFltTunningType eFLTID);
        ACHStatus ULCustAudioFLTParamFromNV(void *pParam, int *len,AudioFltTunningType eFLTID);
#endif
