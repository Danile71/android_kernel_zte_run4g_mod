...
const bt_config_item g_config_table[] = {
    ...
    **********************************************/    
	...
	/* element 1: rfcomm channel, default 25*/
	...
	/* element 1: rfcomm channel, default 26*/
	...
	/* element 3: remote volumne control, supported(1)/ unsupported(0), default unsupported*/
    {
	   ...
	   /*PBAP PCE SDP settings: */
	/* element 0: enable(1)/disale(0) PBAP PCE sdp registration*/
	/* element 1: PBAP PCE version, default Ver1.0*/
    {
    	.name = "pcesdp",
		.value = (void*)(unsigned short[]){0x0000, 
											0x0100},
    ...
    /*SPP SDP settings: */
	/* element 0: enable(1)/disale(0) SPP sdp registration*/
	/* element 1: rfcomm channel, default 27*/
	/* element 2: SPP version, default Ver1.0*/
    {
    	.name = "sppsdp",
		.value = (void*)(unsigned short[]){0x0000, 
											0x001b,
    ...
    /*PSE SDP settings: */
	/* element 0: enable(1)/disale(0) pse customization*/
	/* element 1: PSE version, defautlt 1.1(0x0101)*/
	/* element 2: repositories, default Phone local(0x0001)*/
    {
    	.name = "psesdp",
		.value = (void*)(unsigned short[]){0x0000, 
											0x0101,
    ...
    /*MSE SDP settings: */
	/* element 0: enable(1)/disale(0) MSE customization*/
	/* element 1: MAP version, default 1.1(0x0101)*/
	/* element 2: supported message type, default(GSM/CDMA/MMS)*/
    {
    	.name = "msesdp",
		.value = (void*)(unsigned short[]){0x0000, 
											0x0101,
