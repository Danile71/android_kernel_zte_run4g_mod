...
static BtStatus GORMcmd_HCC_Set_Controllor_SysLmp_Log(void);
static BtStatus GORMcmd_HCC_Set_Controllor_Log_Mask(void);
...
defined(MTK_CONSYS_MT6592) || defined(MTK_CONSYS_MT6571) || defined(MTK_CONSYS_MT6752) || \
...
{    
    ...
    {  GORMcmd_HCC_Set_Controllor_SysLmp_Log},/*0xFCBE*/
    {  GORMcmd_HCC_Set_Controllor_Log_Mask},  /*0xFC5F*/
    {  0  },
};
#endif
...
#if defined(MTK_TC1_FEATURE)
    unsigned char LGE_Security_Area_Default_BDaddr_1[6] = 
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    unsigned char LGE_Security_Area_Default_BDaddr_2[6] = 
        {0x00, 0x05, 0xc9, 0x00, 0x00, 0x00};
    unsigned char LGE_Security_Area_Default_BDaddr_3[6] = 
        {0x00, 0x00, 0x00, 0xc9, 0x05, 0x00};
    unsigned char MISC2_BDaddr[6] = {0};
#endif
...
#if defined(MTK_TC1_FEATURE)
    if(!TC1_FAC_NAME(FacReadBtAddr(MISC2_BDaddr))){
        LOG_ERR("Read BD address from LGE partition fails!\n");
        goto Check_NVRAM;
    }
    
    if ((0 == memcmp(MISC2_BDaddr, LGE_Security_Area_Default_BDaddr_1, 6)) 
        || (0 == memcmp(MISC2_BDaddr, LGE_Security_Area_Default_BDaddr_2, 6)) 
        || (0 == memcmp(MISC2_BDaddr, LGE_Security_Area_Default_BDaddr_3, 6)) 
        || (0 == memcmp(MISC2_BDaddr, ucDefaultAddr, 6))){
        LOG_WAN("LGE partition BD address default value\n");
        goto Check_NVRAM;
    }
    else {
        LOG_WAN("LGE partition BD address has valid value\n");
        btinit->bt_nvram.fields.addr[0] = MISC2_BDaddr[0];
        btinit->bt_nvram.fields.addr[1] = MISC2_BDaddr[1];
        btinit->bt_nvram.fields.addr[2] = MISC2_BDaddr[2];
        btinit->bt_nvram.fields.addr[3] = MISC2_BDaddr[3];
        btinit->bt_nvram.fields.addr[4] = MISC2_BDaddr[4];
        btinit->bt_nvram.fields.addr[5] = MISC2_BDaddr[5];
        goto Set_BD_Addr;
    }
#endif
...
static BtStatus GORMcmd_HCC_Set_Controllor_SysLmp_Log(void)
{
    char VirtualSniffVal[PROPERTY_VALUE_MAX];
    char ContDebugLogVal[PROPERTY_VALUE_MAX];

    if((property_get("persist.bt.contdebuglog", ContDebugLogVal, 0) > 0) && (ContDebugLogVal[0] != '0')){
        
        hciCommand.opCode = 0xFCBE; 
        hciCommand.len = 1;
        hciCommand.parms[0] = 0x05; //parameter 05£º enable sys log & lmp log
        
        LOG_DBG("GORMcmd_HCC_Set_Controllor_SysLmp_Log\n");
        ...
        LOG_DBG("GORMcmd_HCC_Set_Controllor_SysLmp_Log: cancelled\n");
...
static BtStatus GORMcmd_HCC_Set_Controllor_Log_Mask(void)
{
    ...
    if((property_get("persist.bt.contdebuglog", ContDebugLogVal, 0) > 0) && (ContDebugLogVal[0] != '0')){
        ...
        hciCommand.opCode = 0xFC5F; 
        hciCommand.len = 0x2A; //42
        
        hciCommand.parms[0]  = 0x50; //parameter£º log group masks
        hciCommand.parms[1]  = 0x01;        
        hciCommand.parms[2]  = 0x09;
        hciCommand.parms[3]  = 0x00;
        hciCommand.parms[4]  = 0x00;
        hciCommand.parms[5]  = 0x00;
        hciCommand.parms[6]  = 0x01;
        hciCommand.parms[7]  = 0x00;
        hciCommand.parms[8]  = 0x00;
        hciCommand.parms[9]  = 0x00;
        ...
        hciCommand.parms[12] = 0x00;
        hciCommand.parms[13] = 0x00;
        hciCommand.parms[14] = 0x01;
        hciCommand.parms[15] = 0x00;
        hciCommand.parms[16] = 0x00;
        hciCommand.parms[17] = 0x00;
        hciCommand.parms[18] = 0x01;
        hciCommand.parms[19] = 0x00;
                              
        hciCommand.parms[20] = 0x00;
        hciCommand.parms[21] = 0x00;
        hciCommand.parms[22] = 0x01;
        hciCommand.parms[23] = 0x00;
        hciCommand.parms[24] = 0x00;
        hciCommand.parms[25] = 0x00;
        hciCommand.parms[26] = 0x01;
        hciCommand.parms[27] = 0x00;
        hciCommand.parms[28] = 0x00;
        hciCommand.parms[29] = 0x00;
        
        hciCommand.parms[30] = 0x01;
        hciCommand.parms[31] = 0x00;
        hciCommand.parms[32] = 0x01;
        hciCommand.parms[33] = 0x00;
        hciCommand.parms[34] = 0x03;
        hciCommand.parms[35] = 0x38;
        hciCommand.parms[36] = 0x00;
        hciCommand.parms[37] = 0x00;
        hciCommand.parms[38] = 0x01;
        hciCommand.parms[39] = 0x00;
        
        hciCommand.parms[40] = 0x00;
        hciCommand.parms[41] = 0x00;
        
        LOG_DBG("GORMcmd_HCC_Set_Controllor_Log_Mask\n");
        ...
        LOG_DBG("GORMcmd_HCC_Set_Controllor_Log_Mask: cancelled\n");
