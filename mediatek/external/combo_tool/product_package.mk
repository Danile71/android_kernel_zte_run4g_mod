...
$(warning building MT6630)

ifneq ($(filter mt6630_ant_m1,$(CUSTOM_HAL_ANT)),)
$(warning building mt6630_ant_m1)
...
$(warning building mt6630_ant_m2)    
...
$(warning building mt6630_ant_m3)       
...
$(warning building SOC_CONSYS_6571)

ifneq ($(filter mt6571_ant_m1,$(CUSTOM_HAL_ANT)),)
$(warning building SOC_CONSYS ant mode)
    PRODUCT_COPY_FILES += $(cfg_folder)/WMT_SOC.cfg:system/etc/firmware/WMT_SOC.cfg
endif  

$(warning building mt6571_patch_e1_hdr) 
    PRODUCT_COPY_FILES += $(patch_folder)/mt6571_patch_e1_0_hdr.bin:system/etc/firmware/mt6571_patch_e1_0_hdr.bin
    PRODUCT_COPY_FILES += $(patch_folder)/mt6571_patch_e1_1_hdr.bin:system/etc/firmware/mt6571_patch_e1_1_hdr.bin
    
$(warning building SOC_CONSYS finished)
endif

ifeq ($(BUILD_MT6752_CONSYS), true)
$(warning building SOC_CONSYS_6752)

ifneq ($(filter mt6752_ant_m1,$(CUSTOM_HAL_ANT)),)
$(warning building SOC_CONSYS ant mode)
    PRODUCT_COPY_FILES += $(cfg_folder)/WMT_SOC.cfg:system/etc/firmware/WMT_SOC.cfg
endif  

$(warning building mt6571_lm_patch_e1_hdr) 
    PRODUCT_COPY_FILES += $(patch_folder)/mt6571_lm_patch_e1_0_hdr.bin:system/etc/firmware/mt6571_lm_patch_e1_0_hdr.bin
    PRODUCT_COPY_FILES += $(patch_folder)/mt6571_lm_patch_e1_1_hdr.bin:system/etc/firmware/mt6571_lm_patch_e1_1_hdr.bin
...
ifeq ($(ADD_MT6571), true)
  PRODUCT_PACKAGES += mt6571_patch_e1_0_hdr.bin \
                      mt6571_patch_e1_1_hdr.bin \
                      WMT_SOC.cfg
endif

ifeq ($(ADD_MT6752), true)
  PRODUCT_PACKAGES += mt6571_lm_patch_e1_0_hdr.bin \
                      mt6571_lm_patch_e1_1_hdr.bin \
                      WMT_SOC.cfg
endif
