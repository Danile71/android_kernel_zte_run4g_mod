...
int cmd_hdr_sch_patch (P_STP_PARAMS_CONFIG pStpParamsConfig)
{
    ...
    if (gWmtFd > 0)
    {
        ...
        if((!strcmp(chipName,"mt6620")) || (!strcmp(chipName,"mt6628")) || 
			(!strcmp(chipName,"mt6572")) || (!strcmp(chipName,"mt6582")) || (!strcmp(chipName,"mt8127")) || (!strcmp(chipName,"mt6592")) ||
			(!strcmp(chipName,"mt6571")) || (!strcmp(chipName,"mt6752")))
        {
        	if((!strcmp(chipName,"mt6572")) || (!strcmp(chipName,"mt6582")) || (!strcmp(chipName,"mt6592")))
        	{
        		strncpy(chipName,"mt6572_82",strlen("mt6572_82"));
        	}else if(!strcmp(chipName,"mt8127")){
				strncpy(chipName,"mt6571",strlen("mt6571"));
			}else if(!strcmp(chipName,"mt6752")){
				strncpy(chipName,"mt6571_lm",strlen("mt6571_lm"));
			}
        	strcat (chipName, "_patch");
...
int main(int argc, char *argv[])
{
	...
	do{
	    ...
	    if (gWmtFd < 0) {
	        ALOGI("Can't open device node(%s) \n", CUST_COMBO_WMT_DEV);
	        usleep(300000);
	    }
		else
			break;
	...
	if((0x6752 == chipId)|| (0x6582 == chipId) || (0x6592 == chipId) || (0x6572 == chipId) || (0x6571 == chipId) || (0x8127 == chipId))
	{
