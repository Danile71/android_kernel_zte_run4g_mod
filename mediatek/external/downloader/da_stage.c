...
* .
*
* 05 13 2013 monster.huang
* [STP100006993]  [FlashTool] v5.1316/v5.1318 maintenance
* [BROM_Lite]
* 1. Add more logs
* 2. Reduce the interval of reading to avoid failing the brom connection
*
...
*
* 04 19 2013 monster.huang
* [STP100006902]  [FlashTool] v5.1312/v5.1314 maintenance
* Fix for setting reset flag.
*
