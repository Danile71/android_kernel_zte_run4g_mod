...
int main(void)
{
    ...
    }
    {
        ...
        capture_buffer_size_align = capture_buffer_size + 64; //for M4U 32-byte alignment
        ...
        base = (void *)((unsigned long)base_align + 64 - ((unsigned long)base_align & 0x3F)); //for M4U 32-byte alignment
