...
void fill_animation_logo(unsigned int index, void *fill_addr, void * dec_logo_addr, void * logo_addr, LCM_SCREEN_T phical_screen)
{
    ...
    fill_rect_with_content(fill_addr, rect, (unsigned int *)dec_logo_addr, phical_screen);
...
void fill_animation_dynamic(unsigned int index, RECT_REGION_T rect, void *fill_addr, void * dec_logo_addr, void * logo_addr, LCM_SCREEN_T phical_screen)
{
    ...
    decompress_logo((void*)logo_info.inaddr, (void*)dec_logo_addr, logo_info.logolen, (rect.right-rect.left)*(rect.bottom-rect.top)*4);
    fill_rect_with_content(fill_addr, rect, (unsigned int *)dec_logo_addr, phical_screen);            
}
...
void fill_animation_number(unsigned int index, unsigned int number_position, void *fill_addr,  void * logo_addr, LCM_SCREEN_T phical_screen)
{
    ...
    fill_rect_with_content(fill_addr, battery_number_rect, (unsigned int *)number_pic_addr,phical_screen);            
}
...
{    
    ...
    {      
        rect.top = i;
        rect.bottom = i+1;                                             
        fill_rect_with_content(fill_addr, rect, (unsigned int *)line_pic_addr, phical_screen);
