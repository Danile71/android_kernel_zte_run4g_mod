...
private:
	...
	Frame *decodeLTEFrame(unsigned int input_len,unsigned char * src,unsigned char frmType,unsigned short &u16Length);
	Frame *sendFtTask();
...
private:
	...
	MODEM_CAPABILITY_LIST_CNF ft_modem_cap_list;
};
