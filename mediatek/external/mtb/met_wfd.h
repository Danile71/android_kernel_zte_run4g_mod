...
int32_t met_wfd_init(tracer_handle_t self) {return 0;}
int32_t met_wfd_begin(tracer_handle_t self, const char *name, uint32_t pid) {return 0;}
int32_t met_wfd_end(tracer_handle_t self, const char* name, uint32_t pid) {return 0;}
int32_t met_wfd_oneshot(tracer_handle_t self, uint32_t type, const char *name, uint32_t pid) {return 0;}
