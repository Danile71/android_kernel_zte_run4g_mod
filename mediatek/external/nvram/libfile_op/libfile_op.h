...
//!!!be careful here. for MT6575/77, even there is 3 fileds shoud be subtracted, but for structure aligment reason, just only set ofset is 2
//!!!for co-branch reason, later fields shoud add be more careful.
