...
//WMAFORMAT
#ifndef __WMAPROFMT_COM_H__
#define __WMAPROFMT_COM_H__

#pragma pack (push)
#pragma pack () // default
typedef struct _WMAPROFormat {
    WMA_U16 wFormatTag;
    WMA_U16 nChannels;
    WMA_U32 nSamplesPerSec;
...
#ifndef __WMAProRawDecHandle_COM_H__
#define __WMAProRawDecHandle_COM_H__
...
#ifndef __WMAProRawDecInitParams_COM_H__
#define __WMAProRawDecInitParams_COM_H__
...
WMARESULT WMAProRawDecInit (
    ...
    WMAPROFormat* pWMAFormat,               // [in] WMAFormat for input WMA files
...
// **************************************************************************
// WMAProGetVersion()
// This function get the code version
//
// Return values
// the code version
// **************************************************************************
WMA_I32 WMAProGetVersion();
...
WMA_VOID WMAProWMAFormat2PCMFormat(
	WMAPROFormat* pSrc,                     // [in] WMAFormat
...
void WMAProWaveFormat2WMAFormat(WAVEFORMATEX* wfx, WMAPROFormat* wmafmt);
#endif
...
// **************************************************************************
// WMAProGetWorkingBufferSize()
// this function return required buffer size
//
// Return values
// buffer size
// **************************************************************************
WMA_U32 WMAProGetWorkingBufferSize();
