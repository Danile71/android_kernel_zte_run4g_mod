...
private :
	...
	// this API is added by mtk94010 for android api error
	size_t mywcslen(const wchar_t *src);
	size_t mywcsrtombs(char *dst, const wchar_t **src, size_t len);
	size_t mymbsrtowcs(wchar_t *dst, const char **src, size_t len);
};
