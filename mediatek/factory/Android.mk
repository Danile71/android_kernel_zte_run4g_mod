...
ifeq ($(MTK_ALPS_BOX_TVE_SUPPORT), yes)
TEST_SRC_FILES += \
  src/test/ftm_cvbs.c
endif
...
ifeq ($(MTK_ALPS_BOX_TVE_SUPPORT), yes)
	LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/kernel/drivers/tve
endif
...
LOCAL_SHARED_LIBRARIES:= libc libcutils libnvram libdl libhwm libaudiocustparam libext4_utils libfile_op libmmfactoryutil
## hotknot start
ifeq ($(strip $(MTK_HOTKNOT_SUPPORT)), yes)
