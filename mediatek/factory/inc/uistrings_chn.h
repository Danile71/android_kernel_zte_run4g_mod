...
#define uistr_info_emergency_call_success_in_modem			 "拨打112成功 in modem"
#define uistr_info_emergency_call_fail_in_modem			 "拨打112失败 in modem"
...
#define uistr_info_title_ext_buck_connect "连接"
#define uistr_info_title_ext_buck_no_connect "未连接"

/* ext vbat boost */
#define uistr_info_title_ext_vbat_boost_item "EXT VBAT BOOST"
#define uistr_info_title_ext_vbat_boost_chip "EXT VBAT BOOST"
#define uistr_info_title_ext_vbat_boost_connect "连接"
#define uistr_info_title_ext_vbat_boost_no_connect "未连接"
...
/* FM Transmitter */
#define uistr_info_fmt_title                "FM发射器"
...
#define uistr_info_hotknot_info						"再次执行传输以退出"
