...
//#ifdef RECEIVER_HEADSET_AUTOTEST
int headset_auto_entry(struct ftm_param *param, void *priv)
{
    char *ptr;
    int chosen;
    bool exit = false;
...
//#else
int headset_manual_entry(struct ftm_param *param, void *priv)
{
    char *ptr;
    int chosen;
    bool exit = false;
...
int headset_entry(struct ftm_param *param, void *priv)
{
    ...
    if (pTestType != NULL )
    {
        ...
        headset_manual_entry(param, priv);
    }
    else
    {
        headset_auto_entry(param, priv);
    }
