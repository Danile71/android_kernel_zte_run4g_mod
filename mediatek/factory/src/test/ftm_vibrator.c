...
//bool Keep_vibrator_write_data_exit = false;
static pthread_t vibrator_write_data_thread;

static void *keep_vibrator_write_data_thread(void *priv)
{
     while (1) {
        char *ptr;
    ...
    LOGD("keep_vibrator_write_data_thread Thread Exit \n");
...
static void *update_vibrator_thread_vibspk(void *mPtr)
{
    ...
    pthread_create(&vibrator_write_data_thread, NULL, keep_vibrator_write_data_thread, mPtr);
    ...
    pthread_join(vibrator_write_data_thread, NULL);
