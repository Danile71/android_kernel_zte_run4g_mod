...
#define IW_MODUL_ALL		0x00000000	
#define IW_MODUL_FH		0x00000001	
#define IW_MODUL_DS		0x00000002	
#define IW_MODUL_CCK		0x00000004	
#define IW_MODUL_11B		(IW_MODUL_DS | IW_MODUL_CCK)
#define IW_MODUL_PBCC		0x00000008	
#define IW_MODUL_OFDM_A		0x00000010	
#define IW_MODUL_11A		(IW_MODUL_OFDM_A)
#define IW_MODUL_11AB		(IW_MODUL_11B | IW_MODUL_11A)
#define IW_MODUL_OFDM_G		0x00000020	
#define IW_MODUL_11G		(IW_MODUL_11B | IW_MODUL_OFDM_G)
#define IW_MODUL_11AG		(IW_MODUL_11G | IW_MODUL_11A)
#define IW_MODUL_TURBO		0x00000040	

#define IW_MODUL_CUSTOM		0x40000000	

#define IW_BITRATE_TYPE		0x00FF	
#define IW_BITRATE_UNICAST	0x0001	
#define IW_BITRATE_BROADCAST	0x0002	
