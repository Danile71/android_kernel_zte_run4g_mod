    ...
    const sp<DataSource> &source, off_t *inout_pos, ape_parser_ctx_t *ape_ctx, bool parseall)
{
    ...
    while (1)
    {
        ...
        {
            LOGE("getAPEInfo not ape %x", *inout_pos);
            goto GetApeInfo_Exit;
        }
    ...
    *inout_pos += 4;
    ...
    {
        LOGE("getAPEInfo version is not match %d", ape_ctx->fileversion);
        goto GetApeInfo_Exit;
    }
    ...
    *inout_pos += 2;
    ...
    if (ape_ctx->fileversion >= 3980)
    {
        ...
        *inout_pos += 16;
        ...
        {
        	LOGE("getAPEInfo(Line%d): unsupported compressiontype = %u", __LINE__, ape_ctx->compressiontype);
            goto GetApeInfo_Exit;
        }
