...
namespace android {
// ----------------------------------------------------------------------------
class ANDROID_API AudioMTKTimeStretch  {
...
//============================================================//
    ...
    //============================================================//
    //  InternalBufferSpace: return internal buffer left space, input frame count can't exceed internal buffer
    //
    //============================================================//
    int InternalBufferSpace();
