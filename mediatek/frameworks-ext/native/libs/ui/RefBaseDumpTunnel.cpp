...
RefBaseDumpTunnel::RefBaseDumpTunnel(RefBaseMonitor* pMonitor)
    : mMonitor(pMonitor) {
}

RefBaseDumpTunnel::~RefBaseDumpTunnel() {
}

status_t RefBaseDumpTunnel::kickDump(String8& result, const char* prefix) {
...
RefBaseMonitor::RefBaseMonitor() {
    ...
    mDump = new RefBaseDumpTunnel(this);
