...
#define VIRTUAL_DISPLAY_WIDTH  1281
#define VIRTUAL_DISPLAY_HEIGHT 721
...
status_t main(int argc, char** argv) {
   ...
   //=============================================================================
    ...
    //sp<SurfaceComposerClient> client = new SurfaceComposerClient();
    sp<SurfaceControl> surfaceControllerVDS = client->createSurface( String8("autoTestVDS"),
        VIRTUAL_DISPLAY_WIDTH, VIRTUAL_DISPLAY_HEIGHT, PIXEL_FORMAT_RGBA_8888);
