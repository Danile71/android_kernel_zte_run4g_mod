...
#Only level 1 need to build liboemcrypto.so
# liboemcrypto.so
...
ifeq ($(strip $(MTK_IN_HOUSE_TEE_SUPPORT)),yes)
    LOCAL_SHARED_LIBRARIES += lib_uree_mtk_modular_drm
endif
ifeq ($(strip $(TRUSTONIC_TEE_SUPPORT)),yes)
    #Add trustonic shared library
    LOCAL_SHARED_LIBRARIES += libtlcModularDRMWidevine
