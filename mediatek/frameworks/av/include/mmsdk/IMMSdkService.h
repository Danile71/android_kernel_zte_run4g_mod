...
public:
    ...
    virtual status_t connectEffect(String8 const &clientName, sp<NSEffect::IEffectUser>& client)  = 0; 
    virtual status_t connectGesture(sp<NSGesture::IGestureUser>& client) = 0; 
    //virtual status_t connectSample()  = 0;
    virtual status_t registerCamera1Device(NSCam::ICamDevice *deivce) = 0; 
