...
namespace altova
{
	...
	public:
		Error(const string_type& message, const std::exception* inner = 0)
			: std::logic_error("altova::Error"), m_message(message), m_inner(inner) {printf("Error: %s\n", message.c_str());}
	...
	public:
		Exception(const string_type& message, const std::exception* inner = 0)
			: std::runtime_error("altova::Exception"), m_message(message), m_inner(inner) {printf("Exception: %s\n", message.c_str());}
	...
	*/
	...
	class all_exceptions 
	{
	    public:
	        all_exceptions(){};
	        std::string& get_message(){return name.append(message);};
	        all_exceptions(std::string message){this->message = message; this->name = "all_exceptions: Error:"; printf("All_exceptions : %s %s\n", name.c_str(), message.c_str());};
	    public:
	        std::string message;
	        std::string name;
	};
