...
#define MMSDK_LOGV(fmt, arg...)       XLOGV(fmt, ##arg)
#define MMSDK_LOGD(fmt, arg...)       XLOGD(fmt, ##arg)
#define MMSDK_LOGI(fmt, arg...)       XLOGI(fmt, ##arg)
#define MMSDK_LOGW(fmt, arg...)       XLOGW(fmt, ##arg)
#define MMSDK_LOGE(fmt, arg...)       XLOGE(fmt" (%s){#%d:%s}", ##arg, __FUNCTION__, __LINE__, __FILE__)
//
#else
//
