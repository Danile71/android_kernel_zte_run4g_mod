...
#ifndef _MEDIATEK_MMSDK_TEST_SERVICE_COMMAND_H_
#define _MEDIATEK_MMSDK_TEST_SERVICE_COMMAND_H_
//
...
*******************************************************************************/
    ...
    #define HAVE_COMMAND_service         "service"                 //  service
    #define HAVE_COMMAND_client_scaler   "scaler"                  //  [client]scaler
    #define HAVE_COMMAND_client_effect   "effect"                  //  [client]effect
    #define HAVE_COMMAND_client_gesture  "gesture"                 //  [client]gesture
...
#endif  //_MEDIATEK_MMSDK_TEST_SERVICE_COMMAND_H_
