...
LOCAL_JAVA_LIBRARIES := bouncycastle conscrypt telephony-common voip-common mediatek-common

LOCAL_SRC_FILES := $(call all-java-files-under,$(MTK_FRAMEWORKS_BASE_JAVA_SRC_DIRS))


LOCAL_SRC_FILES += \
	bluetooth/java/com/mediatek/bluetoothle/bleservice/IProfileServiceManager.aidl \
	bluetooth/java/com/mediatek/bluetoothle/bleservice/IProfileServiceManagerCallback.aidl \
    bluetooth/java/com/mediatek/bluetoothle/anp/IAlertNotificationProfileService.aidl \
	bluetooth/java/com/mediatek/bluetoothle/tip/ITimeProfileService.aidl \
	bluetooth/java/com/mediatek/bluetoothle/pxp/IProximityProfileService.aidl \
	bluetooth/java/com/mediatek/bluetoothle/pxp/IProximityProfileServiceCallback.aidl \
	bluetooth/java/com/mediatek/bluetooth/IBleDeviceManager.aidl \
	bluetooth/java/com/mediatek/bluetooth/IBleDeviceManagerCallback.aidl

${info ==> $(MTK_FRAMEWORKS_BASE_JAVA_SRC_DIRS)}
${info ==> $(LOCAL_PATH)/bluetooth/java}
...
LOCAL_REQUIRED_MODULES := libmpojni libjni_pq libgifEncoder_jni libjni_lomoeffect libjni_gesture libjni_effects libjni_imagetransform
...
LOCAL_API_SRC_DIRS += camera/effect/java
LOCAL_API_SRC_DIRS += camera/gesture/java
LOCAL_API_SRC_DIRS += media/imageTransform/java
# ===== Used for MediaTek SDK, please do not modify without SDK group reviewing =====
...
stub_package_list := com.mediatek.telephony:com.mediatek.telephony.gemini:com.mediatek.camcorder:com.mediatek.hardware:com.mediatek.telephony.gemini:com.mediatek.media:com.mediatek.build:com.mediatek.hotknot:com.mediatek.effect:com.mediatek.gesture:com.mediatek.imagetransform
...
# Documentation.
# ============================================================
MTK_SRC_API_DIR := mediatek/frameworks/api
MTK_framework_docs_LOCAL_DROIDDOC_HTML_DIR := docs/html
MTK_framework_docs_LOCAL_DROIDDOC_OPTIONS := \
    -since $(MTK_SRC_API_DIR)/1.txt 1 \
    -since $(MTK_SRC_API_DIR)/2.txt 2 \
    -since $(MTK_SRC_API_DIR)/3.txt 3 \
		-werror -hide 113 \
...
LOCAL_DROIDDOC_HTML_DIR:=$(MTK_framework_docs_LOCAL_DROIDDOC_HTML_DIR)
LOCAL_JAVA_LIBRARIES := telephony-common voip-common
