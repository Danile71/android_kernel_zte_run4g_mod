...
public class BleFindMeProfile extends BleProfile {
    ...
    private final int mProfileID = BleProfile.BLE_PROFILE_FMP;
    ...
    private static final int LEVEL_MIN = LEVEL_NO;
    private static final int LEVEL_MAX = LEVEL_HIGH;
    ...
    final void open() {
        ...
        this.mGattClientIf.registerClientCallback(BleProfile.BLE_PROFILE_FMP, mCallback);
    }
    ...
    final void close() {
        ...
        this.mGattClientIf.unregisterClientCallback(BleProfile.BLE_PROFILE_FMP);
    }
