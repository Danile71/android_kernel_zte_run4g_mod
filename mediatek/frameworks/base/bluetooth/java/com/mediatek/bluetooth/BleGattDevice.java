...
public class BleGattDevice {
    ...
    private void openProfileClients() {
        this.mProfileRegistry.put(BleProfile.BLE_PROFILE_FMP, new BleFindMeProfile(this.mDevice,
                mClientWrapper));
        this.mProfileRegistry.put(BleProfile.BLE_PROFILE_PXP, new BleProximityProfile(this.mDevice,
                mClientWrapper));
