...
public class BleManager {
     ...
     * @return true on success, false on error
     */
    public boolean getProfileService(Context ctxt, int profile,
    ...
    public void closeProfileServiceProxy(int profile, BleProfileService proxy) {
        ...
        if (BleProfile.BLE_PROFILE_TIP == profile && proxy instanceof BleTimeProfileService) {
