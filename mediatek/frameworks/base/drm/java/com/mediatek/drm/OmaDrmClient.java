    ...
    */
    ...
    public int installDrmMsg(String path, boolean useFd) {
        ...
        try {
            ...
            if (dmFile.exists()) {
                dmStream = new FileInputStream(dmFile);
                dmFd = dmStream.getFD();
            }
            ...
            request.put(OmaDrmStore.DrmRequestKey.ACTION_INSTALL_DRM_MSG_DM_FD, dmFd); // dm
                                                                                       // file
                                                                                       // descriptor
            request.put(OmaDrmStore.DrmRequestKey.ACTION_INSTALL_DRM_MSG_DCF_FD, dcfFd);
