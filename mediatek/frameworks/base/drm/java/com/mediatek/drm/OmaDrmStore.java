...
public class OmaDrmStore {
    ...
    public static class DrmRequestKey {
        ...
        public static final String ACTION_INSTALL_DRM_MSG_DM_FD = "dmFd";
        public static final String ACTION_INSTALL_DRM_MSG_DCF_FD = "dcfFd";
    }
    ...
    public static class DrmRequestAction {
        ...
        public static final String ACTION_INSTALL_DRM_MSG_BY_FD = "installDrmMsgByFd";
