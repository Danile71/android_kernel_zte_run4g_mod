...
int (*perfUserScnReg)(int, int, int, int) = NULL;
int (*perfUserScnRegBigLittle)(int, int, int, int, int, int) = NULL;
int (*perfUserScnUnreg)(int) = NULL;
int (*perfUserGetCapability)(int) = NULL;
int (*perfUserRegScn)(int, int) = NULL;
int (*perfUserRegScnConfig)(int, int, int, int, int, int) = NULL;
int (*perfUserUnregScn)(int) = NULL;
...
int (*perfDumpAll)(void) = NULL;
int (*perfSetFavorPid)(int) = NULL;
...
static JNINativeMethod sUtilityMethods[] = {
...
extern "C" jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jniRegisterNativeMethods(env, "com/mediatek/perfservice/PerfServiceWrapper", sUtilityMethods, NELEM(sUtilityMethods));
