            ...
            if (simDisplayName == null ||
                ...
                (oriNameSource == SimInfoManager.SIM_SOURCE && strName != null && !strName.equals(simDisplayName))) {
                    ...
                    if (null != optr && optr.equals("OP09")) {
                        logd("OP09");
                        String strOperator = SimInfoManager.getOperatorBySlot(context, slot);
                        if(strOperator != null && strOperator.equals("OP09")) {
                            logd("CT Card");
                            String strCTName = context.getText(com.mediatek.R.string.oper_long_46003).toString();
                            if(!strCTName.equals(simDisplayName)) {
                                logd("Force Update");
                                SimInfoManager.setDefaultNameEx(context, simInfo.mSimInfoId, strCTName , nameSource);
                            }
                        } else {
                            logd("NOT CT Card");
