...
import com.mediatek.common.widget.tests.scroll.RequestRectangleVisible;
...
public class RequestRectangleVisibleTest extends ActivityInstrumentationTestCase<RequestRectangleVisible> {
    ...
    public RequestRectangleVisibleTest() {
        super("com.mediatek.common.widget.tests", RequestRectangleVisible.class);
    }
    ...
    public void testScrollToOffScreenRectangleFromBottom() {
        // go to bottom button
        pressDownUntilViewInFocus(mClickToScrollFromBelow, 100);
    ...
    public void testScrollToPartiallyOffScreenRectFromBottom() {
        pressDownUntilViewInFocus(mClickToScrollToBlobLowerBlob, 100);
        ...
        /// M: may fail due to bugs in view.getLocationInWindow()
