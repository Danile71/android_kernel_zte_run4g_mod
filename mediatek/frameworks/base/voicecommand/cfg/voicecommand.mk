...
ifneq ($(strip $(MTK_VOICE_UNLOCK_SUPPORT))_$(strip $(MTK_VOW_SUPPORT)), no_no)
    PRODUCT_COPY_FILES += \
       ...
       $(LOCAL_MTK_PATH)/antiCmds/c_e_dic.bin.f:system/etc/voicecommand/training/ubmfile/antiCmds/c_e_dic.bin.f \
       $(LOCAL_MTK_PATH)/antiCmds/c_e_dic.bin.l:system/etc/voicecommand/training/ubmfile/antiCmds/c_e_dic.bin.l \
       $(LOCAL_MTK_PATH)/antiCmds/c_e_dic.bin.p:system/etc/voicecommand/training/ubmfile/antiCmds/c_e_dic.bin.p \
       $(LOCAL_MTK_PATH)/antiCmds/c_e_dic.bin.t:system/etc/voicecommand/training/ubmfile/antiCmds/c_e_dic.bin.t \
       $(LOCAL_MTK_PATH)/antiCmds/commandfilr3.dic:system/etc/voicecommand/training/ubmfile/antiCmds/commandfilr3.dic \
       $(LOCAL_MTK_PATH)/antiCmds/Model1.bin:system/etc/voicecommand/training/ubmfile/antiCmds/Model1.bin \
       $(LOCAL_MTK_PATH)/antiCmds/Model4.bin:system/etc/voicecommand/training/ubmfile/antiCmds/Model4.bin \
       $(LOCAL_MTK_PATH)/ubmModel0.bin:system/etc/voicecommand/training/ubmfile/ubmModel0.bin \
       $(LOCAL_MTK_PATH)/ubmModel1.bin:system/etc/voicecommand/training/ubmfile/ubmModel1.bin \
       $(LOCAL_MTK_PATH)/ubmModel2.bin:system/etc/voicecommand/training/ubmfile/ubmModel2.bin \
       $(LOCAL_MTK_PATH)/ubmModel3.bin:system/etc/voicecommand/training/ubmfile/ubmModel3.bin \
       $(LOCAL_MTK_PATH)/ubmModel4.bin:system/etc/voicecommand/training/ubmfile/ubmModel4.bin \
       $(LOCAL_MTK_PATH)/ubmModel10.bin:system/etc/voicecommand/training/ubmfile/ubmModel10.bin
endif
...
ifeq ($(strip $(MTK_VOICE_UI_SUPPORT)),yes)
    PRODUCT_COPY_FILES += \
       ...
       $(LOCAL_MTK_PATH)/modefile/GMN.bin:system/etc/voicecommand/voiceui/modefile/GMN.bin  \
       $(LOCAL_MTK_PATH)/modefile/GMU.bin:system/etc/voicecommand/voiceui/modefile/GMU.bin  \
...
PRODUCT_COPY_FILES += \
       ...
       $(LOCAL_MTK_PATH)/voicecontacts/modefile/GMN.bin:system/etc/voicecommand/voicecontacts/modefile/GMN.bin  \
       $(LOCAL_MTK_PATH)/voicecontacts/modefile/GMU.bin:system/etc/voicecommand/voicecontacts/modefile/GMU.bin  \
