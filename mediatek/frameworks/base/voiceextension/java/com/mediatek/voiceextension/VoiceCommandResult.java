...
public class VoiceCommandResult {
     ...
     */
    public static final int COMMANDSET_ALREADY_EXIST = VoiceCommonState.SET_ALREADY_EXIST;

    /**
     * The Command Set has not yet existed.
     */
    public static final int COMMANDSET_NOT_EXIST = VoiceCommonState.SET_NOT_EXIST;

    /**
     * The Command Set is invalid. Check the format.
     */
    public static final int COMMANDSET_NAME_ILLEGAL = VoiceCommonState.SET_ILLEGAL;

    /**
     * The Command Set string length exceeds the limit.
     */
    public static final int COMMANDSET_NAME_LENGTH_EXCEED_LIMIT = VoiceCommonState.SET_EXCEED_LIMIT;

    /**
     * The Command Set has been selected.
     */
    public static final int COMMANDSET_ALREADY_SELECTED = VoiceCommonState.SET_SELECTED;

    /**
     * The Command Set hasn't been selected.
     */
    public static final int COMMANDSET_NOT_SELECTED = VoiceCommonState.SET_NOT_SELECTED;

    /**
     * The Command Set is occupied; can not be deleted.
     */
    public static final int COMMANDSET_OCCUPIED = VoiceCommonState.SET_OCCUPIED;

    /**
     * Commands data are invalid. Check the data format.
     */
    public static final int COMMANDS_DATA_INVALID = VoiceCommonState.COMMANDS_DATA_INVALID;

    /**
     * Commands file is illegal. Check the file path or the file data format.
     */
    public static final int COMMANDS_FILE_ILLEGAL = VoiceCommonState.COMMANDS_FILE_ILLEGAL;

    /**
     * Commands number exceeds the limit. Reduce the commands number.
     */
    public static final int COMMANDS_NUM_EXCEED_LIMIT = VoiceCommonState.COMMANDS_NUM_EXCEED_LIMIT;
