...
public class CommonInterface {
    ...
    static {
        ...
        commonInterfaceMap.put(ISimSwitchPolicyWrapper.class,
                "com.mediatek.telephony.SimSwitchPolicyWrapper");
        ...
        commonInterfaceMap.put(IImsManager.class,
                "com.mediatek.ims.ImsManager");
        commonInterfaceMap.put(IRecoveryManager.class,
                "com.mediatek.recovery.RecoveryManager");
        commonInterfaceMap.put(IRecoveryManagerService.class,
                "com.mediatek.recovery.RecoveryManagerService");
        commonInterfaceMap.put(PasspointManager.class,
                "com.mediatek.passpoint.PasspointManagerImpl");
        commonInterfaceMap.put(IPasspointManager.class,
                "com.mediatek.passpoint.PasspointService");
        commonInterfaceMap.put(ISensorHubService.class,
                "com.mediatek.sensorhub.SensorHubService");
        commonInterfaceMap.put(ISensorHubManager.class,
