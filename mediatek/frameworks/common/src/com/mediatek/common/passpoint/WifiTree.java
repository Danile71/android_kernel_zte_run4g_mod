...
public class WifiTree implements Parcelable {
    ...
    public static class SpFqdn implements Parcelable {
        ...
        public void readFromParcel(Parcel in) {
            if (in == null) {
                ...
                perProviderSubscription = in.readParcelable(PerProviderSubscription.class.getClassLoader());
            }
        }
    ...
    public static class CredentialInfo implements Parcelable {
        ...
        public void readFromParcel(Parcel in) {
            if (in == null) {
                ...
                subscriptionParameters = in.readParcelable(SubscriptionParameters.class.getClassLoader());
    ...
    public static class Policy implements Parcelable {
        ...
        public void readFromParcel(Parcel in) {
            if (in == null) {
                ...
                in.readMap(preferredRoamingPartnerList, PreferredRoamingPartnerList.class.getClassLoader());
    ...
    public static final Parcelable.Creator<WifiTree> CREATOR = new Parcelable.Creator<WifiTree>() {
        public WifiTree createFromParcel(Parcel in) {
            return new WifiTree(in);
        }
