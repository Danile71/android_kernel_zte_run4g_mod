...
public interface IServiceStateExt {
    ...
    String onUpdateSpnDisplay(String plmn, int radioTechnology, int simId);
    ...
    int needSwitchRatModeInDesignateRegion(int mSimId,String nwPlmn); //[ALPS01577029]
    int needSwitchRatModeForCertainSIM(int mSimId,String mccmnc);    
    ...
    int setEmergencyCallsOnly(int state,int cid,int lac);
