...
/**
 * The SIM switch policy interface to provide capability SIM selection logic.  
 * 
 */
...
//  public static final int CAPABILITY_3G_DT_SWAP = 12;     // reserved.
    ...
    /**
     * To Select Capability SIM based on custom policy. 
     * 
     * Return values including: 
     *     ISimSwitchPolicy.CAPABILITY_INVALID:       invalid value. (no decision made)  
     *     ISimSwitchPolicy.CAPABILITY_GEMINI_SIM1:   SIM1 selected.
     *     ISimSwitchPolicy.CAPABILITY_GEMINI_SIM2:   SIM2 selected.
     *     ISimSwitchPolicy.CAPABILITY_GEMINI_SIM3:   SIM3 selected.
     *     ISimSwitchPolicy.CAPABILITY_GEMINI_SIM4:   SIM4 selected.
     *     ISimSwitchPolicy.CAPABILITY_NOCHANGE:      no change.
     * 
     * @param ctx current context
     * @param currIccId the remembered SIM IccId (last record) 
     * @param currSimId the remembered SIM Id (last record)
     ...
     */
    public int selectCapabilitySim(Context ctx, int capability, String currIccId, int currSimId, String iccId1, String iccId2, String iccId3, String iccId4);
    ...
    /**
     * Check if Sim Switch allows Changing Slot in Manual Control Mode.  
     * 
     * @param ctx current context
     * @param iccId1 current SIM1 IccId, null if not exist/unknown
     * @param iccId2 current SIM2 IccId, null if not exist/unknown
    ...
    /**
     * To Get Sim Switch Allowed Slots.
     * 
