...
public class InternationalRoamingConstants {
    ...
    //For Network mode selection.
    public static final int SIM_SWITCH_RESULT_ERROR_IN_ONLY_C_G_MODE = -10;
    // Sim switch failed because the switch phone process is blocked.
    public static final int SIM_SWITCH_RESULT_ERROR_BLOCKED = -11;
    ...
    //Network mode 
    public static final int NW_MODE_INTERNATIONAL = 0;
    public static final int NW_MODE_CDMA_ONLY = 1;
    public static final int NW_MODE_GSM_ONLY = 2;
    ...
    /**
     * When switching phone process, before setting the property finished, get the dual talk mode will get the old one.
     * Use the switching telephony mode constants to tag the status at that time.
     */
    // Switch to C+G mode, dual talk mode.
    public static final int SWITCHING_TELEPHONYMODE_DUALTALKMODE = 0;
    // Switch to W(G)+G mode, not dual talk mode.
    public static final int SWITCHING_TELEPHONYMODE_NOT_DUALTALKMODE = 1;
    // Not switching phone or switching done.
    public static final int SWITCHING_TELEPHONYMODE_DONE = -1;
}
