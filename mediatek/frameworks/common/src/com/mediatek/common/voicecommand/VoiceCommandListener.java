...
public abstract class VoiceCommandListener {
    ...
    public static final int ACTION_MAIN_VOICE_WAKEUP = ACTION_COMMON + 7;
    ...
    public static final int ACTION_VOICE_TRAINING_MODIFY = ACTION_COMMON + 6;
    public static final int ACTION_VOICE_TRAINING_FINISH = ACTION_COMMON + 7;
    ...
    public static final int ACTION_VOICE_CONTACTS_RECOGNITION_ENABLE = ACTION_COMMON + 11;
    public static final int ACTION_VOICE_CONTACTS_RECOGNITION_DISABLE = ACTION_COMMON + 12;

    public static final int ACTION_VOICE_WAKEUP_START = ACTION_COMMON + 0;
    public static final int ACTION_VOICE_WAKEUP_NOTIFY = ACTION_COMMON + 1;
    public static final int ACTION_VOICE_WAKEUP_INIT = ACTION_COMMON + 2;
    public static final int ACTION_VOICE_WAKEUP_MODE = ACTION_COMMON + 3;
    public static final int ACTION_VOICE_WAKEUP_COMMANDSTATUS = ACTION_COMMON + 4;
    public static final int ACTION_VOICE_WAKEUP_SHUTDOWN_IPO = ACTION_COMMON + 5;

    public static final int VOW_MODE_UNLOCK = 0; //unlock mode
    public static final int VOW_MODE_WAKEUP_ANYONE = 1; //keyword recognition mode
    public static final int VOW_MODE_WAKEUP_COMMAND = 2; //keyword + speaker recognition mode

    public static final int VOW_STATUS_NO_COMMAND_UNCHECKED = 0; //no command and unchecked
    public static final int VOW_STATUS_COMMAND_UNCHECKED = 1; //has command and unchecked
    public static final int VOW_STATUS_COMMAND_CHECKED = 2; //has command and checked
