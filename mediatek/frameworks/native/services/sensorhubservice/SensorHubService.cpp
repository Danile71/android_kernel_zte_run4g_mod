...
#include <sensorhub/ISensorHubServer.h>
...
/*    
        //add touch panel logic here
        SensorCondition activeCondition = SensorCondition::create(SHF_DATA_INDEX_INPOCKET_VALUE,
                false,
                SHF_OPERATION_MORE_THAN_OR_EQUAL,
                INPOCKET_VALUE);
        SensorAction activeAction(SensorAction::ACTION_ID_TOUCH_DEACTIVE, true, true);
        updateAction(SHF_CONDITION_RESERVED_TOUCH_PANEL_ON, activeCondition, activeAction);
    
        SensorCondition deactiveCondition = SensorCondition::create(SHF_DATA_INDEX_INPOCKET_VALUE,
                false,
                SHF_OPERATION_LESS_THAN,
                INPOCKET_VALUE);
        SensorAction deactiveAction(SensorAction::ACTION_ID_TOUCH_ACTIVE, true, true);
        updateAction(SHF_CONDITION_RESERVED_TOUCH_PANEL_OFF, deactiveCondition, deactiveAction);
*/
    }
