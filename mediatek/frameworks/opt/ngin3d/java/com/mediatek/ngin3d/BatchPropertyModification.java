...
public class BatchPropertyModification extends Transaction {
    ...
    public void addPropertyModification(Actor target, Property property, Object value) {
        ...
        if (getModificationList().size() > MAX_OPERATIONS) {
            throw new Ngin3dException("Too many operations in Transaction");
        } else if (getModificationList().size() > MAX_OPERATIONS / 2) {
            Log.d(Ngin3d.TAG, "Warning, there are more than " + MAX_OPERATIONS / 2 + " operations in Transaction");
        } else if (getModificationList().size() > MAX_OPERATIONS / 3) {
            Log.d(Ngin3d.TAG, "Warning, there are more than " + MAX_OPERATIONS / 3 + " operations in Transaction");
        }
