...
public class BitmapFont {
    ...
    public void getCharRect(CharacterInfo charInfo, Box rect) {
        if (charInfo.width > 0) {
            rect.set(charInfo.srcX, mScaleH - charInfo.srcY - charInfo.height, charInfo.width + charInfo.srcX - 1, mScaleH - charInfo.srcY);
        } else {
            // For the ' '(space) the width is zero and no need to minus 1
