...
public abstract class Object3D extends Actor {
     ...
     * @hide
     */
    static final Property<ObjectSource> PROP_OBJ_SRC =
        new Property<ObjectSource>("image_source", null);

    /** @hide */
    public static final Property<Boolean> PROP_ANIMATION_PLAYING =
        new Property<Boolean>("animation_playing", false, PROP_OBJ_SRC);

    /** @hide */
    public static final Property<Float> PROP_ANIMATION_PROGRESS =
        new Property<Float>("animation_progress", 0.0f, PROP_OBJ_SRC);
    ...
    public static final Property<Boolean> PROP_ANIMATION_LOOP_ENABLED =
        new Property<Boolean>("animation_loop_enabled", null, PROP_OBJ_SRC);

    /** @hide */
    public static final Property<Float> PROP_ANIMATION_SPEED =
        new Property<Float>("animation_speed", 1.0f, PROP_OBJ_SRC);
    ...
    /**
     * Sets property value of specified key path and add the dependency with
     * PROP_OBJ_SRC.
     *
    ...
    public <T> boolean setKeyPathValue(String keyPath, Object value) {
        return super.setKeyPathValue(keyPath, value, PROP_OBJ_SRC);
    }
    ...
    protected boolean applyValue(Property property, Object value) {
        ...
        if (property instanceof KeyPathProperty) {
            ...
            if (property.sameInstance(PROP_ANIMATION_PLAYING)) {
                ...
                return true;
            } else if (property.sameInstance(PROP_OBJ_SRC)) {
                ObjectSource src = (ObjectSource) value;
                if (src == null) {
                    return false;
                }
                getPresentation().setObjectSource(src);

                if (mAnimation != null) {
                    int lengthMs = (int) (getPresentation().getAnimationLength
                            () * 1000.0f);
                    mAnimation.setDuration(lengthMs);
                    mAnimation.setLoop(getPresentation()
    ...
    public void setObjectFromFile(String filename) {
        ...
        setValue(PROP_OBJ_SRC, new ObjectSource(ObjectSource.FILE, filename));
    }
    ...
    public void setObjectFromResource(Resources resources, int resId) {
        ...
        setValue(PROP_OBJ_SRC, new ObjectSource(ObjectSource.RES_ID,
    ...
    public void setObjectFromAsset(String assetName) {
        ...
        setValue(PROP_OBJ_SRC, new ObjectSource(ObjectSource.ASSET, assetName));
    }
