...
public class StageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        onCreate(savedInstanceState, new StageView(this, (Stage) null, isAntiAliasingEnabled()));
    ...
    /**
     * Override this method to specify whether to enable anti-aliasing.
     * Anti-aliasing is default on.
     *
     * @return true for enable anti-aliasing and false to disable it.
     */
