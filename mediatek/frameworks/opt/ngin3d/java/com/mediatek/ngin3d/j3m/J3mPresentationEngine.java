...
import com.mediatek.ngin3d.AnimationRunner;
...
public class J3mPresentationEngine implements PresentationEngine {
    ...
    public void initialize(int width, int height, Resources resources,
        ...
        Log.d(TAG, "Number of operations in Transaction: " + Transaction.size());
        if (libDir == null) {
        ...
        mRenderContext = mJ3m.createRenderContext();
        mRenderer = mJ3m.createRenderer(mRenderContext, mAssetPool);
        ...
        mIsReady = true;
        mAnimationRunner = new AnimationRunner(mStage);
        mAnimationRunner.start();
    }
    ...
    public void uninitialize() {
        ...
        // Force to commit all remain operations.
    ...
    public boolean render() {
        ...
        // Start the next frame of animation
        mAnimationRunner.requestRender();
