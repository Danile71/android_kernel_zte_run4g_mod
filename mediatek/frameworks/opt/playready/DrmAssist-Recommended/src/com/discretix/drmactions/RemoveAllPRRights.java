 ...
 */
public class RemoveAllPRRights extends DrmActionSync {
	...
	public String getName() {
		return "Remove All PlayReady Rights";
	}
	...
	protected String perform(Context context, String filePath, String extension) {
		...
		int status = drmClient.removeRights("playready://AllLicenses.playready");
		Log.d("RemoveRights", "DrmManagerClient::removeRights(AllRights) returned " + Utilities.drmClientStatus2Str(status));
