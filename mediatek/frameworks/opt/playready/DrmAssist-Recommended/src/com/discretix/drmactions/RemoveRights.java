 ...
 */
public class RemoveRights extends DrmActionSync {
	...
	protected String perform(Context context, String filePath, String extension) {
		...
		int status = drmClient.removeRights(filePath);
		Log.d("RemoveRights", "DrmManagerClient::removeRights(String) returned " + Utilities.drmClientStatus2Str(status));
