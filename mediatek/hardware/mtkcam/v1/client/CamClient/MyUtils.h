...
#ifndef _MTK_HARDWARE_MTKCAM_V1_CLIENT_CAMCLIENT_CAMUTILS_H_
#define _MTK_HARDWARE_MTKCAM_V1_CLIENT_CAMCLIENT_CAMUTILS_H_
...
//
#endif  //_MTK_HARDWARE_MTKCAM_V1_CLIENT_CAMCLIENT_CAMUTILS_H_
