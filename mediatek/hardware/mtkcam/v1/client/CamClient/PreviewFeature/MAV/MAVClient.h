...
protected:    
    ...
    /**
     * @brief transfer image format form nv21 to yv12.
     *
     * @note N/A.
     *
     * @param [in] srcbufadr Source image buffer address.
    ...
    virtual MINT32 ImageTrans(MVOID * srcbufadr, int ImgWidth, int ImgHeight, MVOID * dstbufadr);
    virtual MINT32 ImageTransBack(MVOID * srcbufadr, int ImgWidth, int ImgHeight, MVOID * dstbufadr);
    #endif
...
protected: 
    ...
    sp<IImageBuffer>  mpframeBuffer[MAV_PIPE_MAX_IMAGE_NUM];
    sp<IImageBuffer>  mpMotionBuffer;
    sp<IImageBuffer>  mpMAVMotionBuffer;
    sp<IImageBuffer>  mpWarpBuffer;
    sp<IImageBuffer>  mpMAVWorkingBuf;
    int               mMAVFrameWidth;
    int               mMAVFrameHeight;
    int               mMAVFrameSize;
