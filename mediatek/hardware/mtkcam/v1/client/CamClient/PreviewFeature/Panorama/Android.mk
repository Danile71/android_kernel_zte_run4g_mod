...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/v1/client/CamClient/inc
...
#-----------------------------------------------------------
LOCAL_MODULE := libcam.client.camclient.featurebase.companorama
#-----------------------------------------------------------
ifeq (yes,$(MTK_CAM_AUTORAMA_SUPPORT))
include $(BUILD_STATIC_LIBRARY)
else
$(warning "Not Build panorama")
endif
