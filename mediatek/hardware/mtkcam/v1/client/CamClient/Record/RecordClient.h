...
public:     ////
    ...
    //
protected:
    virtual uint32_t                getImgStrideY() {return 16;}
    virtual uint32_t                getImgStrideU() {return 16;}
    virtual uint32_t                getImgStrideV() {return 16;}
    virtual const char*             getImgImgFormat() {return MtkCameraParameters::PIXEL_FORMAT_YUV420P;}
...
protected:  ////                    Operations.
    ...
    bool                            performRecordCallback(int32_t bufIdx, sp<RecImgBuf>const& pCameraImgBuf, int32_t const msgType);
