 ...
 *
 ******************************************************************************/
#define MY_LOGV(fmt, arg...)        CAM_LOGV("[DisplayThread::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGD(fmt, arg...)        CAM_LOGD("[DisplayThread::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGI(fmt, arg...)        CAM_LOGI("[DisplayThread::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGW(fmt, arg...)        CAM_LOGW("[DisplayThread::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGE(fmt, arg...)        CAM_LOGE("[DisplayThread::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGA(fmt, arg...)        CAM_LOGA("[DisplayThread::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGF(fmt, arg...)        CAM_LOGF("[DisplayThread::%s] "fmt, __FUNCTION__, ##arg)
//
...
readyToRun()
{
    ...
    int const priority  = NICE_CAMERA_DISPLAY_CLIENT;
#endif
    //
    //  set
