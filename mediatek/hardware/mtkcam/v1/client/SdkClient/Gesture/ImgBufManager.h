...
#ifndef _MTK_CAMERA_CLIENT_SDKCLIENT_GESTURE_IMGBUFMANAGER_H_
#define _MTK_CAMERA_CLIENT_SDKCLIENT_GESTURE_IMGBUFMANAGER_H_
//
...
*******************************************************************************/
class ClientImgBuf : public IImgBuf
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  IMemBuf Interface.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public:     ////                    Attributes.
    ...
    //
    virtual void*                   getVirAddr() const                      { return (void*)mpMemoryHeapBase->base(); }
    virtual void*                   getPhyAddr() const                      { return (void*)mpMemoryHeapBase->base(); }
    //
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  IImgBuf Interface.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////                    Attributes.
    ...
    virtual uint32_t                getImgWidthStride(
                                    ...
                                    )  const
                                    {
                                        ...
                                        return Format::queryPlaneWidthInPixels(Format::queryImageFormat(getImgFormat().string()),
                                                                                               uPlaneIndex,
                                                                                               getImgWidth() 
                                                                                               );
                                    }
...
protected:  ////                    Memory.
    ...
    sp<MemoryHeapBase>              mpMemoryHeapBase; 
...
public:     ////                    Attributes.
    ...
    sp<ClientImgBuf>const&          getBuf(size_t index) const  { return mvImgBuf[index]; }
...
protected:  ////                    Data Members.
    ...
    //
    Vector< sp<ClientImgBuf> >      mvImgBuf;
};
...
#endif  //_MTK_CAMERA_CLIENT_SDKCLIENT_GESTURE_IMGBUFMANAGER_H_
