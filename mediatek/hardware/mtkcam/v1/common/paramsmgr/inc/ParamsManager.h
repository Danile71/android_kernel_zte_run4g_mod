...
public:     ////                        Operations.
    ...
    virtual bool                        getVideoSnapshotSupport() const;
    virtual uint32_t                    getMultFrameBlending() const;
    virtual bool                        getCShotIndicator() const;
    virtual uint32_t                    getVHdr() const;
    virtual String8                     getShotModeStr() const;
    virtual uint32_t                    getShotMode() const;
    virtual void                        getFaceBeautyTouchPosition(FACE_BEAUTY_POS& pos) const;
...
protected:  ////                        Update.
    ...
    virtual bool                        updateDefaultEngParams(); 
...
protected: ////                         Called by updateDefaultEngParams().     
    virtual bool                        updateDefaultEngParams0(); 
...
protected: ////                         called by updateDefaultEngParam0()
    virtual bool                        updateDefaultEngParam0_ByQuery();    //not pure-function for backward compatible for legacy platform
    virtual bool                        updateDefaultEngParam0_ByDefault(); 
...
protected:  ////                        Called by setParameters().
    ...
    virtual bool                        updateFov(Size picSize) = 0;
