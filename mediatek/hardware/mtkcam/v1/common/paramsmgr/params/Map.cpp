...
_PARAM_MAP_BEG_(eMapAppMode)
    ...
    _ADD_STRING_VALUE_MAP_(MtkCameraParameters::APP_MODE_NAME_MTK_STEREO,   eAppMode_StereoMode);
...
_PARAM_MAP_BEG_(eMapMeterMode)
    ...
    _ADD_STRING_VALUE_MAP_(   MtkCameraParameters::EXPOSURE_METER_CENTER,           AE_METERING_MODE_CENTER_WEIGHT);
    _ADD_STRING_VALUE_MAP_(   MtkCameraParameters::EXPOSURE_METER_AVERAGE,          AE_METERING_MODE_AVERAGE);
    }
