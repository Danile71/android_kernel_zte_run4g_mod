...
{RIL_REQUEST_RADIO_POWERON,dispatchVoid, responseInts,RIL_CMD_PROXY_1},
...
{RIL_REQUEST_GET_PSDM_DECISION, dispatchVoid, responseInts, RIL_CMD_PROXY_5},//MMDC
{RIL_REQUEST_CONFIRM_PS_SWITCH, dispatchInts, responseVoid, RIL_CMD_PROXY_2},
{RIL_REQUEST_CONFIRM_PS_SWITCH_ATTACH, dispatchInts, responseVoid, RIL_CMD_PROXY_5},
{RIL_REQUEST_RESET_MODE_AFTER_SWITCH, dispatchInts, responseVoid, RIL_CMD_PROXY_5}, 
{RIL_REQUEST_PS_REATTACH, dispatchVoid, responseVoid, RIL_CMD_PROXY_5},
...
{RIL_REQUEST_GET_EUTRAN_VDP, dispatchVoid, responseInts, RIL_CMD_PROXY_1}, 
{RIL_REQUEST_SET_EUTRAN_VDP, dispatchInts, responseVoid, RIL_CMD_PROXY_1}, 
{RIL_REQUEST_GET_UTRAN_VDP, dispatchVoid, responseInts, RIL_CMD_PROXY_1}, 
{RIL_REQUEST_SET_UTRAN_VDP, dispatchInts, responseVoid, RIL_CMD_PROXY_1}, 
{RIL_REQUEST_GET_MM_IMS_VOICE_TERMINATION, dispatchVoid, responseInts, RIL_CMD_PROXY_1}, 
{RIL_REQUEST_SET_MM_IMS_VOICE_TERMINATION, dispatchInts, responseVoid, RIL_CMD_PROXY_1},
...
{RIL_REQUEST_CONFIG_SIM_SWITCH, dispatchInts, responseVoid, RIL_CMD_PROXY_2},
{RIL_REQUEST_RETRIEVE_HELD_CALL, dispatchInts, responseVoid, RIL_CMD_PROXY_2}, 
...
{RIL_REQUEST_SETUP_EMERGENCY_DATA_CALL, dispatchStrings, responseSetupDataCall, RIL_CMD_PROXY_2},
