...
extern void onLteSuppSvcNotification(char *s, RILId rid);
extern void onVoLteEconfSrvccIndication(char *s, RILId rid);

extern void onEmergencyCallServiceCategoryIndication(char *s, RILId rid);
