...
typedef enum
{
    ...
    //MR2 merge
    ,NT_LTE_GSM_WCDMA_TYPE = 9  // 4G/3G/2G
    ,NT_LTE_ONLY_TYPE      = 11 // 4G only
    ,NT_LTE_WCDMA_TYPE     = 12 // 4G/3G

    //MTK-START: add for LTE
    ,NT_MODE_MTK_BASE_TYPE = 30

    // for "4G Preferred" item
    ,NT_LTE_GSM_WCDMA_PREF_TYPE      = (NT_MODE_MTK_BASE_TYPE+1)
    ,NT_LTE_GSM_WCDMA_PREF_MMDC_TYPE = (NT_MODE_MTK_BASE_TYPE+2)

    //for "3G or 2G Preferred" item
    ,NT_GSM_WCDMA_LTE_TYPE           = (NT_MODE_MTK_BASE_TYPE+3)
    ,NT_GSM_WCDMA_LTE_MMDC_TYPE      = (NT_MODE_MTK_BASE_TYPE+4)
    ...
    //MTK-START: add for LTE
    // for "4G Preferred" item rat only mode
    ,NT_LTE_GSM_WCDMA_PREF_RAT_ONLY_TYPE      = (NT_RAT_ONLY_TYPE + NT_LTE_GSM_WCDMA_PREF_TYPE)
    ,NT_LTE_GSM_WCDMA_PREF_MMDC_RAT_ONLY_TYPE = (NT_RAT_ONLY_TYPE + NT_LTE_GSM_WCDMA_PREF_MMDC_TYPE)

     //for "3G or 2G Preferred" item rat only mode
    ,NT_GSM_WCDMA_LTE_RAT_ONLY_TYPE           = (NT_RAT_ONLY_TYPE + NT_GSM_WCDMA_LTE_TYPE)
    ,NT_GSM_WCDMA_LTE_MMDC_RAT_ONLY_TYPE      = (NT_RAT_ONLY_TYPE + NT_GSM_WCDMA_LTE_MMDC_TYPE)

    //for "4G/2G" item rat only mode
    ,NT_LTE_GSM_RAT_ONLY_TYPE                 = (NT_RAT_ONLY_TYPE + NT_LTE_GSM_TYPE)
    ,NT_LTE_GSM_MMDC_RAT_ONLY_TYPE            = (NT_RAT_ONLY_TYPE + NT_LTE_GSM_MMDC_TYPE)
    //MTK-START: add for LTE
