...
int main(int argc, char **argv)
{
    ...
    if (rilLibPath == NULL) {
        ...
        if ( 0 == property_get(LIB_PATH_PROPERTY, libPath, "/system/lib/mtk-ril-s.so")) {
#else
...
#else
#ifdef MTK_CSFB_IN_MMDC_PROJECT
#define  REFERENCE_RIL_PATH  "/system/lib/mtk-ril-s.so"
#else
...
#endif
#ifdef MTK_CSFB_IN_MMDC_PROJECT
    rilLibPath = "/system/lib/mtk-ril-s.so";
#endif
