...
LOCAL_SRC_FILES := sensors.c  hwmsen_chip_info.c nusensors.cpp InputEventReader.cpp SensorBase.cpp Hwmsen.cpp Acceleration.cpp Magnetic.cpp Gyroscope.cpp AmbienteLight.cpp Proximity.cpp Pressure.cpp Temprature.cpp sensordebug.cpp BatchSensor.cpp StepCounter.cpp Shake.cpp Activity.cpp FaceDown.cpp InPocket.cpp Pedometer.cpp PickUp.cpp
