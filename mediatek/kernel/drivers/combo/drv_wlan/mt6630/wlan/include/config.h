...
** enable SDIO read/write backdoor for SA's HQA item
**
** 08 15 2013 cp.wu
** [BORA00002253] [MT6630 Wi-Fi][Driver][Firmware] Add NLO and timeout mechanism to SCN module
...
** 06 19 2013 cp.wu
** [BORA00002227] [MT6630 Wi-Fi][Driver] Update for Makefile and HIFSYS modifications
** TX maximum access length is now calculated based on page count
**
** 05 16 2013 cp.wu
** [BORA00002227] [MT6630 Wi-Fi][Driver] Update for Makefile and HIFSYS modifications
** change default start address from 0x00095400 to 0x00091400
**
** 05 08 2013 cp.wu
** [BORA00002227] [MT6630 Wi-Fi][Driver] Update for Makefile and HIFSYS modifications
...
** 03 21 2013 cp.wu
** [BORA00002227] [MT6630 Wi-Fi][Driver] Update for Makefile and HIFSYS modifications
** change default starting address to ASIC/S4 setting
**
** 03 19 2013 cp.wu
** [BORA00002227] [MT6630 Wi-Fi][Driver] Update for Makefile and HIFSYS modifications
...
#define CFG_SDIO_TX_AGG                              1 /*!< 1: Enable SDIO TX enhance mode(Multiple frames in single BLOCK CMD)
                                                            0(default): Disable */
#define CFG_SDIO_TX_AGG_LIMIT                        0 /*!< 0: Disable this limitation  
 ...
 */
    ...
    #define CFG_COALESCING_BUFFER_SIZE          (NIC_TX_PAGE_SIZE * NIC_TX_PAGE_SUM)
#else
