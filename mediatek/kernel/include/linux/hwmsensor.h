...
#define SENSOR_TYPE_IN_POCKET           (22)
...
#define ID_SENSOR_MAX_HANDLE			(ID_BASE+25)
#define ID_NONE							(ID_BASE+26)

#define ID_OFFSET                           (1)

#define MAX_ANDROID_SENSOR_NUM	(ID_ACTIVITY +1) //not support MTK virtual sensor (all of them are one shot), otherwise fail at copy_form_user, size too large
...
#define SENSOR_PICK_UP                      (1 << ID_PICK_UP) 
