...
public class MainActivity extends Activity {
    ...
    protected Dialog onCreateDialog(int id, Bundle args) {
        ...
        case DialogID.DLG_LOGIN_STATUES:
            dialog = new AlertDialog.Builder(this).setIconAttribute(android.R.attr.alertDialogIcon)
                    .setTitle(R.string.remind).setMessage(R.string.login_notice).setCancelable(false)
        ...
        case DialogID.DLG_NO_SDCARD:
            dialog = new AlertDialog.Builder(this).setIconAttribute(android.R.attr.alertDialogIcon)
                    .setTitle(R.string.notice).setMessage(SDCardUtils.getSDStatueMessage(this)).setCancelable(false)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
    ...
    private void sdCardCheck() {
        if(!SDCardUtils.isSdcardFull() && SDCardUtils.getStoragePath()==null){
