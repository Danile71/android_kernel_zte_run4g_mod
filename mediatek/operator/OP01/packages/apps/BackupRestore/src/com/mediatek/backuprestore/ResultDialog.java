...
public class ResultDialog {
    ...
    public static ResultDialogAdapter createResultAdapter(final Context context, final Bundle args) {
        ...
        if (list == null) {
            Log.e(LogTag.LOG_TAG, "createResultAdapter: error: list is null");
            return null;
        }
        MyLogger.logD(LogTag.LOG_TAG, "createResultAdapter list size = " + list.size());
    ...
    private static class ResultDialogAdapter extends SimpleAdapter {
        ...
        public ResultDialogAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from,
                int[] to) {
