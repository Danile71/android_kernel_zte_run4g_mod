...
public class CalendarBackupComposer extends Composer {
    ...
    public boolean init() {
        boolean result = true;
        String querySelection = Events.DELETED + "!=1";
        mCursor = mContext.getContentResolver().query(CALANDEREVENTURI, null, querySelection, null, null);
        ...
        MyLogger.logD(CLASS_TAG, "init(),result:" + result + ", count:" + (mCursor != null ? mCursor.getCount() : 0));
        return result;
    }
