...
public class ContactRestoreComposer extends Composer {
    ...
    public boolean implementComposeOneEntity() {
        ...
        if (mIndex == 1) {
            if (mInputStream != null) {
                ...
                result = readOneVCard(mInputStream, VCardConfig.VCARD_TYPE_V21_GENERIC, constructor,
    ...
    public void onStart() {
        ...
        try {
            String fileName = mParentFolderPath + File.separator + ModulePath.FOLDER_CONTACT + File.separator
                    + ModulePath.NAME_CONTACT;
    ...
    private class RestoreVCardEntryCommitter extends VCardEntryCommitter {
         ...
         * 
         * @param resolver
         *            a <code>ContentResolver</code> value
         */
    ...
    // mOperationList = vcardEntry.constructInsertOperations(mContentResolver,
    // mOperationList);
    // if (mOperationList != null
