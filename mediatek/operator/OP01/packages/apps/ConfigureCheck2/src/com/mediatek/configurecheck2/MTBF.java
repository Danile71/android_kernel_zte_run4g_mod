...
class CheckBJTime extends CheckItemBase {
 ...
 class CheckScreenOn extends CheckItemBase {
     ...
     private static final int TIME_30_MIN = 1800000;
     private static final int TIME_15_SEC = 15000;
     private Context cc;
     ...
     CheckScreenOn (Context c, String key) {
        ...
        } else if (key.equals(CheckItemKeySet.CI_SCREEN_ON_SLEEP_15SEC)) {
            setTitle(R.string.title_sleep);
            setNote(c.getString(R.string.note_sleep_15sec)
     ...
     public boolean onCheck() {
         ...
         if (getKey().equals(CheckItemKeySet.CI_SCREEN_ON_SLEEP)
                 || getKey().equals(CheckItemKeySet.CI_SCREEN_ON_SLEEP_15SEC)) {
             ...
             case TIME_30_MIN:
                 ...
                 break;
             case TIME_15_SEC:
                 setValue(R.string.value_sleep_15s);
                 if (getKey().equals(CheckItemKeySet.CI_SCREEN_ON_SLEEP_15SEC)) {
                     mResult = check_result.RIGHT;
                 }
                 break;
             default:
     ...
     public boolean onReset() {
         ...
         if (getKey().equals(CheckItemKeySet.CI_SCREEN_ON_SLEEP)) {
            setValue(R.string.value_sleep_max);
            Settings.System.putInt(cc.getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, TIME_30_MIN);
         } else if (getKey().equals(CheckItemKeySet.CI_SCREEN_ON_SLEEP_15SEC)) {
             setValue(R.string.value_sleep_15s);
             Settings.System.putInt(cc.getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, TIME_15_SEC);
         } else if (getKey().equals(CheckItemKeySet.CI_SCREEN_ON_UNLOCK)) {
             setValue(R.string.value_unlockscreen);
...
class CheckDefaultIME extends CheckItemBase {
    ...
    public boolean onCheck() {
        ...
        if (ime != null && (ime.equals(IME1) || ime.equals(IME2))) {
            mResult = check_result.RIGHT;  
...
class CheckWIFIControl extends CheckItemBase {
    ...
    CheckWIFIControl (Context c, String key) {
        ...
        setNote(cc.getString(R.string.note_WLAN)
                + cc.getString(R.string.SOP_REFER)
                + cc.getString(R.string.SOP_LTE_NS_IOT));
        setProperty(PROPERTY_AUTO_CHECK | PROPERTY_AUTO_CONFG);        
