...
public class ProviderFactory {
    ...
    public static CheckItemProviderBase getProvider(Context c, String category) {
        ...
        } else if (category.equals(c.getString(R.string.lte_pct_tdd))) {
            return new TdlPctTddProvider(c);
            
        } else if (category.equals(c.getString(R.string.lte_pct_fdd_fddtdd))) {
...
class TdsProConTtcnProvider extends CheckItemProviderBase {
    TdsProConTtcnProvider(Context c) {
        ...
        if (FeatureOption.MTK_ATCI_EM_SUPPORT) {
        ...
        if (Utils.IS_SGLTE_PHONE) {
            ...
            if (Utils.IS_3_MODEMS) {
                ...
                mArrayItems.add(new CheckMdSwitchAndNwMode(c, CheckItemKeySet.CI_TDDCSFB_And_TDS_ONLY));
            }
        }
    }
}
    ...
    TdlRrmTddProvider(Context c) {     
        ...
        if (Utils.IS_SGLTE_PHONE) {
            ...
            if (Utils.IS_3_MODEMS) {
                ...
                mArrayItems.add(new CheckMdSwitchAndNwMode(c, CheckItemKeySet.CI_TDDCSFB_And_4G3G2GAuto));
            }
        }
    }
}
    ...
    TdlRrmFddFddTddProvider(Context c) {
        ...
        if (Utils.IS_SGLTE_PHONE) {
            if (Utils.IS_3_MODEMS) {
                ...
                mArrayItems.add(new CheckMdSwitchAndNwMode(c, CheckItemKeySet.CI_FDDCSFB_And_4G3GAnd2G));
            }
        } else if (Utils.IS_CSFB_PHONE) {
            if (Utils.IS_3_MODEMS) {
                mArrayItems.add(new CheckNetworkMode(c, CheckItemKeySet.CI_4G_3G_2G_Auto));
                ...
                mArrayItems.add(new CheckMdSwitchAndNwMode(c, CheckItemKeySet.CI_FDDCSFB_And_4G3G2GAuto));
            }
        }
    }
}
    ...
    TdlNsIotAniteProvider(Context c) {
        ...
        if (Utils.IS_SGLTE_PHONE) {
            ...
            if (Utils.IS_3_MODEMS) {
                ...
                mArrayItems.add(new CheckMdSwitchAndNwMode(c, CheckItemKeySet.CI_TDDCSFB_And_LTE_ONLY));
            }
        }
    }
}
    ...
    TdlNsIotAniCsfbProvider(Context c) {
        ...
        if (Utils.IS_CSFB_PHONE) {
            if (Utils.IS_3_MODEMS) {
                ...
                mArrayItems.add(new CheckMdSwitchAndNwMode(c, CheckItemKeySet.CI_TDDCSFB_And_4g2g));
            }
        }
    }
}
    ...
    TdlIPv62gCaseProvider(Context c) {
        ...
        if (Utils.IS_SGLTE_PHONE) {
            ...
            if (Utils.IS_3_MODEMS) {
                ...
                mArrayItems.add(new CheckMdSwitchAndNwMode(c, CheckItemKeySet.CI_TDDCSFB_And_GSM_ONLY));
            }
        }
    }
}
