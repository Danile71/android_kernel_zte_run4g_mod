...
public class Op01BrowserMiscExt extends DefaultBrowserMiscExt {
            ...
            if (conMgr.getActiveNetworkInfo() == null || 
                ...
                if (list != null && list.size() == 0) {
                    ...
                    if (SystemProperties.get("ro.mtk_gemini_support").equals("1")) {
                        ...
                        hasSim = teleMgrEx.hasIccCard(PhoneConstants.GEMINI_SIM_1) ||
                            teleMgrEx.hasIccCard(PhoneConstants.GEMINI_SIM_2) ||
                            teleMgrEx.hasIccCard(PhoneConstants.GEMINI_SIM_3) ||
                            teleMgrEx.hasIccCard(PhoneConstants.GEMINI_SIM_4);
                    } else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data, Object obj) {
        Xlog.i(TAG, "Enter: " + "onActivityResult" + " --OP01 implement");
