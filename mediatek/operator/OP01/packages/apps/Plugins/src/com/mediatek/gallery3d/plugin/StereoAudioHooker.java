...
public class StereoAudioHooker extends PluginBaseHooker {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        mMenuStereoAudio = menu.add(0, getMenuActivityId(MENU_STEREO_AUDIO), 0, mPluginContext.getString(R.string.single_track));
        return true;
    }
    @Override
    ...
    private boolean getStereoAudio() {
        ...
        if (LOG) {
            Log.v(TAG, "getStereoAudio() isstereo=" + isstereo + ", stereo=" + stereo + ", key=" + key);
        }
        return isstereo;
    }
