...
public class Op01MusicTrackBrowserExtension extends DefaultMusicTrackBrowser {
    ...
    private final String TAG = "Op01MusicTrackBrowserExtension";    

    private final int CLEAR_PLAYLIST = PluginUtils.MENU_ITEM_BASE_ID;
    private final int ADD_SONG_TO_PLAYLIST = PluginUtils.MENU_ITEM_BASE_ID + 1;
    private final int REQUEST_TO_ADD_SONG_TO_PLAYLIST = PluginUtils.ACTIVITY_REQUEST_CODE_BASE_ID;
    private final String SELECT_FILE_FROM_FILEMANAGER = "com.mediatek.filemanager.ADD_FILE";
    ...
    public void onCreateOptionsMenuForPlugin(Menu menu, String activityName, Bundle options) {
        ...
        if (activityName.equals(PluginUtils.TRACK_BROWSER_ACTIVITY)) {
            ...
            if (playlistName != null && !playlistName.equals(PluginUtils.RECENTLY_ADDED) && !playlistName.equals(PluginUtils.PODCASTS)) {
    ...
    private void addSongToPlaylist(Context context, PluginUtils.IMusicListenter musicListener, Uri uri, String playlistName) {
