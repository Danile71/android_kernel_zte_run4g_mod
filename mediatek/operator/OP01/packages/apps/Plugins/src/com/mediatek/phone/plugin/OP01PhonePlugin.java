...
public class OP01PhonePlugin extends PhonePluginDefault {
    private static final String TAG = "OP01PhonePlugin";
    private Context mContext;

	public OP01PhonePlugin(Context context) {
		mContext = context;
	}
    
    public CallNotifierExtension createCallNotifierExtension() {
        return new CallNotifierOP01Extension();
    }

    public SettingsExtension createSettingsExtension() {
        return new SettingsOP01Extension();
    }

    public OthersSettingsExtension createOthersSettingsExtension() {
        return new OthersSettingsOP01Extension(mContext);
    }

    public PhoneCallOptionHandlerExtension createPhoneCallOptionHandlerExtension() {
        return new PhoneCallOptionHandlerOP01Extension();
    }
}
