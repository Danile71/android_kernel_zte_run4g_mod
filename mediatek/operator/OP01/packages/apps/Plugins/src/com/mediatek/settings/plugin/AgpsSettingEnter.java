...
public class AgpsSettingEnter extends PreferenceActivity implements
    ...
    private void createPreferenceHierarchy() {
        ...
        if (FeatureOption.MTK_AGPS_APP
            ...
            try{
			    ...
			    Xlog.d(TAG,"agps_sky get agpsInterface fail");
            } 
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference == mAgpsCB) {
            if (mAgpsCB.isChecked()) {
                ...
                Xlog.d(TAG,"agps_sky onPreferenceTreeClick setAgpsEnabled(false)");
                //mAgpsMgr.disable();
            }
    ...
    private void updateLocationToggles() {
        ...
        if (mAgpsCB != null && agpsInterface != null) {
            Xlog.d(TAG, "[agps_sky] agpsSettingsEnter screen check Agps status = "
                    ...
                    .setPositiveButton(R.string.agps_enable_confirm_allow,
                            new DialogInterface.OnClickListener() {
                                public void onClick(
                                    ...
                                    Xlog.d(TAG,"agps_sky onCreateDialog setPositiveButton onClick "
                                        + "setAgpsEnabled(true)");
                                }
                            })
                    .setNegativeButton(R.string.agps_enable_confirm_deny,
                            new DialogInterface.OnClickListener() {
                                public void onClick(
                                    ...
                                    Xlog.d(TAG, "agps_sky mAgpsMgr.getStatus()"
                                            + agpsInterface.getAgpsConfig().agpsSetting.agpsEnable);
                                    if (!agpsInterface.getAgpsConfig().agpsSetting.agpsEnable) {
                                        mAgpsCB.setChecked(false);
                                        Xlog.d(TAG,"agps_sky onCreateDialog setNegativeButton onClick "
                                        + "setChecked(false)");
                                    }
