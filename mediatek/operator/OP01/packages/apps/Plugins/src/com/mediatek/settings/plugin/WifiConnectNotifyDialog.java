...
public class WifiConnectNotifyDialog extends AlertActivity
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(action)) {
                ...
                Xlog.d(TAG, " receive action");
                if (!info.isConnected()) {
                    Xlog.d(TAG, " disconnected, finish dialog");
                    finish();
                }
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Xlog.d(TAG, " mTimeView = " + mTimeView);
        p.mView = createView();
    ...
    private View createView() {
        Xlog.d(TAG, " createView()");
        StringBuilder summary = new StringBuilder();
        summary.append(getString(R.string.wifi_cmcc_costs_msg));
        summary.append("\n");
        summary.append(String.format(getString(R.string.wifi_count_down_sec), "2"));
    ...
    protected void onResume() {
        ...
        super.onResume();
        if (mWifiCount == null) {
            mWifiCount = new WifiCount(3000, 1000);
            mWifiCount.start();
        }
    }
