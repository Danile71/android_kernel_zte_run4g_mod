...
public class Op02DownloadProviderFeatureExt extends DefaultDownloadProviderFeatureExt {
    ...
    public void setContinueDownload(boolean contiDownload, boolean value) {
        Xlog.i(TAG, "Enter: " + "setContinueDownload" + " --OP02 implement");
        contiDownload = value;
    }
    ...
    public void notifyFileAlreadyExistIntent(Uri uri, String packageName, String className,
        ...
        Xlog.i(TAG, "Enter: " + "notifyFileAlreadyExistIntent" + " --OP02 implement");
    ...
    public void finishCurrentActivity(Activity activity){
        Xlog.i(TAG, "Enter: " + "finishCurrentActivity" + " --OP02 implement");
        activity.finish();
    }
    ...
    public int processFileExistCondition(boolean continueDownload) {
        Xlog.i(TAG, "Enter: " + "processFileExistCondition" + " --OP02 implement");        
        if (!continueDownload) {
