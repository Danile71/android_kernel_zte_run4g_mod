...
public class RewindAndForward extends DefaultRewindAndForwardExtension implements View.OnClickListener {
    ...
    public void onClick(View v) {
        Log.v(TAG, "onClick");
        mMoviePlayer.showMovieController(); //avoid controller to be hidden
        if (v == mStop) {
    ...
    public int getAddedRightPadding() {
        ...
        Log.v(TAG, "getAddedRightPadding() return = " + ret);
        return ret;
    }
    ...
    public void onLayout(int l, int r, int b, int pr) {
        ...
        getPlayer().setControllerButtonPosition(cr + pr);
    ...
    public void updateRewindAndForwardUI(){  
        Log.v(TAG, "updateRewindAndForwardUI() getPlayer() = " + getPlayer());
