...
import com.mediatek.gallery3d.plugin.VideoSettingsActivity;
...
public class StepOptionSettingsHooker extends PluginBaseHooker {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        mMenuStepOption = menu.add(0, getMenuActivityId(MENU_STEP_OPTION_SETTING), 0, mPluginContext.getString(R.string.settings));
        return true;
    }
    @Override
