...
public class OP03PhonePlugin extends PhonePluginDefault {
    private static final String TAG = "OP03PhonePlugin";
    private final Context mContext;

    public OP03PhonePlugin(Context context) {
        mContext = context;
    }

    public SettingsExtension createSettingsExtension() {
        return new SettingsOP03Extension(mContext);
    }
    public MmiCodeExtension createMmiCodeExtension() {
        return new MmiCodeOP03Extension(mContext);
    }
}
