...
public class Use2GOnlyCheckBoxPreference extends CheckBoxPreference {
    ...
    public Use2GOnlyCheckBoxPreference(Context context, PreferenceScreen prefSet) {
        super(context);
        ...
        log(" At the begining, networkMode=" + networkMode + " end");
    ...
    private void showProgressDialog() {
        ...
        mPd.setMessage(mContext.getText(R.string.updating_settings));
    ...
    protected void  onClick() {
        ...
        showProgressDialog();
        int networkType = isChecked() ? Phone.NT_MODE_GSM_ONLY : Phone.NT_MODE_LTE_GSM_WCDMA;
        log("set preferred network type=" + networkType);
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetPreferredNetworkTypeResponse(Message msg) {
            ...
            if (ar.exception == null) {
                ...
                log("get preferred network type=" + type);
        ...
        private void handleSetPreferredNetworkTypeResponse(Message msg) {
            ...
            if (ar.exception != null) {
                ...
                log("set preferred network type, exception=" + ar.exception);
                mPhone.getPreferredNetworkType(obtainMessage(MESSAGE_GET_PREFERRED_NETWORK_TYPE));
            } else {
                log("set preferred network type done");
            }
        }
    }
