...
import com.mediatek.systemui.plugin.Op03StatusBarPlmnPlugin;
...
public class PlmnDisplaySettingsExt extends DefaultStatusBarPlmnDisplayExt{
    ...
    public void createCheckBox(PreferenceCategory pref, int order){
        CheckBoxPreference mcheckboxPref = new CheckBoxPreference(mContext);
        Xlog.d(TAG, "into createCheckBox");
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            Xlog.d(TAG, "set value for boolean =" +(Boolean)newValue);
    ...
    Xlog.d(TAG, "add the mcheckboxPref to preference");
    Xlog.d(TAG, "order ="+order);
   ...
   Xlog.d(TAG, "return mPlmnDisplaySetting "+mPlmnDisplaySetting);
