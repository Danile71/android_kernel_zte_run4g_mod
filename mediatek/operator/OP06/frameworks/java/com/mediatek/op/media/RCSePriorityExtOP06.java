...
public class RCSePriorityExtOP06 extends
        DefaultRCSePriority {
    
    private  Context mContext;
    private static final String TAG = "RCSePriorityExt";

    public RCSePriorityExtOP06() {
	Log.i(TAG, "Constructor default called");
		}
		
    public RCSePriorityExtOP06(ArrayList<String> defaultList) {
	Log.i(TAG, "Constructor with parametres as list");
		   
    }
   
    public RCSePriorityExtOP06(Context context) {
