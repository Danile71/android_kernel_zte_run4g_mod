...
public class Op06RegionalPhoneSmsConfigExt implements IMmsSettingsExt {
	private final static String TAG = "Op06RegionalPhoneSmsConfigExt";
	
    private Context mContext = null;
    private IMmsSettingsHost mMmsHost = null;
    ...
    private class RegionalPhoneContentObserver extends ContentObserver { 
        ...
        public void onChange(boolean selfChange) {
            ...
            querySmsParameter();   
            mMmsHost.setSmsValues(mValues); 
            mMmsHost.registerSmsStateReceiver();
            setSmsTimeStamp((Context)mMmsHost, mTimeStamp);
