...
public class Op06WallpaperPluginExt /*extends ContextWrapper */implements IWallpaperPlugin {
    ...
    public Op06WallpaperPluginExt(Context context) {
        //super(context);
        mContext = context;
        Xlog.d(TAG, "Op06WallpaperPluginExt: call to constructor");
        if(context == null){
            Xlog.d(TAG, "Op06WallpaperPluginExt: cntx null");
	    }else{
	        Xlog.d(TAG, "Op06WallpaperPluginExt: input parameter context valid");
	    }
		/*mContext = getBaseContext();
		if(mContext == null){
            Xlog.d(TAG, "mContext null 2");
	    }else{
	        Xlog.d(TAG, "getBaseContext returned valid context");      
	    }*/
    }
