...
public class OP07CmasSimSwapExt extends DefaultCmasSimSwapExt {
    private static final String TAG = "OP07CmasSimSwapExt";

    public OP07CmasSimSwapExt(Context context) {
        super(context);
    }
