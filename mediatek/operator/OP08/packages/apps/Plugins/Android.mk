...
LOCAL_SRC_FILES := $(call all-java-files-under, src)\
			$(call all-java-files-under, ../../../../common/packages/apps/Plugins/src/com/mediatek/cellbroadcastreceiver/plugin)
			
LOCAL_PACKAGE_NAME :=  OP08Plugin
LOCAL_CERTIFICATE := shared
LOCAL_APK_LIBRARIES := CMASReceiver
