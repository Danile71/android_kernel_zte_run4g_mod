...
public class LowStorageExtOP09 implements ILowStorageExt 
{
	...
	public void init(Context context, long total_size) {       
        ...
        mStorageLowIntent = new Intent("android.intent.action.OP09_DEVICES_STORAGE_LOW");
        mStorageLowIntent.addFlags(Intent.FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT);
        mStorageNotLowIntent = new Intent("android.intent.action.OP09_DEVICES_STORAGE_NOT_LOW");
    ...
    /**
     * Send a OP09 low storage intent.
     */
    ...
    /**
     * Send a OP09 not low storage intent.
     */
