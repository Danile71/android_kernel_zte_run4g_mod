...
public class OplmnUpdateCenter extends Handler {
    private static final String PROPERTY_OPLMN_UPDATE_URL = "https://roam.radiosky.com.cn/cdma/ud/index";
    ...
    private static final String ACTION_OPLMN_UPDATE = "com.mediatek.intent.action.ACTION_OPLMN_UPDATE";

    private static final long UPDATE_INTERVAL = 10 * 24 * 60 * 60 * 1000;
    private static final long MILLISECONDS_TO_SECOND = 60 * 1000;
    ...
    private static final int EVENT_GET_OPLMN_VERSION_DONE = 3;
    ...
    private Runnable mOplmnUpdateRunnable = new Runnable() {
        public void run() {
            ...
            if (oplmnInfo != null) {
                String currentVersion = mSharedPreferences.getString(KEY_OPLMN_UPDATE_VERSION, "0.0");
                ...
                if (OplmnUpdateUtils.compareVersion(oplmnInfo.getVersion(), currentVersion) > 0) {
                    ...
                    if (rawData != null) {
                        ...
                        editor.putString(KEY_OPLMN_UPDATE_TIME, String.valueOf(System.currentTimeMillis()));
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            logd("received broadcast, action = " + action
                    + " at time " + DateFormat.format("yyyy-MM-dd, kk:mm:ss", System.currentTimeMillis()));
            final NetworkInfo info = mConnectivityManager.getActiveNetworkInfo();
            boolean connected = info != null && info.isConnected()
                    && info.getType() == mConnectivityManager.TYPE_MOBILE;
    ...
    public void handleMessage(Message msg) {
        ...
        case EVENT_RETRY_OPLMN_UPDATE:
            ...
            if (oplmnFile != null) {
                ...
                if (cacheOplmn != null) {
                    String version = mSharedPreferences.getString(KEY_OPLMN_UPDATE_VERSION, "0.0");
                    sendOplmnFile(version, cacheOplmn);
                }
            }
            break;
        default:
    ...
    private void logd(String msg) {
        Xlog.d(OplmnUpdateUtils.LOG_TAG_PHONE, OplmnUpdateUtils.LOG_TAG + " " + msg);
    }
}
