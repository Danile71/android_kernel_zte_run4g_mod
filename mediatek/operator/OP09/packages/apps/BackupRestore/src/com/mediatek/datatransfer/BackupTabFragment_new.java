...
public class BackupTabFragment_new extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	View view = mRootView =  inflater.inflate(R.layout.backup, null);
    	loadingContainer = (LinearLayout) view.findViewById(R.id.loading_container);
    	selectCheck = (CheckBox) view.findViewById(R.id.backup_checkbox_select);
    	backupBtn = (Button) view.findViewById(R.id.backup_bt_backcup);
    	backupBtn.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				showContentLoading(i++%2==0);
			}
		});
		return view;
	}

    private void showContentLoading(boolean show){
		loadingContainer.setVisibility(!show?View.GONE:View.VISIBLE);
    }
