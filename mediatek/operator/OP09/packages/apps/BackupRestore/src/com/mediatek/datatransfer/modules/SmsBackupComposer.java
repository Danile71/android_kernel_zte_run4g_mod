...
public class SmsBackupComposer extends Composer {
    ...
    private static final String mStoragePath = Constants.ModulePath.FOLDER_SMS;
    private static final String mStorageName = Constants.ModulePath.SMS_VMSG;
    Writer mWriter = null;
    ...
    public boolean implementComposeOneEntity() {
        ...
        for (int i = 0; i < mSmsCursorArray.length; ++i) {
            if (mSmsCursorArray[i] != null && !mSmsCursorArray[i].isAfterLast()) {
                ...
                String timeStamp = Utils.parseDate(mtime);//formatTimeStampString(mContext, mtime);
                ...
                int mSlotid = Utils.simId2Slot(simid, mContext);
                MyLogger.logD(CLASS_TAG, "mSlotid is " + mSlotid);
...
//    private static final String XREAD = "X-MESSAGE-STATUS:";
...
//    private static final String XTYPE = "X-TYPE:";
	...
	public static String combineVmsg(String TimeStamp, String ReadByte, String BoxType,
	                           int mSlotid, String Locked, String SmsAddress, String body ,String mseen){
        ...
        mBuilder.append("1.1");
        mBuilder.append(VMESSAGE_END_OF_LINE);
        mBuilder.append(XIRMS_TYPE);
        mBuilder.append(VMESSAGE_END_OF_LINE);
        //inbox or sendbox
        mBuilder.append(VMESSAGE_DELIVER);
        mBuilder.append(BoxType.equals("INBOX")?"DELIVER":"SUBMIT");
