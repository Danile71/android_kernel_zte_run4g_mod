...
import com.mediatek.datatransfer.modules.CalllogRestoreComposer;
...
public class BackupFilePreview {
    ...
    private void checkRestored() {
        ...
        MyLogger.logD(CLASS_TAG, "----mIsOtherBackup? --- "+mIsOtherBackup+"----mIsRestored? ---"+mIsRestored);
    }
        ...
        if (files != null) {
            for (File file : files) {
                String[] moduleFolders = new String[] { ModulePath.FOLDER_CALENDAR,
                        ModulePath.FOLDER_CONTACT, ModulePath.FOLDER_CALLLOG,ModulePath.FOLDER_MMS, /*ModulePath.FOLDER_MUSIC,
                        ModulePath.FOLDER_PICTURE,*/ ModulePath.FOLDER_SMS,
                        /*ModulePath.FOLDER_BOOKMARK*/};

                int[] moduleTypes = new int[] { ModuleType.TYPE_CALENDAR, ModuleType.TYPE_CONTACT,ModuleType.TYPE_CALLLOG,
