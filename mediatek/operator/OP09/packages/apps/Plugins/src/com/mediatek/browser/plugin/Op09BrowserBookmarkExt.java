...
public class Op09BrowserBookmarkExt extends DefaultBrowserBookmarkExt {

    private static final String TAG = "Op09BrowserBookmarkExt";
    ...
    public Op09BrowserBookmarkExt(Context context) {
        super();
        mContext = context;
    }
    ...
    public int addDefaultBookmarksForCustomer(SQLiteDatabase db) {
        ...
        Xlog.i(TAG, "Enter: " + "addDefaultBookmarksForCustomer" + " --OP09 implement" + db);
        Resources res = mContext.getResources();
        final CharSequence[] bookmarks = res.getTextArray(
                R.array.bookmarks_for_op09);
        preloads = mContext.getResources().obtainTypedArray(R.array.bookmark_preloads_for_op09);
    ...
    public void createBookmarksPageOptionsMenu(Menu menu, MenuInflater inflater) {
        Xlog.i(TAG, "Enter: " + "createBookmarksPageOptionsMenu" + " --OP09 implement");
    ...
    public boolean bookmarksPageOptionsMenuItemSelected(MenuItem item, Activity activity, long folderId) {
        Xlog.i(TAG, "Enter: " + "bookmarksPageOptionsMenuItemSelected" + " --OP09 implement");
