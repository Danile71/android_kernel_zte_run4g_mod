...
import com.mediatek.mms.ext.DefaultMmsSlideShowExt;

/**
 * M: OP09MmsAdvanceSearchExt
 *
 */
public class Op09MmsSlideShowExt extends DefaultMmsSlideShowExt {
    ...
    private static int FLING_LENGTH = 100;
    ...
    public Op09MmsSlideShowExt(Context context) {
        super(context);
    }

    @Override
    public Direction setMotionEventAndParse(MotionEvent e) {
        MmsLog.d(TAG, "setMotionEventAndParse ext");
        if (e == null) {
