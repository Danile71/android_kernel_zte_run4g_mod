...
public class Op09UnreadMessageNumberExt extends DefaultUnreadMessageNumberExt {
    ...
    public Op09UnreadMessageNumberExt(Context context) {
        super(context);
    }

    public void updateUnreadMessageNumber(final Context context) {
        MmsLog.d(TAG, "OP09UnreadMessageNumberExt: updateUnreadMessageNumber()");
