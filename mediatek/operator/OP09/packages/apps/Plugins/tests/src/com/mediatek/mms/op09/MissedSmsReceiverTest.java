...
public class MissedSmsReceiverTest extends BasicCase {
    private static IMissedSmsReceiver sMissedSmsReceiver;
    ...
    protected void setUp() throws Exception {
        super.setUp();
        sMissedSmsReceiver = (IMissedSmsReceiver)PluginManager.createPluginObject(mContext,
                "com.mediatek.mms.ext.IMissedSmsReceiver");
