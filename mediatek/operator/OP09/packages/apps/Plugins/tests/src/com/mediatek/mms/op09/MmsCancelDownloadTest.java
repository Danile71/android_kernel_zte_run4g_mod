...
public class MmsCancelDownloadTest extends BasicCase {
    private static IMmsCancelDownload sCancelDownload;
    ...
    protected void setUp() throws Exception {
        super.setUp();
        sCancelDownload = (IMmsCancelDownload)PluginManager.createPluginObject(mContext,
                "com.mediatek.mms.ext.IMmsCancelDownload");
    }
    ...
    public void test001CancelDownload() throws Exception {
        ...
        values.put(Mms.STATUS_EXT, IMmsCancelDownload.STATE_DOWNLOADING);
        ...
        assertEquals(IMmsCancelDownload.STATE_ABORTED, sCancelDownload.getStateExt(CONTENT_LOCATION));
        assertEquals(IMmsCancelDownload.STATE_ABORTED, sCancelDownload.getStateExt(mNotificationUri));
    }
