...
import com.mediatek.mms.ext.IMmsMessageListItem;
...
public class MmsMessageListItemTest extends BasicCase implements IMmsMessageListItemHost {
    ...
    private static IMmsMessageListItem sMessageListItem;

    @Override
    protected void setUp() throws Exception {
        super.setUp();
        sMessageListItem = (IMmsMessageListItem)PluginManager.createPluginObject(mContext,
                "com.mediatek.mms.ext.IMmsMessageListItem");
