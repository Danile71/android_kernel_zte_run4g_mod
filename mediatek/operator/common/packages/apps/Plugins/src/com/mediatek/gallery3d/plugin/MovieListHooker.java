    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        if (mMovieList != null) { //list should be filled
            if (mMovieLoader != null && isEnabledVideoList(getIntent())) {
                mMenuPrevious = menu.add(0, getMenuActivityId(MENU_PREVIOUS), 0, mPluginContext.getString(R.string.previous));
                mMenuNext = menu.add(0, getMenuActivityId(MENU_NEXT), 0, mPluginContext.getString(R.string.next));
            }
        }
        return true;
    }
