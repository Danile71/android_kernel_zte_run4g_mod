...
import com.mediatek.dialer.ext.DefaultSimIndicatorExtension;
...
public class DialerGuideExt extends DefaultSimIndicatorExtension {
     ...
     */
    public void switchSimGuide(Activity activity, String type) {
        String name = activity.getLocalClassName();
        Xlog.d(TAG, "activity name:" + name);
