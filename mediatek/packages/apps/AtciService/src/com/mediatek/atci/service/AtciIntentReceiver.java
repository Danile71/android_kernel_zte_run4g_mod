...
public class AtciIntentReceiver extends BroadcastReceiver {
    ...
    static final String MESSAGE_SENT = "com.mediatek.atci.service.MESSAGE_SENT";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (intent.getAction().equals(BOOTUP)) {
            Log.d(LOG_TAG, "Intent Process " + BOOTUP);
            context.startService(new Intent(context, AtciService.class));
        } else if (intent.getAction().equals(MESSAGE_SENT)) {
            Log.d(LOG_TAG, "Intent Process " + MESSAGE_SENT);
            intent.setClass(context, AtciService.class);
