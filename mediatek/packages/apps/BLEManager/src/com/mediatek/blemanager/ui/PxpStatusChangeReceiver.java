...
public class PxpStatusChangeReceiver extends BroadcastReceiver {
    ...
    private static final String STATE_CHANGE_ACTION =
            BleProximityProfileService.ACTION_PXP_UPDATE_STATE;
    private static final String START_SERVICE_ACTION =
            "com.mediatek.bluetooth.action.START_ALERT_SERVICE";

    @Override
    public void onReceive(Context context, Intent intent) {
        String action = intent.getAction();
        Log.d(TAG, "action = " + action);
        if (action != null && action.equals(STATE_CHANGE_ACTION)) {
