...
public class CalendarBackupComposer extends Composer {
    ...
    public void onEnd() {
        ...
        String path = mParentFolderPath + File.separator + ModulePath.FOLDER_CALENDAR;
        String fileName = path + File.separator + ModulePath.NAME_CALENDAR;
        if (fileName != null ) {
