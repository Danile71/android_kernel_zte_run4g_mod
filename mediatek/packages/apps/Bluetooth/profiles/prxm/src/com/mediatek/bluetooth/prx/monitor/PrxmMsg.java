 ...
 ************************************************************************************************/
	...
	// Proximity - Monitor
	public static final int MSG_ID_BT_PRXM_GROUP_START = 3100;
	public static final int MSG_ID_BT_PRXM_CONNECT_REQ = 3100;
	public static final int MSG_ID_BT_PRXM_CONNECT_CNF = 3101;
	public static final int MSG_ID_BT_PRXM_DISCONNECT_REQ = 3102;
	public static final int MSG_ID_BT_PRXM_DISCONNECT_IND = 3103;
	public static final int MSG_ID_BT_PRXM_GET_CAPABILITY_REQ = 3104;
	public static final int MSG_ID_BT_PRXM_GET_CAPABILITY_CNF = 3105;
	public static final int MSG_ID_BT_PRXM_GET_REMOTE_TXPOWER_REQ = 3106;
	public static final int MSG_ID_BT_PRXM_GET_REMOTE_TXPOWER_CNF = 3107;
	public static final int MSG_ID_BT_PRXM_SET_PATHLOSS_REQ = 3108;
	public static final int MSG_ID_BT_PRXM_SET_PATHLOSS_CNF = 3109;
	public static final int MSG_ID_BT_PRXM_SET_LINKLOSS_REQ = 3110;
	public static final int MSG_ID_BT_PRXM_SET_LINKLOSS_CNF = 3111;
	public static final int MSG_ID_BT_PRXM_GET_RSSI_REQ = 3112;
	public static final int MSG_ID_BT_PRXM_GET_RSSI_CNF = 3113;
	public static final int MSG_ID_BT_PRXM_GET_LINKLOSS_REQ = 3114;
	public static final int MSG_ID_BT_PRXM_GET_LINKLOSS_CNF = 3115;
	public static final int MSG_ID_BT_PRXM_GROUP_END = 3116;
