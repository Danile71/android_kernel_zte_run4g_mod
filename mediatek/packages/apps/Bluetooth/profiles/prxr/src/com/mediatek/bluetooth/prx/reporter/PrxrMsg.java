 ...
 ************************************************************************************************/
	...
	// Proximity - Reporter
	public static final int MSG_ID_BT_PRXR_GROUP_START = 3200;
	public static final int MSG_ID_BT_PRXR_REGISTER_REQ = 3200;
	public static final int MSG_ID_BT_PRXR_REGISTER_CNF = 3201;
	public static final int MSG_ID_BT_PRXR_DEREGISTER_REQ = 3202;
	public static final int MSG_ID_BT_PRXR_DEREGISTER_CNF = 3203;
	public static final int MSG_ID_BT_PRXR_AUTHORIZE_IND = 3204;
	public static final int MSG_ID_BT_PRXR_AUTHORIZE_RSP = 3205;
	public static final int MSG_ID_BT_PRXR_CONNECT_IND = 3206;
	public static final int MSG_ID_BT_PRXR_DISCONNECT_REQ = 3207;
	public static final int MSG_ID_BT_PRXR_DISCONNECT_IND = 3208;
	public static final int MSG_ID_BT_PRXR_PATHLOSS_IND = 3209;
	public static final int MSG_ID_BT_PRXR_LINKLOSS_IND = 3210;
	public static final int MSG_ID_BT_PRXR_UPDATE_TXPOWER_REQ = 3211;
	public static final int MSG_ID_BT_PRXR_UPDATE_TXPOWER_CNF = 3212;
	public static final int MSG_ID_BT_PRXR_GROUP_END = 3213;
