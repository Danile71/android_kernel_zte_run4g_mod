...
public class CellBroadcastAlertAudio extends Service implements TextToSpeech.OnInitListener,
    ...
    private static final int PRESIDENT_ALERT_ID_OTHER = 4383;
    private static final int RMT_ALERT_ID = 4380;
    private static final int RMT_ALERT_ID_OTHER = 4393;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
     ...
     /*
        ...
        if(optSetAlertAudioVibration != null){
 ...
 private boolean forcePresidentAlert(){
    	...
    	Log.d(TAG,"[forcePresidentAlert] modeValue:" + modeValue);
    	boolean specialAlert = isSpecialAlert();
    	return specialAlert && modeValue;
    }
 
 private boolean isSpecialAlert(){
	 boolean specialAlert = (PRESIDENT_ALERT_ID == mMessageId) || (PRESIDENT_ALERT_ID_OTHER == mMessageId) || (RMT_ALERT_ID == mMessageId) || (RMT_ALERT_ID_OTHER == mMessageId);
	 Log.d(TAG,"[isSpecialAlert] isSpecialAlert :" + specialAlert);
	 return specialAlert;
 }
}
