    ...
    private Handler mTimeoutHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_OVER_12HOURS:
                ...
                //smsManagerEx.removeCellBroadcastMsg(msg.arg1, msg.arg2, CellBroadcastReceiver.sSlotId);
                Log.i(TAG, "Before delete message, msgid = " + msg.arg1 + " sn = " + msg.arg2);
                smsManagerEx.removeCellBroadcastMsg(msg.arg1, msg.arg2, 0);
                break;
        ...
        new CellBroadcastContentProvider.AsyncCellBroadcastTask(getContentResolver())
                .execute(new CellBroadcastContentProvider.CellBroadcastOperation() {
                    ...
                    public boolean execute(CellBroadcastContentProvider provider) {
                        ...
                        if (!sCompareList.add(cbm) && res != ICmasDuplicateMessageExt.OVER_12_HOURS_IDENTIFY_MSG) {
                        ...
                        case ICmasDuplicateMessageExt.OVER_12_HOURS_IDENTIFY_MSG:
                            ...
                            if (rowNewId > -1) {
                                ...
                                Log.i(TAG, "send MSG_OVER_12HOURS");
