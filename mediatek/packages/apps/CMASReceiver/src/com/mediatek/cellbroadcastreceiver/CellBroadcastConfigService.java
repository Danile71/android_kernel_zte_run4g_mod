        ...
        if (ACTION_ENABLE_CHANNELS.equals(intent.getAction())) {
            ...
            if (enableAlerts) {
                ...
                infos[1] = new SmsBroadcastConfigInfo(
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_PRESIDENTIAL_LEVEL_WITH_OTH_LANG,
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_PRESIDENTIAL_LEVEL_WITH_OTH_LANG, -1, -1, true);
                ...
                infos[3] = new SmsBroadcastConfigInfo(
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_EXTREME_IMMEDIATE_OBSERVED_WITH_OTH_LANG,
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_EXTREME_EXPECTED_LIKELY_WITH_OTH_LANG, -1, -1,
                        isExtremEnable);
                ...
                infos[5] = new SmsBroadcastConfigInfo(
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_SEVERE_IMMEDIATE_OBSERVED_WITH_OTH_LANG,
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_SEVERE_EXPECTED_LIKELY_WITH_OTH_LANG, -1, -1,
                        isSevereEnable);
                ...
                infos[7] = new SmsBroadcastConfigInfo(
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_CHILD_ABDUCTION_EMERGENCY_WITH_OTH_LANG,
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_CHILD_ABDUCTION_EMERGENCY_WITH_OTH_LANG, -1, -1,
                        isAmberEnable);
                ...
                infos[9] = new SmsBroadcastConfigInfo(
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_REQUIRED_MONTHLY_TEST_WITH_OTH_LANG,
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_OPERATOR_DEFINED_USE_WITH_OTH_LANG, -1, -1,
                        true);
                isSetSuccess = smsManagerEx.setCellBroadcastSmsConfig(infos, infos,
                ...
                SmsBroadcastConfigInfo[] info = { new SmsBroadcastConfigInfo(
                        ...
                        SmsCbConstants.MESSAGE_ID_CMAS_ALERT_OPERATOR_DEFINED_USE_WITH_OTH_LANG, -1, -1,
                        false) };
                isSetSuccess = smsManagerEx.setCellBroadcastSmsConfig(info, info,
                        CellBroadcastReceiver.sSlotId);

            }
            if (DBG) {
                SmsBroadcastConfigInfo[] configInfo = smsManagerEx
                        .getCellBroadcastSmsConfig(CellBroadcastReceiver.sSlotId);
                if (configInfo != null) {
