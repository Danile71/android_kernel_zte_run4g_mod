...
public class CheckBoxAndSettingsPreference extends CheckBoxPreference {
    ...
    public static final int MESSAGE_ENABLE_CB_END_ERROR = 102;
    ...
    private class CBEnableThread extends Thread {
        ...
        public void run() {
            ...
            // Configurate channels by CellBroadcastReceiver, if error happened, mMsg.what will be
            // changed to 'MESSAGE_ENABLE_CB_ERROR'.
            mMsg = mHandler.obtainMessage(MESSAGE_ENABLE_CB_END, 0, 0, null);
