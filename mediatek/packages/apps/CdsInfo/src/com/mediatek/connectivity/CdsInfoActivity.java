...
public class CdsInfoActivity extends Activity implements OnItemClickListener {
    ...
    private static final String ITEM_STRINGS[] = { "CDS Information", "Wi-Fi Information", "Wi-Fi P2P Information", "Radio Information", "Network Utility", "Background Data Usage",
            "Multiple APN", "Connectivity Testing", "MTU Configuration", "Socket Inforomation", "PS data control"
            };
    private static final String ITEM_INTENT_STRING[] = {"CdsCommonInfoTabActivity", "CdsWifiInfoActivity", "CdsWifiP2pInfoActivity", "CdsRadioMenuActivity", "CdsUtilityActivity",
    ...
    private List<String> getData() {
        ...
        for (int i = 0; i < ITEM_STRINGS.length; i++) {
            if(i == 5)  //Remove Background Data Usage from BSP package
                continue;
