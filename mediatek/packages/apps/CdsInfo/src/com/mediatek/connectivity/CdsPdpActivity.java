...
public class CdsPdpActivity extends Activity implements View.OnClickListener {
    ...
    private static final String[] APN_LIST = new String[] {"MMS", "SUPL", "WAP", "HIPRI", "DUN"};
    private static final int[] APN_TYPE_LIST = new int[] {ConnectivityManager.TYPE_MOBILE_MMS, ConnectivityManager.TYPE_MOBILE_SUPL,
            ConnectivityManager.TYPE_MOBILE_WAP, ConnectivityManager.TYPE_MOBILE_HIPRI, ConnectivityManager.TYPE_MOBILE_DUN
                                                         };
        ...
        for (String naString : naStrings) {
            try {
                ...
                if (n.type > ConnectivityManager.MAX_NETWORK_TYPE) {
                    ...
                    Log.i(TAG, "Skip default data connection");
                    continue;
                }
    ...
    private int getDataConnectionFromSetting() {
        ...
        if(slot < 0) {
            Log.e(TAG, "Set default SIM slot to 0 due to slot is " + slot);
            slot = 0;
        }
        Log.v(TAG, "Default Data Setting value=" + slot);
    ...
    private void handleStopAPN() {
        ...
        Log.i(TAG, "[Feature][Stop]" + mSelectApnFeature);
    }
    ...
    private void handleStartAPN() {
        ...
        Log.i(TAG, "[Feature][Start]" + mSelectApnFeature);
    ...
    private BroadcastReceiver mNetworkConnReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
                ...
                Log.i(TAG, "Type:" + type + "/ state:" + state);
