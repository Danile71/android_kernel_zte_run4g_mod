...
public final class DmConst {
    ...
    public static final class PathName {
        ...
        public static final String CONFIG_FILE_IN_SYSTEM = PATH_IN_SYSTEM + "/config.xml";
        public static final String CONFIG_FILE_IN_DATA = PATH_IN_DATA + "/config.xml";
        public static final String UPDATE_RESULT_FILE = "/data/data/com.mediatek.dm/files/updateResult";
