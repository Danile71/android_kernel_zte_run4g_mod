...
public final class MTKPhone {
    ...
    public static String getSubscriberIdGemini(TelephonyManagerEx telMgr,
            int simId) {
        return telMgr.getSubscriberId(simId);
    }

    public static String getDeviceIdGemini(TelephonyManagerEx telMgr, int slot) {
        return telMgr.getDeviceId(slot);
    }
    ...
    public static String getSimOperatorNameGemini(TelephonyManagerEx telMgr,
            int slot) {
        return telMgr.getSimOperatorName(slot);
    }

    public static int getPhoneTypeGemini(TelephonyManagerEx telMgr, int slot) {
        return telMgr.getPhoneType(slot);
    }

    public static boolean hasIccCardGemini(TelephonyManagerEx telMgr, int slot) {
        return telMgr.hasIccCard(slot);
    }
