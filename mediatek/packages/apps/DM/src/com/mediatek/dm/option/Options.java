...
package com.mediatek.dm.option;

public final class Options {
    public static final boolean USE_DIRECT_INTERNET = true;
    public static final boolean USE_SMS_REGISTER = false;
    public static final boolean USE_SCHEDULED_POLLING = false;
    public static final boolean SCOMO_SUPPORT = true;
    public static final boolean LAWMO_SUPPORT = true;
