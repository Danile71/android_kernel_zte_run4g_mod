...
public class Fumo04UpdateTests extends AndroidTestCase {
    ...
    public void atestFOTAUpdateSystem() {
        File fotaFile = new File(FOTA_PACKAGE_PATH);
        if (!fotaFile.exists()) {
            Log.d(TAG, "FOTA package doesn't exist, skip this case.");
            return;
        }
//        DmController controller = new DmController(this.mContext);
//        controller.executeFwUpdate();
    }
