...
public class DataUsageStageView extends StageTextureView {
    ...
    public void showResource() {
        ...
        log(TAG, "screenWidthInDp: " + screenWidthInDp + ", screenHeightInDp:" + screenHeightInDp + ", density:" + displayMetrics.density);
        log(TAG, "res_folder: " + getResources().getString(R.string.res_folder));
    }
        ...
        synchronized (this) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    mActorCard1 = null;
                    mActorCard2 = null;
                    log(TAG, "onTouchEvent->ACTION_DOWN: (" + touchX + "," + touchY + ")");

                    if (mContainerCircle1 != null) {
                        log(TAG, "Circle1: " + mContainerCircle1.getPosition());
                    }

                    if (mContainerCircle2 != null) {
                        log(TAG, "Circle2: " + mContainerCircle2.getPosition());
                    }
