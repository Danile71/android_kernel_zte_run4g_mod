...
public class ApMcu extends CpuStressCommon implements OnClickListener, OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (cpuTestMode == CpuStressTestService.MODE_CUSTOM_V2) {
            //findViewById(R.id.apmcu_max_power_64_ll).setVisibility(View.VISIBLE);
            //findViewById(R.id.apmcu_dhrystone_64_ll).setVisibility(View.VISIBLE);
            findViewById(R.id.apmcu_saxpy_ll).setVisibility(View.VISIBLE);
            //findViewById(R.id.apmcu_saxpy_64_ll).setVisibility(View.VISIBLE);
            findViewById(R.id.apmcu_adv_sim_ll).setVisibility(View.VISIBLE);
            //findViewById(R.id.apmcu_idle_to_max_ll).setVisibility(View.VISIBLE);
        }
    ...
    private void updateTestUi(TestDataSet testDataSet) {
        Xlog.v(TAG, "updateTestUI: " + testDataSet.running + " " + testDataSet.leftTestCount);
    ...
    private void showTestResult(int indexMode, TestDataSet testDataSet) {
        ...
        for (int i = 0; i < APMCU_TEST_INDEXS.length; i++) {
            ...
            Xlog.d(TAG, "showTestResult: i:" + i + " testData:" + testData);
            if (testData.enabled) {
    ...
    public void onClick(View arg0) {
        if (mBtnStart.getId() == arg0.getId()) {
            ...
            if (getResources().getString(R.string.hqa_cpustress_apmcu_start)
                ...
                Xlog.d(TAG, "testDataSet.leftTestCount:" + testDataSet.leftTestCount);
                int cbMask = 0;
                for (int i = 0; i < APMCU_TEST_INDEXS.length; i++) {
