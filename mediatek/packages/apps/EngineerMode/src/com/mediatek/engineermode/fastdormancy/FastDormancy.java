...
public class FastDormancy extends Activity implements OnClickListener {
    ...
    //                }
                ...
                if (isSuccess) {
                    ...
                    Toast.makeText(FastDormancy.this, "Please set value between 5~3600!", Toast.LENGTH_LONG).show();
                    Toast.makeText(FastDormancy.this, "Restore to default: 20", Toast.LENGTH_LONG).show();
                }
            }
