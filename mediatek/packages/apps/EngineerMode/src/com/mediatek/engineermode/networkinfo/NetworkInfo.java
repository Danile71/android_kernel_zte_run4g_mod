...
public class NetworkInfo extends Activity {
    ...
    public static final String LOG_TAG = "NetworkInfo";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCheckBox[Content.URR_3G_GENERAL_INDEX] = (CheckBox) findViewById(R.id.NetworkInfo_3GGeneralStatus);
        ...
        if (mSimType == PhoneConstants.GEMINI_SIM_1) {
            if (FeatureOption.MTK_LTE_DC_SUPPORT && LteModemSwitchHandler.isLteDcMode()) {
        ...
        mCheckBox[Content.SECURITY_CONFIGURATION_INDEX] = (CheckBox) findViewById(R.id.NetworkInfo_3GSecurityConfiguration);
        if (!FeatureOption.MTK_TC1_FEATURE) {
    ...
    public boolean onOptionsItemSelected(MenuItem aMenuItem) {
        ...
        case CHECK_INFOMATION_ID:
            ...
            if (mSimType == PhoneConstants.GEMINI_SIM_1
                    && "OP09".equals(SystemProperties.get("ro.operator.optr"))) {
                Toast.makeText(this, getString(R.string.networkinfo_not_support), Toast.LENGTH_LONG).show();
                break;
            }
