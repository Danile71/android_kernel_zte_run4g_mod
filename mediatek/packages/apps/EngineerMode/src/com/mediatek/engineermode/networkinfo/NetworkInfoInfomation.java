...
public class NetworkInfoInfomation extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNetworkInfo.put(Content.CELL_INDEX,    new NetworkInfoItem("RR Cell Sel", Content.CELL_SEL_SIZE));
        mNetworkInfo.put(Content.CHANNEL_INDEX, new NetworkInfoItem("RR Ch Dscr", Content.CH_DSCR_SIZE));
        mNetworkInfo.put(Content.CTRL_INDEX,    new NetworkInfoItem("RR Ctrl chan", Content.CTRL_CHAN_SIZE));
        mNetworkInfo.put(Content.RACH_INDEX,    new NetworkInfoItem("RR RACH Ctrl", Content.RACH_CTRL_SIZE));
        mNetworkInfo.put(Content.LAI_INDEX,     new NetworkInfoItem("RR LAI Info", Content.LAI_INFO_SIZE));
        mNetworkInfo.put(Content.RADIO_INDEX,   new NetworkInfoItem("RR Radio Link", Content.RADIO_LINK_SIZE));
        mNetworkInfo.put(Content.MEAS_INDEX,    new NetworkInfoItem("RR Meas Rep", Content.MEAS_REP_SIZE));
        mNetworkInfo.put(Content.CA_INDEX,      new NetworkInfoItem("RR Ca List", Content.CAL_LIST_SIZE));
        mNetworkInfo.put(Content.CONTROL_INDEX, new NetworkInfoItem("RR Control Msg", Content.CONTROL_MSG_SIZE));
        mNetworkInfo.put(Content.SI2Q_INDEX,    new NetworkInfoItem("RR SI2Q Info", Content.SI2Q_INFO_SIZE));
        mNetworkInfo.put(Content.MI_INDEX,      new NetworkInfoItem("RR MI Info", Content.MI_INFO_SIZE));
        mNetworkInfo.put(Content.BLK_INDEX,     new NetworkInfoItem("RR BLK Info", Content.BLK_INFO_SIZE));
        mNetworkInfo.put(Content.TBF_INDEX,     new NetworkInfoItem("RR TBF Info", Content.TBF_INFO_SIZE));
        mNetworkInfo.put(Content.GPRS_INDEX,    new NetworkInfoItem("RR GPRS Gen", Content.GPRS_GEN_SIZE));
        mNetworkInfo.put(Content.SM_INFO_INDEX, new NetworkInfoItem("SM EM Info", Content.SM_EM_INFO_SIZE));
        mNetworkInfo.put(Content.GMM_INFO_INDEX, new NetworkInfoItem("GMM EM Info", Content.GMM_EM_INFO_SIZE));
        mNetworkInfo.put(Content.MM_INFO_INDEX, new NetworkInfoItem("RR 3G MM EM Info", Content.M3G_MM_EMINFO_SIZE));
        mNetworkInfo.put(Content.URR_3G_GENERAL_INDEX, new NetworkInfoItem("URR 3G General Status", Content.URR_3G_GENERAL_SIZE));
        mNetworkInfo.put(Content.TCM_MMI_INDEX, new NetworkInfoItem("RR 3G TCM MMI EM Info", Content.M_3G_TCMMMI_INFO_SIZE));
        mNetworkInfo.put(Content.CSCE_SERV_CELL_STATUS_INDEX,     new NetworkInfoItem("RR 3G CsceEMServCellSStatusInd", Content.CSCE_SERV_CELL_STATUS_SIZE));
        mNetworkInfo.put(Content.CSCE_NEIGH_CELL_STATUS_INDEX,    new NetworkInfoItem("RR xG CsceEMNeighCellSStatusIndStructSize", Content.XGCSCE_NEIGH_CELL_STATUS_SIZE));
        mNetworkInfo.put(Content.CSCE_MULTIPLMN_INDEX,            new NetworkInfoItem("RR 3G CsceEmInfoMultiPlmn", Content.CSCE_MULTI_PLMN_SIZE));
        mNetworkInfo.put(Content.PERIOD_IC_BLER_REPORT_INDEX,     new NetworkInfoItem("RR 3G MemeEmPeriodicBlerReportInd", Content.PERIOD_IC_BLER_REPORT_SIZE));
        mNetworkInfo.put(Content.URR_UMTS_SRNC_INDEX,             new NetworkInfoItem("RR 3G UrrUmtsSrncId", Content.URR_UMTS_SRNC_SIZE));
        mNetworkInfo.put(Content.HSERV_CELL_INDEX,                new NetworkInfoItem("RR 3G MemeEmInfoHServCellInd", Content.MEME_HSERV_CELL_SIZE));
        // add for LGE
        mNetworkInfo.put(Content.SLCE_VOICE_INDEX, new NetworkInfoItem("3G speech codec", Content.SLCE_VOICE_SIZE));
        mNetworkInfo.put(Content.SECURITY_CONFIGURATION_INDEX, new NetworkInfoItem("Security Configuration", Content.SECURITY_CONFIGURATION_SIZE));

        if (modemType == NetworkInfo.MODEM_FDD) {
            mNetworkInfo.put(Content.UMTS_CELL_STATUS_INDEX, new NetworkInfoItem("RR 3G MemeEmInfoUmtsCellStatus", Content.UMTS_CELL_STATUS_SIZE));
            mNetworkInfo.put(Content.PSDATA_RATE_STATUS_INDEX, new NetworkInfoItem("RR 3G SlceEmPsDataRateStatusInd", Content.SLCE_PS_DATA_RATE_STATUS_SIZE));
        } else if (modemType == NetworkInfo.MODEM_TD) {
            mNetworkInfo.put(Content.HANDOVER_SEQUENCE_INDEX, new NetworkInfoItem("RR 3G HandoverSequenceIndStuct", Content.HANDOVER_SEQUENCE_SIZE));
            mNetworkInfo.put(Content.UL_ADM_POOL_STATUS_INDEX, new NetworkInfoItem("RR 3G Ul2EmAdmPoolStatusIndStruct", Content.ADM_POOL_STATUS_SIZE));
            mNetworkInfo.put(Content.UL_PSDATA_RATE_STATUS_INDEX, new NetworkInfoItem("RR 3G Ul2EmPsDataRateStatusIndStruct", Content.UL2_PSDATA_RATE_STATUS_SIZE));
            mNetworkInfo.put(Content.UL_HSDSCH_RECONFIG_STATUS_INDEX, new NetworkInfoItem("RR 3G Ul2EmHsdschReconfigStatusIndStruct", Content.UL_HSDSCH_RECONFIG_STATUS_SIZE));
            mNetworkInfo.put(Content.UL_URLC_EVENT_STATUS_INDEX, new NetworkInfoItem("RR 3G Ul2EmUrlcEventStatusIndStruct", Content.URLC_EVENT_STATUS_SIZE));
            mNetworkInfo.put(Content.UL_PERIOD_IC_BLER_REPORT_INDEX, new NetworkInfoItem("RR 3G Ul2EmPeriodicBlerReportInd", Content.UL_PERIOD_IC_BLER_REPORT_SIZE));
        }
    ...
    private void registerNetwork() {
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            ...
            mLteDcPhone.registerForNetworkInfo(mUrcHandler, MSG_NW_INFO_URC, null);
        } else {
    ...
    private void unregisterNetwork() {
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            mGeminiPhone.getPhonebyId(mSimType).unregisterForNetworkInfo(mUrcHandler);
                ...
                && mSimType == PhoneConstants.GEMINI_SIM_1) {
            mLteDcPhone.unregisterForNetworkInfo(mUrcHandler);
        } else {
    ...
    private void sendATCommand(String[] atCommand, int msg) {
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            mGeminiPhone.invokeOemRilRequestStringsGemini(atCommand,
                ...
                && mSimType == PhoneConstants.GEMINI_SIM_1) {
            mLteDcPhone.invokeOemRilRequestStrings(atCommand, mATCmdHander.obtainMessage(msg));
        } else {
    ...
    private String handle3gGeneralStatusInfo(String oldValue, String newValue) {
        final String SERVICE_NO_CHANGE = "04";
        final String RRC_NO_CHANGE = "06";
        final String NO_CHANGE = "FEFF";
