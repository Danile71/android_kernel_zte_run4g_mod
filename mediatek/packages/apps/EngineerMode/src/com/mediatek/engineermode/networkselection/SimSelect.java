...
public class SimSelect extends Activity implements OnItemClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.simselect);

        ListView simTypeListView = (ListView) findViewById(R.id.ListView_SimSelect);

        ArrayList<String> items = new ArrayList<String>();
        items.add(getString(R.string.ct_sim_1));
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        if (arg2 == 0) {
            ...
            intent.setClass(this, NetworkSelection.class);
