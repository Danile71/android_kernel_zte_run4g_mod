...
public class RadioInfo extends Activity {
    ...
    private static final int LTE_GSM_VALUE = Phone.NT_MODE_LTE_GSM;
    ...
    private AdapterView.OnItemSelectedListener mPreferredNetworkHandler = new AdapterView.OnItemSelectedListener() {
