...
public class RfDesenseTxTestLte extends Activity implements Button.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onClick(View v) {
        ...
        case R.id.button_start:
            ...
            String command = "AT+ERFTX=6,0,1," +
                    (mBand.getSelectedItemPosition() + (mTdd.isChecked() ? TDD_BAND_MIN : FDD_BAND_MIN)) + "," +
    ...
    private void saveState() {
        SharedPreferences.Editor editor =
                getSharedPreferences(RfDesenseTxTest.PREF_FILE, MODE_WORLD_READABLE | MODE_WORLD_WRITEABLE).edit();
    ...
    private void restoreState() {
        SharedPreferences pref =
                getSharedPreferences(RfDesenseTxTest.PREF_FILE, MODE_WORLD_READABLE | MODE_WORLD_WRITEABLE);
    ...
    private int getDefaultFreq() {
        int band = mBand.getSelectedItemPosition() + (mTdd.isChecked() ? TDD_BAND_MIN : FDD_BAND_MIN);
