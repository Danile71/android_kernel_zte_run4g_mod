...
public class WfdVdoCapability extends Activity implements OnClickListener {
    ...
    private RadioButton[] mRdResoulution =  new RadioButton[2]; // 0: 720p(30p), 1: 720p(60p), 2: 1080p(30p)
...
//                }
//                
//                if( mRg720pDefinition.getCheckedRadioButtonId() != R.id.Wfd_Vdo_720p_def_l) {
