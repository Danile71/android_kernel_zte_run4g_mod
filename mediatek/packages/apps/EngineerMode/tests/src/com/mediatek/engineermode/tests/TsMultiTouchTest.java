...
public class TsMultiTouchTest extends ActivityInstrumentationTestCase2<TsMultiTouch> {
    private static final String TAG = "TsMultiTouchTest";
    ...
    public void test02_TouchTest() {
        ...
        if (!mSolo.getCurrentViews(EditText.class).isEmpty()) {
            mSolo.enterText(0, "4");
            mSolo.sleep(EmOperate.TIME_SUPER_LONG);
    ...
    public void test03_RandomMoveTest() {
        ...
        final TestCaseUtils.Point center = new TestCaseUtils.Point();
        center.x = 200;
        center.y = 400;
        final TestCaseUtils.Point bottom = new TestCaseUtils.Point();
        bottom.x = 200;
        bottom.y = 800;
        final TestCaseUtils.Point top = new TestCaseUtils.Point();
        top.x = 200;
        top.y = 0;
