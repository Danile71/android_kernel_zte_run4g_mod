...
public class FMTransmitterStation {
    ...
    public static final int INVALID_LOWEST_STATION = FeatureOption.MTK_FM_50KHZ_SUPPORT ? 9760 : 976;
    public static final int INVALID_HIGEST_STATION = FeatureOption.MTK_FM_50KHZ_SUPPORT ? 9940 : 994;
    ...
    private static IFMTXSearchChannelListenter mFMTXSearchChannelListenter;
    ...
    public static void setSearchChannelListenter(
            IFMTXSearchChannelListenter FMSearchChannelListenter) {
        mFMTXSearchChannelListenter = FMSearchChannelListenter;
    }

    public static IFMTXSearchChannelListenter getSearchChannelListenter() {
        return mFMTXSearchChannelListenter;
    }

    public interface IFMTXSearchChannelListenter {
