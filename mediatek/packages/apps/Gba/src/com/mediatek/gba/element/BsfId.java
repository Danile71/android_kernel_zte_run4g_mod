...
public class BsfId {
    ...
    /**
     * @param mBsfFullDnsName - full DNS name of BSF server
    ...
    public BsfId(final byte[] bsfIdBin) {        
        ...
        System.arraycopy(bsfIdBin, bsfIdBin.length - MAX_LENGTH, mUaSecurityProtocolId, 0, MAX_LENGTH);        
    }
    ...
    private byte[] createBsfIdBin(final String bsfFullDnsName,
        ...
        final ByteArrayOutputStream byteArrayWriter = new ByteArrayOutputStream(bsfFullDnsNameBytes.length + uaSecurityProtocolId.length);
        byteArrayWriter.write(bsfFullDnsNameBytes, 0, bsfFullDnsNameBytes.length);
        byteArrayWriter.write(uaSecurityProtocolId, bsfFullDnsNameBytes.length, uaSecurityProtocolId.length);
