        ...
        try {
            ...
            for (Iterator infoIterator = downloads.iterator(); infoIterator.hasNext();) {
                ...
                if (info.mState == State.RUNNING || info.mState == State.CONNECTING) {
                    ...
                    if(info.isGroup()) {
                        builder.setContentTitle(res.getString(R.string.notification_group_title, info.mCount));
                    } else {
                    ...
                    if (info.getResult()) {
                        ...
                        final Intent intent = new Intent(HotKnotBeamService.HOTKNOT_DL_COMPLETE, uri, mContext, HotKnotBeamReceiver.class);
                        ...
                        if(info.isGroup()) {
                            builder.setContentTitle(res.getString(R.string.notification_group_received, info.mCount));
                        } else {
                            builder.setContentTitle(info.getTitle());
                        }
