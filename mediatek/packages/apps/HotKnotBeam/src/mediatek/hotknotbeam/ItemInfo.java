...
public class ItemInfo {
    ...
    public String toString() {
        ...
        str.append(getTag() + " " + mState + " " + mCurrentBytes + "/" + mTotalBytes + ":" + mOrder + ":" + mCount + ":" + isGroup() + ":" + getResult() + ":" + mFileName);
    ...
    public boolean isDead(){
        ...
        if(mLastCurrentBytes < mCurrentBytes){
            ...
            if((currentTimeStamp - mLastTimeStamp) > HotKnotBeamConstants.MAX_NOTIFY_TIMEOUT_VALUE){
                Log.e(TAG, "No update too long:" + currentTimeStamp + ":" +  mLastTimeStamp);
                isDead = true;
            }
        }
        return isDead;
