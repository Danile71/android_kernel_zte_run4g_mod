...
/**
 * This class is a thin wrapper of MdmEngine and MOs creation. It configures engine, register observer and IO handlers.
 */
public class DmController {

    /**
     * @param service Android context
     */
    public DmController(
            DmService service,
            SessionStateObserver sessionObserver,
            NIAMsgHandler niaHandler,
            SessionInitiator niaInitiator,
    ...
    public void triggerReportSession(
            String correlator,
            String format,
            String type,
            String mark,
        ...
        try {
            mEngine.triggerReportSession(correlator,
                    format,
                    type,
                    mark,
                    source,
