...
public class DmOperation extends Properties implements Comparable<DmOperation> {
    public static class KEY {
        ...
        public static final String ANDSF_TAG = "ANDSFTag";
        public static final String WFHS_TAG = "WFHSTag";
        public static final String SCOMO_DP = "SCOMODP";
        public static final String CONNECTION = "Connection";
        public static final String ACTION_MASK = "ActionMask";
        //For cmcc wap push, key value is boolean, if true means data Connection should turn off
        public static final String IS_STEAL_DATA_Connection = "IsStealDataConn";
    }
