    ...
    protected Dialog onCreateDialog(int id) {
        if (id == DIALOG_REPORT) {
                ...
                if (mIsUpdateSuccessfull) {
                    ...
                    msg = getString(R.string.updateSuccess) + CustomProperties.getString("Setting", "SWVerno", Build.DISPLAY);
                } else {
                    title = getString(R.string.updateFailTitle);
                    msg = getString(R.string.updateFail) + CustomProperties.getString("Setting", "SWVerno", Build.DISPLAY);
                }
