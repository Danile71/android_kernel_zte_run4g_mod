...
/**
 * PlainBinHandler is an abstract NodeIoHandler implementation which provides writable control and
 * a simple wrapper for straightforward String data access interface. Descendants of this class should
 * override readValue and writeValue methods to provide simple String read/write function for PlainBinHandler.
 * The interaction protocol (e.g. size inspection) is taken care of by PlainBinHandler.
 * @author mtk81226
 *
 */
