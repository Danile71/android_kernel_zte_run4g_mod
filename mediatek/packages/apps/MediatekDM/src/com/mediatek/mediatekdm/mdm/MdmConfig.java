...
public class MdmConfig {
    ...
    public static enum NotifVerificationMode {
        ...
        DISABLED(0),
        /**
         * When the client receives a notification message and the verification of the notification fails, the client tries
         * to authenticate the notification again using the special nonce value, 0x00000000.
         */
        RESET_NONCE(1),
        /**
         * When the client receives a notification message and the verification of the notification fails, the client tries
        ...
        REVERIFY(2),
        /**
         * Upon authentication failure, the notification message is ignored and no session is initiated.
         */
        STRICT(3);
    ...
    /**
     * <b>NOTE:</b> Setting this configuration to TRUE contradicts OMA DM standard behavior and can break the client-server
     * authentication negotiation when the authentication type is other than "none".
     * 
     * @param abort
     * @throws MdmException
     */
    ...
    /**
     * Set whether to verify the version and the type of the parsed Download Descriptor. The initial value is FALSE,
     * indicating no verification. Call after MDMEngine has been created and before MDMEngine.start(). <b>Note:</b> Setting
     * this configuration to TRUE contradicts OMA DM standard behavior and is not recommended. Verification should be used
    ...
    /**
     * Set whether TNDS support is enabled or not. The initial value is true. Call after MdmEngine has been created and
     * before MdmEngine.start().
     * 
     * @param isEnabled true if TNDS should be enabled.
     * @throws MdmException OUT_OF_SYNC if the function is called after MdmEngine.start().
     */
