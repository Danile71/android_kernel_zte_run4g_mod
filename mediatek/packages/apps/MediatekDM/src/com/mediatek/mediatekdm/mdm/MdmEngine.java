...
public class MdmEngine {
     ...
     * @param target
     * @param data
     * @param account The Value of the DM Account node in the DM tree. (null for default DM account).
    ...
    /**
     * This method will be invoked by native implementation of MDM engine each time it sends a message
     * to server.
     * @return
     */
