...
public class MdmTree {
    ...
    private static class TreeManagerAgent {
        ...
        //add API for SOAP OSU to Add sub tree,sync tree mo
        public native boolean addSubTree(String nodeUri, byte[] data);
        //add API for SOAP Remediation to replace sub tree,sync tree mo
        public native boolean replaceSubTree(String nodeUri, byte[] data);
     ...
     * @throws MdmException
     */
    public boolean deleteNode(String nodeUri) throws MdmException {
        boolean result = false;
    ...
    public boolean addSubTree(String nodeUri,byte[] data) throws MdmException {
        boolean result = false;
        if (!mTMA.addSubTree(nodeUri,data)) {
            //throw new MdmException(MdmError.INTERNAL);
            result = false;
        } else {
            result = true;
    ...
    public boolean replaceSubTree(String nodeUri,byte[] data) throws MdmException {
        boolean result = false;
        if (!mTMA.replaceSubTree(nodeUri,data)) {
            //throw new MdmException(MdmError.INTERNAL);
            result = false;
        } else {
            result = true;
