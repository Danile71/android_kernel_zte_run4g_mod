...
public interface MmiConfirmation {
    ...
    /**
     * Prompt user to confirm / decline a session. The MmiObserver must be notified upon a user response, cancellation, or
     * timeout.
     * 
     * @param context Context of the screen to be displayed.
     * @param defaultCommand Which command (confirm/declined), if any, should be selected by default.
