...
public interface NIAMsgHandler {
    ...
    /**
     * A NIA message content has been parsed successfully after Notification Initiated DM session (NIDM) is triggered. The
     * parsed content is also passed. After handling the notification alert content, this method should call either
     * MdmEngine.notifyNIASessionProceed() to proceed with the DM session or MdmEngine.cancelSession()to abort the session.
     * 
