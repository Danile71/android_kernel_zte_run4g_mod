...
public interface PLFactory {
     ...
     *  
     * @param url URL of the host, which can be either HTTP of HTTPS.
     * @param proxyType 0 -- DIRECT, 1 -- PROXY(HTTP??), 2 --SOCKS
     * @param proxyAddr URL of the proxy.
     * @param proxyPort port of the proxy.
     * @return A new HttpConnection instance or null. If it returns null, then engine will use its own implementation.
     */
