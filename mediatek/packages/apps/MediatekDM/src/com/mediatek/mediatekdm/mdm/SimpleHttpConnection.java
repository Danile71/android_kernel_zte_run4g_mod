...
public class SimpleHttpConnection implements PLHttpConnection {
    class CertTrustManager implements X509TrustManager {
        ...
        public void checkServerTrusted(X509Certificate[] arg0, String arg1)
            ...
            mLogger.logMsg(MdmLogLevel.DEBUG, "[checkServerTrusted] X509Certificate amount:" + arg0.length
                    + ", cryptography: " + arg1);
        }
    ...
    private TrustManager[] mTrustManagerArray = new TrustManager[] {
    ...
    public boolean addRequestProperty(String field, String value) {
        ...
        try {
            ...
            mLogger.logMsg(MdmLogLevel.ERROR, "AddRequestProperty: Exception");
        }
    ...
    public int getHeadFieldInt(String field, int defValue) {
        mLogger.logMsg(MdmLogLevel.DEBUG, "getHeadFieldInt: field=" + field + " ,defValue=" + defValue);
        if (mConnection == null) {
