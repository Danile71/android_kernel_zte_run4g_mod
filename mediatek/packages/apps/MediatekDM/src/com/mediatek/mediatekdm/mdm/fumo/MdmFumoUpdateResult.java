...
public class MdmFumoUpdateResult {
    public static enum ResultCode {
        ...
        USER_CANCELED(401),
        DOWNLOAD_CANCELED(401),
        /**
         * Corrupted firmware update package, did not store correctly. Detected, for example, by mismatched CRCs between
         * actual and expected.
         */
        FW_UP_CORRUPT(402),
        ...
        NOT_ACCEPTABLE(405),
        /**
         * Authentication was Required but Authentication Failure was encountered when downloading Firmware Update Package.
         */
        AUTH_FAILED(406),
        ...
        DL_SERVER_ERROR(500),
        /** The download fails due insufficient memory in the device to save the firmware update package. */
