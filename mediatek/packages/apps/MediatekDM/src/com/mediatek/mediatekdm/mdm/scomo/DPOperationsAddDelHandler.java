    ...
    public void onAdd(String uri) {
        ...
        try {
            if (operator.equals(Uri.DOWNLOAD)) {
                ...
                mScomo.getTree().registerExecute(uri, new DLDownloadInstallExecHandler(mScomo, mDp));
            } else if (operator.equals(Uri.DOWNLOADINSTALLINACTIVE)) {
                mScomo.getTree().registerExecute(uri, new DLDownloadInstallInactiveExecHandler(mScomo, mDp));
                ...
                mScomo.getTree().registerExecute(uri, new DPInstallInactiveExecHandler(mScomo, mDp));
