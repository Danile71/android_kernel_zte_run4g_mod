...
public class DmPLDeltaFile implements PLFile {
    ...
    public DmPLDeltaFile(String fileName, Context context, AccessMode accessMode) throws IOException {
        ...
        Log.i(TAG.PL, "[DmPLDeltaFile] fileName = " + mDeltaFileName + ", mTempFileName = " + mTempFileName);
    ...
    public void close(boolean commitClose) throws IOException {
        Log.d(TAG.PL, "[DmPLDeltaFile] commitClose =  " + commitClose + ", mAccessMode = " + mAccessMode);
        ...
        if (commitClose && mAccessMode == AccessMode.WRITE) {
            ...
            Log.d(TAG.PL, "[DmPLDeltaFile] Rename " + deltaSrc.getAbsolutePath() + " to " + deltaDst.getAbsolutePath());
