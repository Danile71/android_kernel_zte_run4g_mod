...
public class ParameterRetrievalTestCase extends MockServerTestCase {

    public ParameterRetrievalTestCase() {
        super(CMCCTestRequest.PARAMETERS_RETRIEVAL, 60);
    }

    @Override
    protected String getTag() {
        return "MDMTest/ParameterRetrievalTestCase";
    }
