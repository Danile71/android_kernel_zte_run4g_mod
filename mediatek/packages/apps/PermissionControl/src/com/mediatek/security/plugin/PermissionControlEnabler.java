...
public final class PermissionControlEnabler implements Preference.OnPreferenceChangeListener {
    ...
    private final BroadcastReceiver mPkgChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(PermControlUtils.PERM_UI_UPDATE_ACTION)) {
                Xlog.d(TAG, "PermissionControlEnabler update SwitchPreference ui");
                if (intent!=null) {
					boolean checked = intent.getBooleanExtra(PermControlUtils.PERM_UI_UPDATE_STATE,false);
    ...
    public void resume() {
        ...
        //register broadcast to update the swtich button state
        IntentFilter filter = new IntentFilter();
        filter.addAction(PermControlUtils.PERM_UI_UPDATE_ACTION);
        mContext.registerReceiver(mPkgChangeReceiver, filter);
    }
    ...
    public void pause() {
        ...
        mContext.unregisterReceiver(mPkgChangeReceiver);
    }
