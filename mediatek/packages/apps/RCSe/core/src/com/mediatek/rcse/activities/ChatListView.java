...
public final class ChatListView extends View implements OnClickListener, ContactsListManager.OnDisplayNameChangedListener {
        ...
        for (int i = 0; i < viewList.length; i++) {
            ...
            if (view != null) {
                ...
                if (obj instanceof InvitationStruct) {
                    ...
                    try {
                        itemSessionId = invitation.getChatSession().getChatId();
                    } catch (JoynServiceException e) {
                        e.printStackTrace();
                    }
    ...
    public static class InvitationStruct {
        ...
        private GroupChat mChatSession = null;
         ...
         * @return IChatSession
         */
        public GroupChat getChatSession() {
            return mChatSession;
        }
         ...
         */
        public void setChatSession(GroupChat chatSession) {
            this.mChatSession = chatSession;
        }
...
public String getMlatestMessageId() {
 ...
 ContactsListManager.getInstance().getDisplayNameByPhoneNumber((String) obj);
     ...
     */
    public void addMessage(Object chatWindowTag, ChatMessage message, boolean isRead) {
        ...
        if (null != message) {
            ...
            chatStruct.setMlatestMessageId(message.getId());        
                       
            chatStruct.setDate(message.getReceiptDate());
            chatStruct.setLatestMessage(message.getMessage());
            
            MessageItemStructForContact newMessage = new MessageItemStructForContact();
            newMessage.setmDate(message.getReceiptDate());
            newMessage.setMlatestMessage(message.getMessage());
            ...
            {
                Logger.d(TAG, "addMessage() chatStruct is " + chatStruct +"msgID : " + message.getId());
                
                if(!chatStruct.chatItems.isEmpty() && message.getId()!=null && (message.getId().equals(chatStruct.chatItems.get(i).getMlatestMessageId())))
