...
import com.mediatek.rcse.settings.AppSettingsData;
...
public class SettingsFragment extends PreferenceFragment implements
    ...
    private PreferenceScreen mGroupChatWallpaper = null;
    ...
    public void disableAllPreferences()
    {
    	 ...
    	 if(mGroupChatWallpaper!=null)
    		 mGroupChatWallpaper.setEnabled(false);
    ...
    public void enableAllPreferences()
    {
    	 ...
    	 if(mGroupChatWallpaper!=null)
    		 mGroupChatWallpaper.setEnabled(true);
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // mSettings = PreferenceManager.getDefaultSharedPreferences(getActivity());
                        ...
                        if (RCS_DISABLE_JOYN.equals(key)) {
                            if (mDisableJoyn != null) {
                                ...
                                mSettings.edit().putBoolean(RCS_DISABLE_JOYN, isChecked)
                                        .apply();
                                AppSettings.getInstance().setJoynMessagingDisabledFullyIntegrated(isChecked);
                                retValue = true;
        ...
        mGroupChatWallpaper = (PreferenceScreen) findPreference(RCS_CHAT_WALLPAPER); 
        ...
        prefs.edit().putString(RCS_RINGTONE, AppSettings.getInstance().getChatInvitationRingtone())
                .apply();
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                if (preference != null) {
                    ...
                    if (RCS_RINGTONE.equals(key)) {
                        ...
                        AppSettings.getInstance().setChatInvitationRingtone(uri);
                        retValue = true;
                    }
                }
                return retValue;
        ...
        mCompressImageCheckBox.setChecked(AppSettings.getInstance()
                ...
                if (preference != null) {
                    ...
                    if (RCSE_COMPRESS_IMAGE.equals(key)) {
                        ...
                        AsyncTask.execute(new Runnable() {
                            @Override
                            public void run() {
                                boolean isEnableCompressedPrev = AppSettings.getInstance()
                                        .isEnabledCompressingImageFromDB();
                                AppSettings.getInstance().setCompressingImage(isChecked);
                                ...
                                if (isEnableCompressedPrev == true
                                    ...
                                    AppSettings.getInstance().saveRemindCompressFlag(false);
                                }
                            }
                        });
                    }
		...
		if (!mSettings.getBoolean("rcse_master_switch", true)) {
    ...
    private class GetCompressStatusTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
         ...
         //   registerObserver(RcsSettingsData.THIRD_USER_ACCOUNT_CONTENT_URI);
            boolean satus = AppSettings.getInstance().isEnabledCompressingImageFromDB();
            return satus;
        }
        ...
        private void registerObserver(final Uri uri) {
            ...
            try {
                cursor = resolver.query(uri, new String[] {
                    ...
                    AppSettingsData.RCSE_COMPRESSING_IMAGE
                }, null);
        ...
        if (RCS_VIBRATE.equals(key)) {
            if (mVibrateCheckBox != null) {
                ...
                Logger.d(TAG, "onSharedPreferenceChanged(), the status of mVibrateCheckBox is "
                        + isChecked);
                AppSettings.getInstance().setPhoneVibrateForChatInvitation(isChecked);
            } else {
