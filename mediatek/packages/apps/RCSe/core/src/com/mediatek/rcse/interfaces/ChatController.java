...
public final class ChatController {
    ...
    /**
     * This event indicates the user wants to export chat
     * 
     */
    public static final int EVENT_EXPORT_GROUP_CHAT = EVENT_BASE_ACTION_MESSAGE + 12;
    
    /**
     * This event indicates TO reload all messages
     * 
     */
    public static final int EVENT_RELOAD_NEW_MESSAGE = EVENT_BASE_ACTION_MESSAGE + 13;
    /**
     * This event indicates need to clear extra message from group chat i.e. more than GroupChatFragment.LOAD_DEFAULT
     */
    public static final int EVENT_CLEAR_EXTRA_MESSAGE_GROUP_CHAT = EVENT_BASE_ACTION_MESSAGE + 14;
    
    /**
     * This event indicates to clear chat history from memory of chatwindow , not db
     */
    public static final int EVENT_CLEAR_CHAT_HISTORY_MEMORY_ONLY = EVENT_BASE_ACTION_MESSAGE + 15;

    /**
     * This event indicates to clear all chat history from memory of chatwindow , not db
     */
    public static final int EVENT_CLEAR_ALL_CHAT_HISTORY_MEMORY_ONLY = EVENT_BASE_ACTION_MESSAGE + 16;

	 /**
     * This event indicates the user wants to delte message list
     * 
     */
    public static final int EVENT_DELETE_MESSAGE_LIST = EVENT_BASE_ACTION_MESSAGE + 17;
    /**
     ...
     * invitation to a contact
     */
    public static final int EVENT_GROUP_FILE_TRANSFER_INVITATION = EVENT_BASE_FT + 8;
