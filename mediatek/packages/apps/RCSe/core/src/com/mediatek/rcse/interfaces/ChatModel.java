...
public final class ChatModel {
    ...
    public interface IChat1 {
		...
		void handleInvitation(Chat chat, ArrayList<IChatMessage> messages, boolean isAutoAccept);

		void handleInvitation(GroupChat chat, ArrayList<IChatMessage> messages, boolean isAutoAccept);
		
		 void setInviteContact(String contact);
    ...
    public interface IChatManager {
         ...
         */
        IChat1 addChat(List<Participant> participants, Object chatTag , String Chat);
		...
		boolean handleO2OInvitation(Intent intent, boolean isCheckSessionExist);
		
		boolean handleNewGroupInvitation(Intent intent, boolean isCheckSessionExist);
