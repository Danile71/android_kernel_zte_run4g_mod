...
public final class ChatView {
    ...
    public interface IChatWindow {
         ...
         */
        IReceivedChatMessage addReceivedMessage(ChatMessage message, boolean isRead);
    ...
    public interface IGroupChatWindow extends IChatWindow {
        ...
        /**
         * Clear Extra message(file/message) from chatItemList, 
         * Extra message will be loaded on request from user when load history
         */
        void clearExtraMessage();
        /**
         * Set message Id List for group chat, so that they can be loaded when user press load history
         * 
         */
