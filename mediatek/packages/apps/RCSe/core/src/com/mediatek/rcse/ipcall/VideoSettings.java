...
public class VideoSettings extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
     ...
     */
    public static final VideoCodec[] CODECS = {
//      public VideoCodec(String encoding, int payload, int clockRate, int frameRate, int bitRate, int width, int height, String parameters) {
        new VideoCodec(H264Config.CODEC_NAME, 99,
                H264Config.CLOCK_RATE, 12, 96000,
                H264Config.QCIF_WIDTH, H264Config.QCIF_HEIGHT, H264Config.CODEC_PARAM_PROFILEID + "="
                        + H264Profile1b.BASELINE_PROFILE_ID + ";"
                        + H264Config.CODEC_PARAM_PACKETIZATIONMODE + "=1"),
        new VideoCodec(H264Config.CODEC_NAME, 98,
                H264Config.CLOCK_RATE, 15, 384000,
                H264Config.QVGA_WIDTH, H264Config.QVGA_HEIGHT, H264Config.CODEC_PARAM_PROFILEID + "="
                        + H264Profile1_2.BASELINE_PROFILE_ID + ";"
                        + H264Config.CODEC_PARAM_PACKETIZATIONMODE + "=1"),
        new VideoCodec(H264Config.CODEC_NAME, 97,
                H264Config.CLOCK_RATE, 15, 384000,
                H264Config.CIF_WIDTH, H264Config.CIF_HEIGHT, H264Config.CODEC_PARAM_PROFILEID + "="
                        + H264Profile1_2.BASELINE_PROFILE_ID + ";"
                        + H264Config.CODEC_PARAM_PACKETIZATIONMODE + "=1"),
     ...
     */
    public static VideoCodec getCustomCodec(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        return new VideoCodec(H264Config.CODEC_NAME,
                ...
                bitrate,
                width,
                height,H264Config.CODEC_PARAM_PROFILEID + "=" + level + ";" + H264Config.CODEC_PARAM_PACKETIZATIONMODE + "=1");
    }
