...
public class RCSeCallButtonExtension extends CallButtonExtension implements
    ...
    private View verticalSpacerFile;
    private View verticalSpacerHold;
    private View verticalSpacerVideo;
    ...
    public void onViewCreated(Context context, View inCallTouchUi) {
        ...
        verticalSpacerHold = new View(context);
        verticalSpacerHold.setLayoutParams(new LayoutParams(VERTICAl_SPACER_WIDTH, LayoutParams.FILL_PARENT));
        mInCallControlArea.addView(verticalSpacerHold,8);
        mInCallControlArea.addView(mShareFileButton,9);
        mShareFileButton.setOnClickListener(this);
        mShareFileButton.setVisibility(View.GONE);
        verticalSpacerHold.setVisibility(View.GONE);
       ...
       // mShareVideoButton = (ImageButton) inCallTouchUi.findViewById(resource.getIdentifier(
        ...
        verticalSpacerFile = new View(context);
        verticalSpacerFile.setLayoutParams(new LayoutParams(VERTICAl_SPACER_WIDTH_2 , LayoutParams.FILL_PARENT));
        
        mInCallControlArea.addView(verticalSpacerFile,10);
        verticalSpacerFile.setVisibility(View.GONE);
        
        mInCallControlArea.addView(mShareVideoButton,11);
        
        verticalSpacerVideo = new View(context);
        verticalSpacerVideo.setLayoutParams(new LayoutParams(2, LayoutParams.FILL_PARENT));
        mInCallControlArea.addView(verticalSpacerVideo,12);
        verticalSpacerVideo.setVisibility(View.GONE);
        ...
        mLeftDialpadSpacer =
                inCallTouchUi.findViewById(resource.getIdentifier("leftDialpadSpacer", "id",
                        packageName));
        if (DBG) {
            log("onFinishInflating() values buttons are -file2 " + mShareFileButton + "InCallControlarea " + mInCallControlArea + "mvideobutton" + mShareVideoButton + "dialpad" + mDialpadButton +"mHoldButton" + mHoldButton
    ...
    */}
    ...
    private void updateBottomButtons(CallManager cm) {
        if (RCSeUtils.canShare(cm)) {
            ...
            if (null != verticalSpacerFile) {
            	verticalSpacerFile.setVisibility(View.VISIBLE);
            }
            if (null != verticalSpacerHold) {
            	verticalSpacerHold.setVisibility(View.VISIBLE);
            }
            if (null != verticalSpacerVideo) {
            	verticalSpacerVideo.setVisibility(View.VISIBLE);
            }
