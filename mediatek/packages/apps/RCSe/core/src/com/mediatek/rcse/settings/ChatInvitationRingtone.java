...
public class ChatInvitationRingtone extends RingtonePreference {
    ...
    public Uri onRestoreRingtone() {
        String uri = AppSettings.getInstance().getChatInvitationRingtone();
    ...
    public void onSaveRingtone(Uri ringtoneUri) {
        if (ringtoneUri != null) {
            AppSettings.getInstance().setChatInvitationRingtone(ringtoneUri.toString());
        } else {
            AppSettings.getInstance().setChatInvitationRingtone("");
        }
    }
}
