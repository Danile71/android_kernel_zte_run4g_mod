    ...
    public synchronized boolean registration() {
        ...
        try {
            ...
            if (dialogPath == null) {
                ...
                // Set local party
            	String localParty = registrationProcedure.getPublicUri_ex();
            	 //@tct-stack change getPublicUri() to getPublicUri_ex() for user public user identity as From and To header in sip register message 

                // Set remote party
            	String remoteParty = registrationProcedure.getPublicUri_ex();
            	 //@tct-stack change getPublicUri() to getPublicUri_ex() for user public user identity as From and To header in sip register message 
