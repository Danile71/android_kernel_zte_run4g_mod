...
public class Capabilities {
	...
	* SIP automata (@see RFC 3840)
	*/
	private boolean joynOffline = false;

    
    /**
     * INTEGRATED MODE
     */
    private boolean integratedMode = false;
	 ...
	 * @param sipAutomata
	 */
	public void setSipJoynOffline(boolean joynOffline) {
		this.joynOffline = joynOffline;
	}
	 ...
	 */
	public boolean isSipJoynOffline() {
		return joynOffline;
	}
