...
public class PhoneUtils {
    ...
    */
    ...
    private static String getImsServerIpAddress() {
        ...
        int currentAddressCounter=RcsSettings.getInstance().getCurrentPCscfAddresCounter();
        String imsProxyAddr = RcsSettings.getInstance().getImsProxyAddrForMobile(currentAddressCounter);
        int imsProxyPort = RcsSettings.getInstance().getImsProxyPortForMobile(currentAddressCounter);
    ...
    public static void routeToHost(final ConnectivityManager connManager) {
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... arg0) {
                int currentAddressCounter=RcsSettings.getInstance().getCurrentPCscfAddresCounter();
                String mobileHost = RcsSettings.getInstance().getImsProxyAddrForMobile(currentAddressCounter);
