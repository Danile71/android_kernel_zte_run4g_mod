...
public abstract class NewFileTransferListener extends INewFileTransferListener.Stub {
	 ...
	 * @param transferId Transfer ID
	 */
	public abstract void onFileDeliveredReport(String transferId,String contact);
	 ...
	 * @param transferId Transfer ID
	 */
	public abstract void onFileDisplayedReport(String transferId,String contact);
