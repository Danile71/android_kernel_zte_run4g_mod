...
public class JDiffClassDescription {
    ...
    public JDiffClassDescription(String pkg,
            String className,
            ResultObserver resultObserver, Context context) {
        mPackageName = pkg;
    ...
    private Class<?> findMatchingClass() {
        ...
        try {
            ...
            // level class.
        	Context rcsContext = mContext.createPackageContext("com.orangelabs.rcs", Context.CONTEXT_INCLUDE_CODE | Context.CONTEXT_IGNORE_SECURITY);
            Class<?> clz = rcsContext.getClassLoader().loadClass(currentName);
