...
public class ChatScreenActivityTest extends ActivityInstrumentationTestCase2<ChatScreenActivity> {
    ...
    private static final ChatMessage MOCK_SENT_MESSAGE_TODAY = new ChatMessage("sent",
            MOCK_NUMBER, MOCK_SENT_MESSAGE_TEXT, MOCK_DATE_TODAY, true);
    private static final ChatMessage MOCK_RECEIVED_MESSAGE_YESTERDAY = new ChatMessage(
            "received", MOCK_NUMBER, MOCK_RECEIVED_MESSAGE_TEXT, MOCK_DATE_YESTERDAY, true);
    private static final ChatMessage MOCK_RECEIVED_MESSAGE_TOMORROW = new ChatMessage(
            "received", MOCK_NUMBER, MOCK_RECEIVED_MESSAGE_TEXT, MOCK_DATE_TOMORROW, true);
