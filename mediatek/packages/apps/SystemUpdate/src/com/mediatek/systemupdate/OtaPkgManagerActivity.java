...
public class OtaPkgManagerActivity extends PkgManagerBaseActivity {
    ...
    private static final int DIALOG_LOW_BATTERY = 13;
    ...
    protected Dialog onCreateDialog(int id, Bundle bundle) {
        ...
        case DIALOG_LOW_BATTERY:
            mAlertDialog = new AlertDialog.Builder(this).setTitle(getString(R.string.low_battery))
    ...
    private void clearDownloadRecord() {
        final String pkgPath  = Util.getPackageFileName(OtaPkgManagerActivity.this);
