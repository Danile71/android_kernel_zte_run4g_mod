...
//        curHandler.sendMessageDelayed(m, mDelaytime);
    ...
    public int sendContactsRecogEnable(int recognitionEnable) {
        Log.i(VoiceCommandManagerStub.TAG, "sendContactsRecogEnable : " + recognitionEnable);
        int erroid = VoiceCommandListener.VOICE_NO_ERROR;
        return erroid;
    }
    ...
    public int startVoiceTraining(String pwdpath, String patternpath,
            ...
            int[] commandMask, int trainingMode, String wakeupInfo,
            String processname, int pid) {
        // TODO Auto-generated method stub
    ...
    public int initVoiceWakeup(int mode, int cmdStatus, int[] cmdIds,
            String pattern, int mode1, String patternPath1,
