...
public abstract class VoiceCommandBusiness {
    ...
    public static final int ACTION_MAIN_VOICE_BROADCAST_BOOT_COMPLETED = ACTION_MAIN_VOICE_BROADCAST + 1;

    //Used to deal with the event of boot completed
    public static final int ACTION_MAIN_VOICE_BOOT_COMPLETED = ACTION_MAIN_VOICE_BROADCAST + 2;
