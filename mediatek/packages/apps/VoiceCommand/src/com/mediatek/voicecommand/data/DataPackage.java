...
public class DataPackage {
    ...
    public static Bundle packageSendInfo(int sendinfo) {
        Bundle bundle = new Bundle();
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_SEND_INFO, sendinfo);
        return bundle;
    }

    public static Bundle packageSendInfo(int sendinfo, int sendinfo1, int[] sendinfo2) {
        Bundle bundle = new Bundle();
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_SEND_INFO, sendinfo);
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_SEND_INFO1, sendinfo1);
        bundle.putIntArray(VoiceCommandListener.ACTION_EXTRA_SEND_INFO2, sendinfo2);
        return bundle;
    }
}
