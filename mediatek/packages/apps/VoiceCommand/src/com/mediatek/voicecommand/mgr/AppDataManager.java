...
public class AppDataManager extends VoiceDataManager implements
    ...
    private static final String SYSTEM_PROCESS1 = "com.android.systemui";
    private static final String SYSTEM_PROCESS2 = "com.android.keyguard";
    ...
    private int checkProcessIllegal(String pkgName, int uid, int pid) {
        ...
        if (processNameList != null
                && !(processNameList.contains(SYSTEM_PROCESS1) || processNameList
                        .contains(SYSTEM_PROCESS2))
