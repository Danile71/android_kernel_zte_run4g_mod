...
public class VoiceUnlock extends PreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        if (VoiceUnlockFragment.class.getName().equals(fragmentName))
            return true;
        return false;
    }
    ...
    public static class VoiceUnlockFragment extends SettingsPreferenceFragment {
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
            ...
            if (vuPreference.isChecked()) {
                ...
                if (KEY_VOICE_UNLOCK.equals(key)) {
                    mClickedCmdSummary = getResources().getText(
                            R.string.voice_command_record_description_unlock_screen);
                } else {
            ...
            if (KEY_VOICE_UNLOCK.equals(key)) {
                ...
                intent.putExtra(LockPatternUtils.SETTINGS_COMMAND_KEY,
        ...
        public Dialog onCreateDialog(int dialogId) {
            ...
            case OPTIONS_DIALOG:
                return new AlertDialog.Builder(getActivity()).setTitle(
                        R.string.voice_unlock_options_title).setItems(R.array.voice_unlock_options,
        ...
        private void playCommand(String key) {
            ...
            intent.putExtra(KEY_COMMAND_MODE, 0);
            log("playCommand commandId = " + commandId + " summary = " + mClickedCmdSummary);
            try {
                startActivity(intent);
            } catch (android.content.ActivityNotFoundException e) {
                Toast.makeText(getActivity(), R.string.pass_word_file_missing, Toast.LENGTH_SHORT)
                        .show();
            }
        }
