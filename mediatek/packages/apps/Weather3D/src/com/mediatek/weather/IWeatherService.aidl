...
interface IWeatherService {
    ...
    /**
    * request the cities list with weather service
    */
    void requestCityList();

    /**
    * request the weather information of the city represented by cityId
    * @param cityId : identify of city
    * @param updateForce: if get latest weather info from weather server or not
    */
    void requestWeather(int cityId, boolean updateForce);
