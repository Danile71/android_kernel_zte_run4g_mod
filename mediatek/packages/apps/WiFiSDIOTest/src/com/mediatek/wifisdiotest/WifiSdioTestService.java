...
public class WifiSdioTestService extends Service {
    ...
    public static final String TAG = "EM/WifiSdioTestService";
    ...
    public static final int DEFAULT_LASTRUN_COUNT = 3;
    public static final int DEFAULT_LASTRUN_TIME = 600;
    ...
    public static final int TEST_5CMD_INTER_ROUND = TEST_LOOP_COUNT - DEFAULT_LASTRUN_COUNT;
