...
public class ResourceManagerExt extends ResourceManager {
    ...
    static {
        ...
        sStringMap.put(string.ipmsg_nms_mms_not_default,               R.string.imsg_nms_mms_not_default);
        // fix bug ISMS-1119
        sStringMap.put(string.ipmsg_send_by_xms,                R.string.STR_NMS_SEND_BY_SMS);
        sStringMap.put(string.ipmsg_send_by_joyn,               R.string.STR_NMS_SEND_BY_ISMS);
        // string array
        ...
        sDrawableMap.put(drawable.ipmsg_emoticon,       R.drawable.isms_emoticon);
        sDrawableMap.put(drawable.enter_joyn_chat,     R.drawable.about_isms_logo);
        // raw resource
