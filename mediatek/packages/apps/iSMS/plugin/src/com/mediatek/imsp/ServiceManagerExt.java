...
public class ServiceManagerExt extends ServiceManager {
    ...
    private SNmsSimInfo getNmsSimInfo(int simId) {
        ...
        // fix bug ISMS-1176 ISMS-1174
        if (nmsSimInfoCache == null || nmsSimInfoCache.get() == null || simId == NmsConsts.SINGLE_CARD_SIM_ID) {
    ...
    public int getIntegrationMode() {
        ...
        return IpMessageConsts.IntegrationMode.ISMS_MODE;
    }	
}
