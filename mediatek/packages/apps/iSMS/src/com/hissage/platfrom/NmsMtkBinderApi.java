...
public class NmsMtkBinderApi {
    ...
    private static final String FUNC_ID_SEND_MESSAGE = "5";
    ...
    public void sendMessage(String destAddr, String scAddr, ArrayList<String> parts,
            int encodingType, int slotId, ArrayList<PendingIntent> sentIntents,
            ArrayList<PendingIntent> deliveryIntents) {
        try {
            Bundle param = new Bundle();
            param.putString("destAddr", destAddr);
            param.putString("scAddr", scAddr);
            param.putStringArrayList("parts", parts);
            param.putInt("encodingType", encodingType);
            param.putInt("slotId", slotId);
            param.putParcelableArrayList("sentIntents", sentIntents);
            param.putParcelableArrayList("deliveryIntents", deliveryIntents);
            Bundle back = mApiProviders.call(API_CONTENT_URI, FUNC_ID_SEND_MESSAGE, null, param);
        } catch (Exception e) {
            NmsLog.nmsPrintStackTrace(e);
        }
    }
