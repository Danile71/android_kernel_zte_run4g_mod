...
public class NmsPlatformAdapter {
    ...
    public String getImsi(int slotId) {
        if (!isMtkGeminiSupport() && slotId == NmsConsts.SIM_CARD_SLOT_2)
            return null ;
    ...
    public void sendMultipartTextMessage(String destinationAddress, String scAddress,
            ArrayList<String> parts, long threadId, long simId, ArrayList<PendingIntent> sentIntents,
            ArrayList<PendingIntent> deliveryIntents) {
        smsMan.sendMultipartTextMessage(smsMan, destinationAddress, scAddress, parts, threadId, simId,
