...
public class NmsChatLongPressDialog implements MenuItem.OnMenuItemClickListener {
    ...
    public void bind(NmsIpMessage msg, NmsContact contact, ContextMenu menu,boolean isDefaultSmsApp) {
        if (null == msg) {
        ...
        initStringList(isDefaultSmsApp);
    }
    ...
    private void tryToAddForwardMsgItem() {
        ...
        // !NmsCommonUtils.isExistsFile(msg.path)) {
        // return;
        // }
        // }
        // }
    ...
    private void initStringList(boolean isDefaultSmsApp) {
        ...
        if (mMessage.type == NmsIpMessageConsts.NmsIpMessageType.TEXT) {
            ...
            if ((mMessage.flag & NmsIpMessageConsts.NmsIpMessageFlag.NMS_MSG_FLAG_BURN_AFTER_READ) != 0) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT,
                        mContext.getResources().getString(R.string.STR_NMS_READED_BURN_PIC));
            } else {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        case saveInSDcard:
            NmsIpAttachMessage msg = (NmsIpAttachMessage) mMessage;
            if (msg.isInboxMsgDownloalable() || TextUtils.isEmpty(msg.path)
                    || !NmsCommonUtils.isExistsFile(msg.path)) {
                Toast.makeText(mContext, R.string.imsp_save_chat_history_failed, Toast.LENGTH_SHORT)
                        .show();
                break;
            }
            saveMsgInSDCard();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (dbId == mMessage.ipDbId
                ...
                if (status == NmsIpMessageConsts.NmsDownloadAttachStatus.DONE) {
                    ...
                    strTmp = String.format(mContext
                            .getString(R.string.STR_NMS_FORWARD_DOWNLOAD_FAILED));
