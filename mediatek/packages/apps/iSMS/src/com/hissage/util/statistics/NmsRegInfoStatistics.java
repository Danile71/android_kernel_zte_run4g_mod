...
public class NmsRegInfoStatistics implements NmsHttpTask.HttpTaskListener {
    ...
    public static final int NMS_REGS_SERVER_ERROR = 1;
    public static final int NMS_REGS_RECV_NOC_NUMBER = 2;
    public static final int NMS_REGS_SEND_NOC_SMS = 3;
    public static final int NMS_REGS_RECV_NOC_SMS_RESP = 4;
    public static final int NMS_REGS_SEND_INPUT = 5;
    public static final int NMS_REGS_SHOW_INPUT_DLG = 6;
    public static final int NMS_REGS_SEND_SELF_REG = 7;
    public static final int NMS_REGS_RECV_SELF_REG_RESP = 8;
    public static final int NMS_REGS_FAILED = 9;
    public static final int NMS_REGS_SUCCEED = 10;
    
    public static final int NMS_REGS_SHOW_EDIT_DLG = 11;
    public static final int NMS_REGS_NOC_BACK = 12;
    public static final int NMS_REGS_INPUT_DLG_BACK = 13;
    public static final int NMS_REGS_SELF_REG_BACK = 14;
    public static final int NMS_REGS_SHOW_EDIT_BACK = 15;
    ...
    private NmsRegInfoStatistics() {
        ...
        String netWorkStatus[] = NmsUpgradeManager.getNetworkStatus();
        mNetworkStatus = netWorkStatus[0];
        mMarketChannel = 0;
    ...
    private void postToServer(String imsi, int type, String val, String time) throws JSONException {
        ...
        data.put("networkStatus", mNetworkStatus);
        ...
        } else if (type == NMS_REGS_SEND_SELF_REG || type == NMS_REGS_INPUT_DLG_BACK) {
            if (TextUtils.isEmpty(val)) {
