        ...
        try {
            ...
            while(tryCount <= retry && ntpServiceStatus != 1) {
                ...
                try {
                    ...
                    byte[] data = new NtpMessageInfo().toByteArray();
                    ...
                    NtpMessageInfo ntpMessage = new NtpMessageInfo(ntpResponse.getData());
                    double localClockOffset =
                        ((ntpMessage.mReceivedRequestTime - ntpMessage.mSendRequestTime)
                         + (ntpMessage.mSendResponseTime - destinationTimestamp)) / 2;
