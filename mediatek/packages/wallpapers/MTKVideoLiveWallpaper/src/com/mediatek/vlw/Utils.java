...
public final class Utils {
    ...
    public static ArrayList<Uri> query2DVideos(Context context, String bucketId) {
        ...
        try {
            ...
            if (FeatureOption.MTK_VIDEO_4KH264_SUPPORT) {
                where = Video.VideoColumns.BUCKET_ID + "=" + bucketId
                        + " AND ((" + Video.VideoColumns.WIDTH + " <= 1920"
                        + " AND " + Video.VideoColumns.HEIGHT + " <= 1920)"
                        + " OR (" + Video.VideoColumns.WIDTH + " IS NULL"
                        + " OR " + Video.VideoColumns.HEIGHT + " IS NULL))";
            }
