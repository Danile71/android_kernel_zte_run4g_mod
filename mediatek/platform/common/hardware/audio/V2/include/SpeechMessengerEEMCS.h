#ifndef ANDROID_SPEECH_MESSAGE_EEMCS_H
#define ANDROID_SPEECH_MESSAGE_EEMCS_H
...
class SpeechMessengerEEMCS : public SpeechMessengerInterface
{
    public:
        SpeechMessengerEEMCS(modem_index_t modem_index, SpeechDriverLAD *pLad);
        virtual ~SpeechMessengerEEMCS();
