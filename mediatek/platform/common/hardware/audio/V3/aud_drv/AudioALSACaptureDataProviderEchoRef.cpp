...
static const uint32_t kReadBufferSize = ((0x1B90) / 2); // 44.1K\stereo\20ms data (framebase: get 20ms data/per time), downlink sample rate(DL1)
...
status_t AudioALSACaptureDataProviderEchoRef::GetCaptureTimeStamp(time_info_struct_t *Time_Info, size_t read_size)
{
