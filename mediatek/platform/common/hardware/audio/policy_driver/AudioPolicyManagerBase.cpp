...
status_t  AudioPolicyManagerBase::StartOutputSamplerate (audio_io_handle_t output,
                         AudioSystem::stream_type stream,
...
status_t  AudioPolicyManagerBase::StopOutputSamplerate (audio_io_handle_t output,
                         AudioSystem::stream_type stream,
                         int session ,int samplerate)
{
     return NO_ERROR;
