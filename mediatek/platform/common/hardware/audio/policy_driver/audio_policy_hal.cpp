...
extern "C" {
    ...
    static int ap_start_otuput_sampletate(struct audio_policy *pol,
                                          audio_io_handle_t output,
                                          audio_stream_type_t stream,
    ...
    {
        struct legacy_audio_policy *lap = to_lap(pol);
        return lap->apm->StartOutputSamplerate(output, (AudioSystem::stream_type)stream , session , samplerate);
    }


    static int ap_stop_otuput_sampletate(struct audio_policy *pol,
                                          audio_io_handle_t output,
                                          audio_stream_type_t stream,
                                          int session, int samplerate)
    ...
    {
        struct legacy_audio_policy *lap = to_lap(pol);
        return lap->apm->StopOutputSamplerate(output, (AudioSystem::stream_type)stream , session , samplerate);
    }
                                ...
                                struct audio_policy **ap)
    {
        ...
        lap->policy.set_policy_parameters = ap_set_policy_parameters; // #ifndef ANDROID_DEFAULT_CODE
        lap->policy.start_output_samplerate = ap_start_otuput_sampletate; // #ifndef ANDROID_DEFAULT_CODE
        lap->policy.stop_output_samplerate = ap_stop_otuput_sampletate; // #ifndef ANDROID_DEFAULT_CODE
