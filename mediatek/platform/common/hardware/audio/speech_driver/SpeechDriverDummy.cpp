...
status_t SpeechDriverDummy::SetMagiConSpeechParameters(const AUDIO_CUSTOM_MAGI_CONFERENCE_STRUCT *pSphParamMagiCon)
{
...
status_t SpeechDriverDummy::SetHACSpeechParameters(const AUDIO_CUSTOM_HAC_PARAM_STRUCT *pSphParamHAC)
{
    ALOGD("%s()", __FUNCTION__);
    return NO_ERROR;
}
