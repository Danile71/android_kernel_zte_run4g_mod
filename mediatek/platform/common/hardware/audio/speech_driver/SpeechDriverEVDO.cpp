...
status_t SpeechDriverEVDO::SpeechRouterOn()
{
    SPEECH_DRIVER_DBG("%s()", __FUNCTION__);
    CheckApSideModemStatusAllOffOrDie();
...
status_t SpeechDriverEVDO::SpeechRouterOff()
{
    SPEECH_DRIVER_DBG("%s()", __FUNCTION__);
...
status_t SpeechDriverEVDO::SetUplinkSourceMute(bool mute_on)
{
...
status_t SpeechDriverEVDO::SetMagiConSpeechParameters(const AUDIO_CUSTOM_MAGI_CONFERENCE_STRUCT *pSphParamMagiCon)
{
    SPEECH_DRIVER_DBG("%s()", __FUNCTION__);
    return NO_ERROR;
}
...
status_t SpeechDriverEVDO::SetHACSpeechParameters(const AUDIO_CUSTOM_HAC_PARAM_STRUCT *pSphParamHAC)
{
    SPEECH_DRIVER_DBG("%s()", __FUNCTION__);
    return NO_ERROR;
}
