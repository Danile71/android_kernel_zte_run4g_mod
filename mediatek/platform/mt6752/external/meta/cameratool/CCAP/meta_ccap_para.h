...
#define FT_CCT_ERR_SHADING_CAL_COEF_OVERFLOW			0xD7
...
//-----------Dual Camera Feature---------------------
    ...
    ,FT_CCT_OP_STROBE_READ_NVRAM_TO_PC
		...
		//6595
	,FT_CTT_CMD_GET_SENSOR_MODE_NUM
	,FT_CCT_V2_OP_ISP_SET_SHADING_TSF_ONOFF
	,FT_CCT_V2_OP_ISP_GET_SHADING_TSF_ONOFF
	,FT_CCT_OP_SET_CCM_WB
	,FT_CCT_OP_GET_CCM_WB
	,FT_CCT_V2_OP_AE_SET_HDR_GAMMA_TABLE
	,FT_CCT_V2_OP_AE_GET_HDR_GAMMA_TABLE
	,FT_CCT_V3_OP_ISP_SET_TUNING_PARAS
	,FT_CCT_V3_OP_ISP_GET_TUNING_PARAS
	,FT_CCT_V3_OP_ISP_GET_TUNING_PARAS_BUF
	,FT_CCT_OP_SET_FEATURE_MODE
	,FT_CCT_OP_GET_FEATURE_MODE
	,FT_CCT_OP_FLASH_CALIBRATION
	,FT_CCT_OP_AWB_GET_FLASH_AWB_PARA
	,FT_CCT_OP_AWB_APPLY_FLASH_AWB_PARA
	,FT_CCT_OP_AWB_SAVE_FLASH_AWB_PARA
	,FT_CCT_GET_CAPTURE_FEATURE_PARA
	,FT_CCT_SAVE_CAPTURE_FEATURE_PARAS
	,FT_CCT_APPLY_CAPTURE_FEATURE_PARAS
	,FT_CCT_V2_OP_CCM_GET_SMOOTH_SWITCH
	,FT_CCT_K2_CCM_SET_SMOOTH_SWITCH
	,FT_CCT_K2_QUERY_ISP_INDEX_SET
	,FT_CCT_K2_FLASH_SET_MANUAL_FLASH
	,FT_CCT_K2_FLASH_CLEAR_MANUAL_FLASH
	//,FT_CCT_K2_READ_SENSOR_REG
	//,FT_CCT_K2_WRITE_SENSOR_REG
	,FT_CCT_K2_GET_AEPLINE
	,FT_CCT_K2_APPLY_AEPLINE
	,FT_CCT_K2_SAVE_AEPLINE
	,FT_CCT_K2_GET_AEPLINE_BUF
	,FT_CCT_OP_END
	} FT_CCT_OP;
	...
	typedef struct 
	{
		...
		unsigned short int		video1_width;
		unsigned short int		video1_height;
		unsigned short int		video2_width;
		unsigned short int		video2_height;
		unsigned short int		custom1_width;
		unsigned short int		custom1_height;
		unsigned short int		custom2_width;
		unsigned short int		custom2_height;
		unsigned short int		custom3_width;
		unsigned short int		custom3_height;
		unsigned short int		custom4_width;
		unsigned short int		custom4_height;
		unsigned short int		custom5_width;
		unsigned short int		custom5_height;
		FT_CCT_BAYER_PATTERN	start_pixel_bayer_ptn;
		unsigned short int		grab_x_offset;
		unsigned short int		grab_y_offset;
	} FT_CCT_SENSOR_EX;
...
typedef enum
{
    CCT_TUNING_PREVIEW_SET = 0,
    CCT_TUNING_CAPTURE_SET,
    CCT_TUNING_VIDEO_SET,
    CCT_TUNING_VIDEO1_SET,
    CCT_TUNING_VIDEO2_SET,
    CCT_TUNING_CUSTOM1_SET,
    CCT_TUNING_CUSTOM2_SET,
    CCT_TUNING_CUSTOM3_SET,
    CCT_TUNING_CUSTOM4_SET,
    CCT_TUNING_CUSTOM5_SET,
    CCT_TUNING_SET_SIZE
} CCT_CAMERA_TUNING_SET_ENUM;
...
typedef enum
{
    ...
    CCT_MFLL_MNRSW,
    CCT_mVHDR,
    CCT_FEATURE_SUPPORT_SIZE
}CCT_FEATURE_SUPPORT_ENUM;
...
typedef struct AWB_NVRAM_ALL_T
{
	...
	typedef union 
	{
		...
		ACDK_CCT_GAMMA_ACCESS_STRUCT          dev_ae_gamma_table;
		...
		AWB_NVRAM_ALL_T                          dev_awb_nvram_info;
		...
		ISP_NVRAM_MIXER3_T		set_MFB_mixer;
		...
		ISP_NVRAM_CCM_AWB_GAIN_STRUCT		set_ccm_wb_gain;
        META_ISP_SET_TUNING_PARAS       set_isp_para;
        META_ISP_GET_TUNING_PARAS       get_isp_para;
		CCT_FEATURE_SUPPORT_ENUM		set_feature_mode;
		FLASH_AWB_NVRAM_T				set_flash_awb_nvram;
		NVRAM_CAMERA_FEATURE_STRUCT		set_camera_feature;
		CCT_COMMON_INT_INPUT_STRUCT		set_flash_level;
		ACDK_CCT_FUNCTION_ENABLE_STRUCT		set_smooth_ccm_status;
		ACDK_CCT_QUERY_ISP_INDEX_INPUT_STRUCT	sensor_profile_iso;
		META_ISP_BUFFER_ACCESS_STRUCT                        set_pline_para;
		META_ISP_BUFFER_ACCESS_STRUCT                        get_pline_para;
	} FT_CCT_CMD;
	...
	typedef union 
	{
		...
		ACDK_CCT_GAMMA_ACCESS_STRUCT   get_6238_ae_gamma_table;
		...
		AWB_NVRAM_ALL_T             get_awb_nvram_info;
		...
		ISP_NVRAM_MIXER3_T			get_MFB_mixer;
		...
		unsigned int								get_sensor_mode_num;
		ISP_NVRAM_CCM_AWB_GAIN_STRUCT		get_ccm_wb_gain;
		CCT_FEATURE_SUPPORT_ENUM				get_feature_mode;
		FLASH_AWB_NVRAM_T					get_flash_awb_nvram;
        NVRAM_CAMERA_FEATURE_STRUCT			get_camera_feature;
        ACDK_CCT_FUNCTION_ENABLE_STRUCT		get_smooth_ccm_status;
		CUSTOM_NVRAM_REG_INDEX				get_ispIdxFromFW_cnf;
	...
	typedef struct {
		...
		bool	is_init;
		bool	is_fb_init;
		uint8	cnf_return_code;

		// memory management 
		uint32	mem_lcd_layer0_buf_addr;
		uint32	mem_lcd_layer0_buf_size;
		uint32	mem_isp_int_buf_addr;
		uint32	mem_isp_int_buf_size;
		uint32	mem_isp_ext_buf_addr;
		uint32	mem_isp_ext_buf_size;
		uint32	mem_capture_ext_buf_addr;
		uint32	mem_capture_ext_buf_size;
		uint32	mem_capture_int_buf_addr;
		uint32	mem_capture_int_buf_size;
		uint32	mem_capture_cur_buf_addr;
		uint32	mem_capture_cur_buf_size;

		// sensor info 
		FT_CCT_ON_BOARD_SENSOR_EX	sensor_onboard_sensors;
		// sensor engineer mode state 
		int16					sensor_eng_group_idx;
		int16					sensor_eng_item_idx_pregain_R;
		int16					sensor_eng_item_idx_pregain_Gr;
		int16					sensor_eng_item_idx_pregain_Gb;
		int16					sensor_eng_item_idx_pregain_B;
		...
		bool					defect_table_on_off;
		bool					defect_table_cal_in_progress;

		// strobe calibration state 
		bool					strobe_cal_enable;
		...
		uint32					usb_ready_to_write_cnt;

		//capture dormat
		unsigned char					output_format;

		//src device
		uint32					src_device_mode;//main : 0x1¡Asub : 0x2¡Amain2 : 0x8 [89]

		//feature mode
		CCT_FEATURE_SUPPORT_ENUM    feature_mode;
