...
static const char* BwcProfileType_GetStr( BWC_PROFILE_TYPE profile ){
    switch( profile ){
        ...
        case BWCPT_VIDEO_RECORD:
            return "BWCPT_VIDEO_RECORD";
        case BWCPT_VIDEO_PLAYBACK:
            return "BWCPT_VIDEO_PLAYBACK";
        case BWCPT_VIDEO_SWDEC_PLAYBACK:
            return "BWCPT_VIDEO_SWDEC_PLAYBACK";
        ...
        case BWCPT_VIDEO_LIVE_PHOTO:
            return "BWCPT_VIDEO_LIVE_PHOTO";
        case BWCPT_VIDEO_WIFI_DISPLAY:
            return "BWCPT_VIDEO_WIFI_DISPLAY";
        case BWCPT_NONE:
            return "BWCPT_NONE";
    }
...
int BWC::Profile_Change( BWC_PROFILE_TYPE profile_type, bool bOn ){
    ...
    //BWC_INFO("HWL OVL MAX Size = %d\n", mm_info.hw_ovl_limit);
    ...
    // UT for BWC Monotor
    //{
    //    unsigned int ovl_limit_bytes = 0;
    //    BWC_MONITOR monitor;
    //    ovl_limit_bytes = monitor.query_hwc_max_pixel();
    //    BWC_INFO("Monitor UT: HW OVL limit byts = %d\n", ovl_limit_bytes);
    //}
...
BWC_SIZE BWC::SensorSize_Get( void ){
    ...
    BWCHelper bwcHelper;
    MTK_SMI_BWC_MM_INFO_ADAPT mm_info;
