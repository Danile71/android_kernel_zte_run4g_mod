...
/*tuning data for HDR capable scene*/
typedef struct
{
    ASD_DECIDER_TIME_WEIGHT_TYPE_ENUM  HdrTimeWeightType;
	ASD_DECIDER_TIME_WEIGHT_RANGE_ENUM HdrTimeWeightRange;
	MINT16 HdrIdxWeightBlAe;
	MINT16 HdrIdxWeightBlScd;
	MUINT8 HdrScoreThrBacklit;
    MBOOL  HdrBacklitLockEnable;
    MINT16 HdrBacklitLockEvDiff;	
    MBOOL  bReserved;
    void   *pReserved;	
} ASD_HDR_INDICATOR_TUNING_PARA_STRUCT;
...
typedef struct
{
    ...
    MBOOL  bReserved;
    void   *pReserved;
	ASD_HDR_INDICATOR_TUNING_PARA_STRUCT HdrIdxTuning;
...
typedef struct 
{
    ...
    MBOOL  bReserved;
    void   *pReserved;
} ASD_DECIDER_TUNING_PARA_STRUCT_ORI;


typedef struct 
{
    ASD_DECIDER_REF_STRUCT			DeciderRefData;
    ASD_DECIDER_TUNING_PARA_STRUCT_ORI	DeciderTuneData;    // tuning parameters    
...
typedef enum
{
	...
	DECIDER_FEATURE_RESET_HDR_SCORE,
