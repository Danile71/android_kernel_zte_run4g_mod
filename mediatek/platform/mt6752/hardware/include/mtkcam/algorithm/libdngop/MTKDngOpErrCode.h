...
#ifndef _MTK_DNGOP_ERRCODE_H
#define _MTK_DNGOP_ERRCODE_H
...
#define MODULE_MTK_DNGOP (0) // Temp value

#define MTKDNGOP_OKCODE(errid)         OKCODE(MODULE_MTK_DNGOP, errid)
#define MTKDNGOP_ERRCODE(errid)        ERRCODE(MODULE_MTK_DNGOP, errid)


// Detection error code
#define S_DNGOP_OK                  MTKDNGOP_OKCODE(0x0000)

#define E_DNGOP_NEED_OVER_WRITE     MTKDNGOP_ERRCODE(0x0001)
#define E_DNGOP_NULL_OBJECT         MTKDNGOP_ERRCODE(0x0002)
#define E_DNGOP_WRONG_STATE         MTKDNGOP_ERRCODE(0x0003)
#define E_DNGOP_WRONG_CMD_ID        MTKDNGOP_ERRCODE(0x0004)
#define E_DNGOP_WRONG_CMD_PARAM     MTKDNGOP_ERRCODE(0x0005)
#define E_DNGOP_INSUFF_WORK_BUF     MTKDNGOP_ERRCODE(0x0006)
#define E_DNGOP_WRONG_PACK_MODE     MTKDNGOP_ERRCODE(0x0007)
#define E_DNGOP_WRONG_STRIDE_VALUE  MTKDNGOP_ERRCODE(0x0008)
#define E_DNGOP_ERR                 MTKDNGOP_ERRCODE(0x0100)
