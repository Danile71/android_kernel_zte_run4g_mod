...
public:
    ...
    virtual void GdMain(MUINT32 ImageScaleBuffer/*, MUINT32 ImageBufferRGB565*/,  MTK_GD_OPERATION_MODE_ENUM gd_state, GD_GSENSOR_DIRECTION direction, int gfd_fast_mode);
    virtual void GdReset(void);
    //virtual MUINT32 GdGetResultSize(void);
    virtual MUINT8 GdGetResult(MUINT32 GD_result_Adr, GD_TRACKING_RESULT_TYPE_ENUM result_type);
    virtual void GdGetICSResult(MUINT32 GD_ICS_Result, MUINT32 GD_Results, MUINT32 Width,MUINT32 Heigh, MUINT32 LCM, MUINT32 Sensor, MUINT32 Camera_TYPE, MUINT32 Draw_TYPE);
