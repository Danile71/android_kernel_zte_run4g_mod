...
#ifndef _MTK_NR_ERRCODE_H
#define _MTK_NR_ERRCODE_H
...
#define MODULE_MTK_NR (0) // Temp value

#define MTK_NR_OKCODE(errid)         OKCODE(MODULE_MTK_NR, errid)
#define MTK_NR_ERRCODE(errid)        ERRCODE(MODULE_MTK_NR, errid)


// Detection error code
#define S_NR_OK                  MTK_NR_OKCODE(0x0000)

#define E_NR_NEED_OVER_WRITE     MTK_NR_ERRCODE(0x0001)
#define E_NR_NULL_OBJECT         MTK_NR_ERRCODE(0x0002)
#define E_NR_WRONG_STATE         MTK_NR_ERRCODE(0x0003)
#define E_NR_WRONG_CMD_ID        MTK_NR_ERRCODE(0x0004)
#define E_NR_WRONG_CMD_PARAM     MTK_NR_ERRCODE(0x0005)
#define E_NR_INSUFF_WORK_BUF     MTK_NR_ERRCODE(0x0006)
#define E_NR_WRONG_IMAGE_FMT     MTK_NR_ERRCODE(0x0007)
#define E_NR_ILLEGAL_CONFIG      MTK_NR_ERRCODE(0x0008)
#define E_NR_RECTIFY_FAIL        MTK_NR_ERRCODE(0x0009)
#define E_NR_ILLEGAL_CORE_NUM    MTK_NR_ERRCODE(0x000A)
#define E_NR_NULL_FILE_POINTER   MTK_NR_ERRCODE(0x000B)
#define E_NR_MDP_FAIL            MTK_NR_ERRCODE(0x000C)
#define E_NR_MET_INIT_FAIL       MTK_NR_ERRCODE(0x000C)

#define E_NR_ERR                 MTK_NR_ERRCODE(0x0100)
