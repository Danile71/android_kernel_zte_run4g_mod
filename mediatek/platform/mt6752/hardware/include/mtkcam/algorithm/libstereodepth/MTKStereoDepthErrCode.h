...
#ifndef _MTK_STEREODEPTH_ERRCODE_H
#define _MTK_STEREODEPTH_ERRCODE_H
...
#define MODULE_MTK_STEREODEPTH (0) // Temp value

#define MTKSTEREODEPTH_OKCODE(errid)         OKCODE(MODULE_MTK_STEREODEPTH, errid)
#define MTKSTEREODEPTH_ERRCODE(errid)        ERRCODE(MODULE_MTK_STEREODEPTH, errid)


// Detection error code
#define S_STEREODEPTH_OK                  MTKSTEREODEPTH_OKCODE(0x0000)

#define E_STEREODEPTH_NEED_OVER_WRITE     MTKSTEREODEPTH_ERRCODE(0x0001)
#define E_STEREODEPTH_NULL_OBJECT         MTKSTEREODEPTH_ERRCODE(0x0002)
#define E_STEREODEPTH_WRONG_STATE         MTKSTEREODEPTH_ERRCODE(0x0003)
#define E_STEREODEPTH_WRONG_CMD_ID        MTKSTEREODEPTH_ERRCODE(0x0004)
#define E_STEREODEPTH_WRONG_CMD_PARAM     MTKSTEREODEPTH_ERRCODE(0x0005)

#define E_STEREODEPTH_ERR                 MTKSTEREODEPTH_ERRCODE(0x0100)
