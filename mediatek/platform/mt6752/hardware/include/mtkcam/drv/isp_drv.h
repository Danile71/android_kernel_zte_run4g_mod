...
({																					\
	MUINT32 addrOffset=(MUINT32)(&(IspDrvPtr->mpIspVirRegMap->RegName))-(MUINT32)(IspDrvPtr->mpIspVirRegMap);\
...
/*/////////////////////////////////////////////////////////////////////
    CommandQ control
/////////////////////////////////////////////////////////////////////*/
#define ISP_TUNING_QUEUE_NUM        21
...
//TH    CAM_TOP_IMGSYS  = 0, // 99   15000000~15000188
    ...
    CAM_P1_MAGIC_NUM,    // 2    150075DC~150040E0
    CAM_P1_MAGIC_NUM_D,  // 2    150075E4~150040E8
    CAM_RESERVED_00,
    CAM_DUMMY_,
    CAM_MODULE_MAX
...
typedef struct
{
	ISP_DRV_IRQ_CLEAR_ENUM  Clear; //remove this
	...
	char*			   		UserName;
	MUINT32					irq_TStamp;
	MUINT32                 bDumpReg;//if this value = 0xfe, no dump
...
class IspDrv
{
    ...
    public:
		...
		virtual MBOOL   registerIrq(ISP_DRV_WAIT_IRQ_STRUCT WaitIrq) = 0;
		...
		virtual MUINT32   getCurHWRegValues()=0;
        ...
        // debug information
        virtual MBOOL dumpCQTable(ISP_DRV_CQ_ENUM cq,MINT32 burstQIdx=0, MUINT32 dupCqIdx=0, MUINT32 cqDesVa=0, MUINT32 cqVirVa=0) = 0;
        ...
        virtual MUINT32 getTuningUpdateFuncBit(ETuningQueAccessPath ePath, MINT32 magicNum, MINT32 cq) = 0;
