    ...
    Event_Camera_Platform_Root = EVENT_CAMERA_PLATFORM_COMMON,
        ...
        Event_Core,
            ...
            Event_Core_Drv,
                ...
                // --Define the event used in twin driver
                Event_TwinDrv,
            ...
            // Define the event used in Core::Camnode
            Event_Core_Camnode,

                // --Define the event used in Feature Pipe
                Event_FeaturePipe,
                    Event_FeaturePipe_init,
                    Event_FeaturePipe_uninit,
                    Event_FeaturePipe_P2AThread,
                        Event_FeaturePipe_P2A_FeatureStream,
                    Event_FeaturePipe_P2BThread,
                        Event_FeaturePipe_P2B_FeatureStream,
                    Event_FeaturePipe_GPUThread,
                        Event_FeaturePipe_GPU_Memcpy,
                        Event_FeaturePipe_GPU_Warp,
                        Event_FeaturePipe_GPU_MDP,
                    Event_FeaturePipe_VFBThread,
                        Event_FeaturePipe_VFB_FD,
                        Event_FeaturePipe_VFB_Proc,
    ...
    {Event_Camera_Platform_Root, EVENT_CAMERA_ROOT, "CameraPlatform"}
        ...
        ,{Event_Core, Event_Camera_Platform_Root, "Core"}
            ...
            ,{Event_Core_Drv, Event_Core, "Drv"}
                ...
                // --Define the event used in twin driver
                ,{Event_TwinDrv, Event_Core_Drv, "TwinDrv"}
            ...
            // Define the event used in Core::Camnode
            ,{Event_Core_Camnode, Event_Core, "Camnode"}
                // --Define the event used in 3A pipe
                ,{Event_FeaturePipe, Event_Core_Camnode, "FeaturePipe"}
                    ,{Event_FeaturePipe_init, Event_FeaturePipe, "FeaturePipeInit"}
                    ,{Event_FeaturePipe_uninit, Event_FeaturePipe, "FeaturePipeUninit"}
                    ,{Event_FeaturePipe_P2AThread, Event_FeaturePipe, "FeaturePipeP2AThread"}
                        ,{Event_FeaturePipe_P2A_FeatureStream, Event_FeaturePipe_P2AThread, "FeaturePipeP2AFeatureStream"}
                    ,{Event_FeaturePipe_P2BThread, Event_FeaturePipe, "FeaturePipeP2BThread"}
                        ,{Event_FeaturePipe_P2B_FeatureStream, Event_FeaturePipe_P2BThread, "FeaturePipeP2BFeatureStream"}
                    ,{Event_FeaturePipe_GPUThread, Event_FeaturePipe, "FeaturePipeGPUThread"}
                        ,{Event_FeaturePipe_GPU_Memcpy, Event_FeaturePipe_GPUThread, "FeaturePipeGPUMemcpy"}
                        ,{Event_FeaturePipe_GPU_Warp, Event_FeaturePipe_GPUThread, "FeaturePipeGPUWarp"}
                        ,{Event_FeaturePipe_GPU_MDP, Event_FeaturePipe_GPUThread, "FeaturePipeGPUMDP"}
                    ,{Event_FeaturePipe_VFBThread, Event_FeaturePipe, "FeaturePipeVFBThread"}
                        ,{Event_FeaturePipe_VFB_FD, Event_FeaturePipe_VFBThread, "FeaturePipeVFBFD"}
                        ,{Event_FeaturePipe_VFB_Proc, Event_FeaturePipe_VFBThread, "FeaturePipeVFBProc"}
