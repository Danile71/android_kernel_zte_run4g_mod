...
enum EFeatureStreamTag
{
    ...
    EFeatureStreamTag_vFB_Stream    ,
    EFeatureStreamTag_vFB_FB        ,
    EFeatureStreamTag_MFB_Cap       ,
    EFeatureStreamTag_MFB_Bld       ,
    EFeatureStreamTag_MFB_Mix       ,
    EFeatureStreamTag_N3D_Stream_M  ,
    EFeatureStreamTag_N3D_Stream_M2 ,
    EFeatureStreamTag_PRaw_Stream   ,
    EFeatureStreamTag_CCRaw_Stream  ,
...
public:     ////                    Instantiation.
     ...
     *
     */
    static  IFeatureStream*          createInstance(char const* szCallerName,EFeatureStreamTag streamTag,MUINT32 openedSensorIndex);
