    ...
    public :
       ...
       /**
        ...
        /**
               ...
               *-MTRUE indicates success, otherwise indicates fail
             */
        virtual MINT32 LomoImageEnque(uint32_t* ppDstImgVA, MUINT32 ppEffectIdx)  = 0;
        ...
        /**
               ...
               *-MTRUE indicates success, otherwise indicates fail
             */
        virtual MINT32 LomoImageDeque(uint32_t* ppDstImgMVA, MUINT32 ppEffectIdx)  = 0;
...
public:
	...
	MVOID fps(MINT32 count)
	{
		...
		{
		    lddiff = 0.1;
		    XLOGD("[lomo: %s,count-%d (fps) Id: %d] too fast! : %f\n", mInfo, count , mIdx, (double)1000/lddiff*1000);		
		}
		else
		{
		    XLOGD("[lomo: %s,count-%d (fps) Id: %d] non-zero: %f\n", mInfo, count , mIdx, (double)1000/lddiff*1000);
		}
	}
	~LomoTimer()
	{
