...
#define ACDK_LOGD(fmt,arg...)  VV_MSG(" \n[%s]" fmt, __func__, ##arg)
#define ACDK_INFO(fmt,arg...)  VV_MSG(" \n[%s]INF(%5d):" fmt, __func__, __LINE__, ##arg)
#define ACDK_WARN(fmt,arg...)  VV_MSG(" \n[%s]WRN(%5d):" fmt, __func__, __LINE__, ##arg)
#define ACDK_LOGE(fmt,arg...)  VV_ERRMSG("{ \n#%d:%s}Err :" fmt,__LINE__,__FILE__, ##arg)
