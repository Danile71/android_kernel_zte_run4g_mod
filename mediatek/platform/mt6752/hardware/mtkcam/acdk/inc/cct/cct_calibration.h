...
public:
    ...
    //!
    /////////////////////////////////////////////////////////////////////////
    MRESULT init(MINT32 dev, AcdkBase *a_pAcdkBaseObj);
    ...
    int flashCalibration(int senDev);
    ...
    MRESULT flashCalibrationTemp(ACDK_CDVT_AE_PLINE_TEST_INPUT_T* in, int inSize, ACDK_CDVT_AE_PLINE_TEST_OUTPUT_T* out, int outSize, MUINT32* realOutSize);
