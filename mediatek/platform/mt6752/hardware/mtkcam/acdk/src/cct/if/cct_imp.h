...
private:    //// ISP feature control
    ...
    MVOID   setIspOnOff_LCE(MBOOL const fgOn);
...
public:
    ...
    virtual MINT32 captureFeatureControl(MUINT32 a_u4Ioctl, MUINT8 *puParaIn, MUINT32 u4ParaInLen, MUINT8 *puParaOut, MUINT32 u4ParaOutLen, MUINT32 *pu4RealParaOutLen);

private:
    //helper functions
    MINT32 getSensorStaticInfo();//get m_SensorStaticInfo
