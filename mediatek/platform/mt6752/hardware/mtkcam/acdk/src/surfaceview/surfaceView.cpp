...
MINT32 surfaceView::init()
{
    ...
    if(g_overlayFlag == 0)
    {
       ...
       if (ioctl(mFBfd, MTKFB_SET_OVERLAY_LAYER, &mLayerInfo[0]) < 0)
       {
        ...
        mLayerInfo[0].layer_id = 2; //just for disable usage. mLayerInfo[0] disable layer0 and mLayerInfo[1] disable layer1
...
MINT32 surfaceView::uninit()
{
    ...
    if (mFBfd > 0 )
    {
        ...
        mLayerInfo[0].layer_id = 2; // disable layer2
        ...
        mLayerInfo[0].layer_id = 3; // disable layer3
