...
public:     ////    operation
    ...
    virtual MBOOL   requestBuffer_GB(MUINT32 const data, AllocInfo const & info, sp<GraphicBuffer>* pGraphicBuffer) = 0;
    virtual MBOOL   getGraphicBuffer(MUINT32 const data, IImageBuffer const * pImageBuffer, sp<GraphicBuffer>** pGraphicBuffer) = 0;
};
