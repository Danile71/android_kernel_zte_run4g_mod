...
*
******************************************************************************/
MBOOL FeaturePipeEisNode::onPostBuffer(MUINT32 const data, MUINT32 const buf, MUINT32 const ext)
{
...
MBOOL FeaturePipeEisNode::threadLoopUpdate()
{
    ...
    { 
        ...
        {
            LOG_INF("EIS WarpMap(0x%08x,%d)",(MUINT32)(ptr+i),*(ptr+i));
        }
    }   
    ...
    if(mFeatureOnMask & FEATURE_ON_MASK_BIT_VFB)    //vFB on
    {
        ...
        handlePostBuffer(EISSW_TO_VFBSW, (MUINT32) &warpImgReq, mFrameNum.front());
    }
    else    //vFB off
    {
        LOG_DBG("EIS->GPU warp map(%u)", mFrameNum.front());
        handlePostBuffer(EISSW_TO_GPU, (MUINT32) &warpImgReq, mFrameNum.front());
    }
...
*
******************************************************************************/
MBOOL FeaturePipeEisNode::onReturnBuffer(MUINT32 const data, MUINT32 const buf, MUINT32 const ext)
{   
...
*
******************************************************************************/
MVOID FeaturePipeEisNode::onDumpBuffer(const char* usr, MUINT32 const data, MUINT32 const buf, MUINT32 const ext)
{
}
