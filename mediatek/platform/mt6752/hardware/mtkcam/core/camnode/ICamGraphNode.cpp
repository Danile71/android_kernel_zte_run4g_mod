...
MBOOL
ICamNode::
handlePostBuffer(MUINT32 const data, MUINT32 const buf, MUINT32 const ext) const
{
...
MBOOL
ICamNode::
handleReturnBuffer(MUINT32 const data, MUINT32 const buf, MUINT32 const ext) const
{
