...
class ShotCallbackNodeImpl : public ShotCallbackNode
{
    ...
    private: 
        ...
        MBOOL   queueData(MUINT32 const data, MUINT32 const buf, MUINT32 const ext);
...
MBOOL
ShotCallbackNodeImpl::
queueData(MUINT32 const data, MUINT32 const buf, MUINT32 const ext)
{   
    FUNC_START;
    MINT64 timestamp;
...
MVOID
ShotCallbackNodeImpl::
handleDataCallback(MUINT32 const msg, MUINT32 const ext1, MUINT32 const ext2, IImageBuffer* const pImgBuf) const
{
    if( mDataCb == NULL )
    {
