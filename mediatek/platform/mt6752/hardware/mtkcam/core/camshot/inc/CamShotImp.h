...
protected:  ////    Data Members.
    ...
    //
    //  notify callback
    MINT32         mi4NotifyMsgSet;//  bitset of notify message types.
    CamShotNotifyCallback_t    mNotifyCb;      //  notify callback function pointer.
    //
    //  data callback
    MINT32         mi4DataMsgSet;  //  bitset of data message types.
...
protected:
    ...
    MBOOL      handleDataCallback(MINT32 const i4Msg, MUINT32 const ext1, MUINT32 const ext2, IImageBuffer* pImgBuf); 
