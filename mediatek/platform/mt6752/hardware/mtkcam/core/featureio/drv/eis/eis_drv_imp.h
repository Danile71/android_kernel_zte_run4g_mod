...
public:
    ...
    /**
       ...
       */
    virtual MVOID GetEisHwStatistic(EIS_STATISTIC_STRUCT *apEisStat,const MINT64 &aTimeStamp);
    ...
    /**
         ...
         *@param[in] aTimeStamp : time stamp of  pass1 image
       */
    virtual MVOID GetEisHwStatistic(EIS_STATISTIC_T *apEisStat,const MINT64 &aTimeStamp);    
