...
#define mcuIOC_T_MOVETO       _IOW('A',1,unsigned long)
#define mcuIOC_T_SETINFPOS    _IOW('A',2,unsigned long)
#define mcuIOC_T_SETMACROPOS  _IOW('A',3,unsigned long)
#define mcuIOC_T_SETPARA      _IOW('A',5,unsigned long)
