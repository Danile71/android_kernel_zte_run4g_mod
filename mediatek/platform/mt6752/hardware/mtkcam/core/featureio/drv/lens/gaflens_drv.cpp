...
********************************************************************************/
MCUDrv*
GAFLensDrv::getInstance()
{
    static GAFLensDrv singleton;
    return &singleton;
}
...
********************************************************************************/
int
GAFLensDrv::init(unsigned int a_u4CurrSensorDev )
{
    ...
    {    
        ...
        sprintf(cBuf,"%s", MCUDrv::m_LensInitFunc_main[MCUDrv::m_u4CurrLensIdx_main].LensDrvName);
    }
    else if(a_u4CurrSensorDev==MCU_DEV_MAIN_2)
    {    
        a_u4CurrLensIdx=MCUDrv::m_u4CurrLensIdx_main2;
        sprintf(cBuf,"%s", "/dev/GAF008AF");
        ...
        sprintf(cBuf,"%s", MCUDrv::m_LensInitFunc_main2[MCUDrv::m_u4CurrLensIdx_main2].LensDrvName);

    }
    else if(a_u4CurrSensorDev==MCU_DEV_SUB)
    {    
        a_u4CurrLensIdx=MCUDrv::m_u4CurrLensIdx_sub;
        sprintf(cBuf,"%s", "/dev/GAF002AF");
        ...
        sprintf(cBuf,"%s",MCUDrv::m_LensInitFunc_sub[MCUDrv::m_u4CurrLensIdx_sub].LensDrvName);
    }
    else 
        return MCUDrv::MCU_INVALID_DRIVER;
    
    DRV_DBG("[GLensDriver]%s\n", cBuf);
    DRV_DBG("[GLensDriverName]%x\n", strtol(cBuf, NULL, 0)); 
	moveMCU( strtol(cBuf, NULL, 0),a_u4CurrSensorDev);
...
********************************************************************************/
int
GAFLensDrv::uninit(unsigned int a_u4CurrSensorDev )
{
    if(a_u4CurrSensorDev==MCU_DEV_MAIN)
    {    
...
********************************************************************************/
int
GAFLensDrv::moveMCU(int a_i4FocusPos,unsigned int a_u4CurrSensorDev )
{
...
********************************************************************************/
int
GAFLensDrv::getMCUInfo(mcuMotorInfo *a_pMotorInfo, unsigned int a_u4CurrSensorDev )
{
...
********************************************************************************/
int
GAFLensDrv::setMCUInfPos(int a_i4FocusPos,unsigned int a_u4CurrSensorDev )
{
...
********************************************************************************/
int
GAFLensDrv::setMCUMacroPos(int a_i4FocusPos,unsigned int a_u4CurrSensorDev )
{
...
int
GAFLensDrv::setMCUParam(int ois_param,unsigned int a_u4CurrSensorDev )
{
    int err, a_fdMCU,a_u4CurrLensIdx; 
