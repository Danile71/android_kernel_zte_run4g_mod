...
#include <mtkcam/core/featureio/pipe/aaa/aaa_hal_yuv.h>
//
...
)
{
    ...
    if (EN_3A_CB_LOG) MY_LOG("[%s] _msgType(%d) _ext1(0x%08x) _ext2(0x%08x) _ext3(0x%08x)", __FUNCTION__, _msgType, _ext1, _ext2, _ext3);
