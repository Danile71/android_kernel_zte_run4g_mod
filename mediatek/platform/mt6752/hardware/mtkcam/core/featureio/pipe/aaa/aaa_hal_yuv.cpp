...
init(MINT32 i4SensorOpenIndex)
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev, SENSOR_CMD_GET_YUV_EV_INFO_AWB_REF_GAIN, (MINT32)&ref, 0, 0);
...
MBOOL 
Hal3AYuv::postCommand(ECmd_T const eCmd, MINT32 const i4Arg)
#else
MBOOL 
Hal3AYuv::sendCommand(ECmd_T const eCmd, MINT32 const i4Arg)
#endif
{
    MBOOL bRet = MTRUE;
...
MBOOL Hal3AYuv::setAeLock(MBOOL bLock)
{
    ...
    if (m_fgAwbLockSupp == 1)
    {
        ...
        m_pIHalSensor->sendCommand(m_i4SensorDev, SENSOR_CMD_SET_YUV_3A_CMD, (int)&iYuv3ACmd,0,0);
    }
...
MBOOL Hal3AYuv::setVideoFrmRate(MINT32 i4FrmRate)
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev, SENSOR_CMD_SET_VIDEO_FRAME_RATE, (int)&i4FrmRate, 0, 0);
...
MBOOL Hal3AYuv::setFrmRate(MINT32 i4Min, MINT32 i4Max)
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev,  SENSOR_CMD_SET_MIN_MAX_FPS, (int)&i4Min, (int)&i4Max, 0);
...
{\
    ...
    m_pIHalSensor->sendCommand(\
        m_i4SensorDev, SENSOR_CMD_SET_YUV_FEATURE_CMD, (int)&cmd, (int)&param, 0);\
}\
...
MBOOL Hal3AYuv::getSupportedParams(FeatureParam_T &rFeatureParam)
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_GET_YUV_AE_AWB_LOCK,(int)&ae_lock,(int)&awb_lock,0);
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_GET_YUV_AF_MAX_NUM_FOCUS_AREAS,(int)&max_focus,0,0);
    m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_GET_YUV_AE_MAX_NUM_METERING_AREAS,(int)&max_meter,0,0);
...
MBOOL Hal3AYuv::set3AEXIFInfo(IBaseCamExif *pIBaseCamExif) const
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_GET_YUV_EXIF_INFO,(int)&mSensorInfo,0,0);
...
MINT32 Hal3AYuv::getDelayFrame(EQueryType_T const eQueryType) const
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_GET_YUV_DELAY_INFO,(int)&pDelay,0,0);
...
{
    MY_LOG("[%s] cb(0x%08x)", __FUNCTION__, (MINT32)cb);
...
get3AStatusFromSensor()
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev, SENSOR_CMD_GET_YUV_AF_STATUS, (int)&m_i4AfStatus, 0, 0);
    m_pIHalSensor->sendCommand(m_i4SensorDev, SENSOR_CMD_GET_YUV_AE_STATUS, (int)&m_i4AeStatus, 0, 0);
    m_pIHalSensor->sendCommand(m_i4SensorDev, SENSOR_CMD_GET_YUV_AWB_STATUS, (int)&m_i4AwbStatus, 0, 0);
...
MVOID Hal3AYuv::setMeteringAreas(MINT32 a_i4Cnt, AREA_T const *a_psAEArea)
{
    ...
    else  // spot or matrix meter
    {
        ...
        m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_SET_YUV_AE_WINDOW,(int)zone_addr,0,0);
    }
...
MBOOL Hal3AYuv::resetAFAEWindow()
{
    ...
    if (m_max_af_areas > 0)
    {
        m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_SET_YUV_AF_WINDOW,(int)ai4Zone,0,0);
    }

    if (m_max_metering_areas > 0)
    {
        m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_SET_YUV_AE_WINDOW,(int)ai4Zone,0,0);
    }
...
MINT32 Hal3AYuv::isAEFlashOn()
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev, SENSOR_CMD_GET_YUV_TRIGGER_FLASHLIGHT_INFO, (int)&u4TrigFlashOn,0,0);
       ...
       MUINT32 a_u4ExpTime, MUINT32 a_u4SensorGain)
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_SET_SENSOR_EXP_LINE,(int)&a_u4ExpTime,0,0);
    m_pIHalSensor->sendCommand(m_i4SensorDev,SENSOR_CMD_SET_SENSOR_GAIN,(int)&a_u4SensorGain,0,0);
...
MINT32 Hal3AYuv::getASDInfo(ASDInfo_T &a_ASDInfo)
{
    ...
    m_pIHalSensor->sendCommand(m_i4SensorDev, SENSOR_CMD_GET_YUV_CURRENT_SHUTTER_GAIN_AWB_GAIN, (MINT32)&cur, 0, 0);
