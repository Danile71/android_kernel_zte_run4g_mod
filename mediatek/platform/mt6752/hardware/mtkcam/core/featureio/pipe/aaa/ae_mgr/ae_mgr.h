...
public:
    ...
    MRESULT doAFAE(MINT32 i4FrameCount, MVOID *pAEStatBuf, MINT32 i4ActiveAEItem, MUINT32 u4AAOUpdate);
    MRESULT doPreCapAE(MINT32 i4FrameCount, MBOOL bIsStrobeFired, MVOID *pAEStatBuf, MINT32 i4ActiveAEItem, MUINT32 u4AAOUpdate);
    MRESULT doCapAE();
    MRESULT doBackAEInfo();
    MRESULT doRestoreAEInfo(MBOOL bRestorePrvOnly);
    MRESULT doPvAE(MINT32 i4FrameCount, MVOID *pAEStatBuf, MINT32 i4ActiveAEItem, MUINT32 u4AAOUpdate);
    ...
    MBOOL getAEGammaIdx(MINT32 *i4AEGammaIdx);
