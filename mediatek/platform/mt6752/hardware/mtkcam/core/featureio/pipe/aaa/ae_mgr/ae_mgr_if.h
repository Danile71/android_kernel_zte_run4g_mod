...
public:
     ...
     */
    MRESULT doAFAE(MINT32 i4SensorDev, MINT32 i4FrameCount, MVOID *pAEStatBuf, MINT32 i4ActiveAEItem, MUINT32 u4AAOUpdate);
    /**
     ...
     * @param [in] u4AAOUpdate AAO buffer update or not     
     */
    MRESULT doPreCapAE(MINT32 i4SensorDev, MINT32 i4FrameCount, MBOOL bIsStrobeFired, MVOID *pAEStatBuf, MINT32 i4ActiveAEItem, MUINT32 u4AAOUpdate);
    /**
     ...
     * @param [in] u4AAOUpdate AAO buffer update or not     
     */
    MRESULT doPvAE(MINT32 i4SensorDev, MINT32 i4FrameCount, MVOID *pAEStatBuf, MINT32 i4ActiveAEItem, MUINT32 u4AAOUpdate);
    /**
    ...
    */
    ...
    /**
     * @brief get AE gamma index
     * @param [out] i4AEGammaIdx output the gamma index value
    */        
    MBOOL getAEGammaIdx(MINT32 i4SensorDev, MINT32 *i4AEGammaIdx);
