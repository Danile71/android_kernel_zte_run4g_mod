...
MVOID AfMgr::setFlkWinConfig()
{
    ...
    if(m_eSensorTG ==ESensorTG_1)
    {
        if (MFALSE == sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AF,
                                           (MINT32)&handle, (MINT32)(&("AFMgr::setFlkWinConfig()"))))
        {
    ...
    if (MFALSE==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("AFMgr::setFlkWinConfig()")), MNULL))
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE setFlkWinConfig fail");
...
MVOID AfMgr::setAFWinConfig(AF_AREA_T a_sAFArea)
{
    ...
    {
        if (MFALSE ==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AF,
                                           (MINT32)&handle, (MINT32)(&("AFMgr::setAFWinConfig()"))))
        {
    ...
    if (MFALSE==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("AFMgr::setAFWinConfig")), MNULL))
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE setAFWinConfig fail");
}
...
{
    MINT32 handle;
    if (MFALSE==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_TG_OUT_SIZE, m_i4SensorIdx, (MINT32)(&m_i4AF_in_Hsize), (MINT32)(&m_i4AF_in_Vsize)))
    ...
    if(m_eSensorTG ==ESensorTG_1)
    {
        ...
        if (MFALSE ==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AF,
                                       (MINT32)&handle, (MINT32)(&("AFMgr::setAF_IN_HSIZE()"))))
        {
    ...
    if (MFALSE==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("AFMgr::setAF_IN_HSIZE")), MNULL))
...
MVOID AfMgr::setAFWinTH(AF_CONFIG_T a_sAFConfig)
{
    ...
    {
        if (MFALSE ==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AF,
                                           (MINT32)&handle, (MINT32)(&("AFMgr::setAFWinTH()"))))
        {
    ...
    if (MFALSE==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("AFMgr::setAFWinTH")), MNULL))
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE setAFWinTH fail");
}
...
{
    MINT32 handle, i4_SGG[7], i4_SGG_setting1, i4_SGG_setting2;
    ...
    if(m_eSensorTG ==ESensorTG_1)
    {
        if (MFALSE ==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_SGG1,
                                           (MINT32)&handle, (MINT32)(&("AFMgr::setGMR()"))))
        {
    ...
    if (MFALSE==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("AFMgr::setGMR")), MNULL))
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE setGMR fail");
...
MVOID AfMgr::setAFConfig(AF_CONFIG_T a_sAFConfig)
{
    ...
    if (MFALSE==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_TWIN_INFO, (MINT32)&istwinmode, -1,-1))
    ...
    {
        if (MFALSE ==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_AF,
                                           (MINT32)&handle, (MINT32)(&("AFMgr::setAFConfig()"))))
        {
    ...
    if (MFALSE==sendAFNormalPipe(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("AFMgr::setAFConfig")), MNULL))
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE setAFConfig fail");
}
...
if(m_eSensorTG ==ESensorTG_1)
{
     MY_LOG("DoAFTG1 [XY]%d %d [Sz]%d %d  [G]%d %d %d %d %d %d %d [Hz]%d ",
