...
MRESULT IAfMgr::init(MINT32 i4SensorDev, MINT32 i4SensorIdx)
{   
    if (i4SensorDev & ESensorDev_Main)
        return AfMgr::getInstance(ESensorDev_Main).init(i4SensorIdx);
    if (i4SensorDev & ESensorDev_Sub)
        return AfMgr::getInstance(ESensorDev_Sub).init(i4SensorIdx);
    if (i4SensorDev & ESensorDev_MainSecond)
        return AfMgr::getInstance(ESensorDev_MainSecond).init(i4SensorIdx);   
    return AfMgr::getInstance(ESensorDev_Main).init(i4SensorIdx);
}

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT IAfMgr::uninit(MINT32 i4SensorDev)
{   
    if (i4SensorDev & ESensorDev_Main)
        return AfMgr::getInstance(ESensorDev_Main).uninit();
    if (i4SensorDev & ESensorDev_Sub)
        return AfMgr::getInstance(ESensorDev_Sub).uninit();
    if (i4SensorDev & ESensorDev_MainSecond)
        return AfMgr::getInstance(ESensorDev_MainSecond).uninit();    
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
EAfState_T IAfMgr::getAFState(MINT32 i4SensorDev)
{
    if (i4SensorDev & ESensorDev_Main)
