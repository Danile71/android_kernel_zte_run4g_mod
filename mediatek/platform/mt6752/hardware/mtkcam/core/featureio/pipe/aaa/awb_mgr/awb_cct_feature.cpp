...
)
{
    ...
    ISP_MGR_RPG_T::getInstance(m_eSensorDev, m_eSensorTG).setIspAWBGain(m_rAWBOutput.rPreviewAWBGain);
    ISP_MGR_PGN_T::getInstance(m_eSensorDev).setIspAWBGain (m_rAWBOutput.rPreviewAWBGain);
    //ISP_MGR_PGN_T::getInstance(m_eSensorDev).apply (static_cast<NSIspTuning::EIspProfile_T>(IspTuningMgr::getInstance().getIspProfile(m_eSensorDev)));
