...
MBOOL AwbMgr::cameraPreviewInit(MINT32 i4SensorIdx, Param_T &rParam)
{
    ...
    ISP_MGR_AWB_STAT_CONFIG_T::getInstance(m_eSensorDev, m_eSensorTG).config(m_rAWBStatCfg[m_i4StrobeMode][m_eSensorMode][m_eAWBMode], m_bHBIN2Enable, m_i4SensorIdx);
...
MBOOL AwbMgr::cameraCaptureInit()
{
    ...
    if (m_bEnableAWB && (m_eAWBMode != LIB3A_AWB_MODE_OFF))
    {
        if (m_i4StrobeMode == AWB_STROBE_MODE_ON) {
            ...
            ISP_MGR_AWB_STAT_CONFIG_T::getInstance(m_eSensorDev, m_eSensorTG).config(m_rAWBStatCfg[AWB_STROBE_MODE_ON][m_eSensorMode][m_eAWBMode], m_bHBIN2Enable, m_i4SensorIdx);
        }
        else {
            ...
            // update AWB statistics config
            ISP_MGR_AWB_STAT_CONFIG_T::getInstance(m_eSensorDev, m_eSensorTG).config(m_rAWBStatCfg[AWB_STROBE_MODE_OFF][m_eSensorMode][m_eAWBMode], m_bHBIN2Enable, m_i4SensorIdx);
        }
...
MBOOL AwbMgr::doAFAWB(MVOID *pAWBStatBuf, MBOOL bApplyToHW)
{
    ...
    if (m_bEnableAWB && (!m_bAWBLock) && (!m_bAdbAWBLock) && (m_eAWBMode != LIB3A_AWB_MODE_OFF))
    {
        if (/*(m_i4StrobeMode == AWB_STROBE_MODE_ON) &&*/ (m_bStrobeModeChanged))
        {
            ...
            // update AWB statistics config
            ISP_MGR_AWB_STAT_CONFIG_T::getInstance(m_eSensorDev, m_eSensorTG).config(m_rAWBStatCfg[m_i4StrobeMode/*AWB_STROBE_MODE_ON*/][m_eSensorMode][m_eAWBMode], m_bHBIN2Enable, m_i4SensorIdx);
...
MBOOL AwbMgr::getInitInputParam(SYNC_CTC_INIT_PARAM &CCTInitParam, NORMAL_GAIN_INIT_INPUT_PARAM &NoramlGainInitParam)
{
    ...
    CCTInitParam.i4CCT[eHorizon_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCCTEstimation.i4CCT[eHorizon_Light];
    CCTInitParam.i4CCT[eA_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCCTEstimation.i4CCT[eA_Light];
    CCTInitParam.i4CCT[eTL84_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCCTEstimation.i4CCT[eTL84_Light];
    CCTInitParam.i4CCT[eDNP_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCCTEstimation.i4CCT[eDNP_Light];
    CCTInitParam.i4CCT[eD65_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCCTEstimation.i4CCT[eD65_Light];

    NoramlGainInitParam.NormalWB_Gain[eHorizon_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rLightAWBGain.rHorizon;
    NoramlGainInitParam.NormalWB_Gain[eA_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rLightAWBGain.rA;
    NoramlGainInitParam.NormalWB_Gain[eTL84_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rLightAWBGain.rTL84;
    NoramlGainInitParam.NormalWB_Gain[eDNP_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rLightAWBGain.rDNP;
    NoramlGainInitParam.NormalWB_Gain[eD65_Light] = m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rLightAWBGain.rD65;
...
MBOOL AwbMgr::getEEPROMData()
{
    ...
    {
        MY_LOG("NO err (%s)", CamCalErrString[enCamCalEnum]);
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4R = static_cast<MINT32>(GetCamCalData.Single2A.S2aAwb.rGoldGainu4R);
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4G = static_cast<MINT32>(GetCamCalData.Single2A.S2aAwb.rGoldGainu4G);
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4B = static_cast<MINT32>(GetCamCalData.Single2A.S2aAwb.rGoldGainu4B);
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4R = static_cast<MINT32>(GetCamCalData.Single2A.S2aAwb.rUnitGainu4R);
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4G = static_cast<MINT32>(GetCamCalData.Single2A.S2aAwb.rUnitGainu4G);
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4B = static_cast<MINT32>(GetCamCalData.Single2A.S2aAwb.rUnitGainu4B);
    }

    MY_LOG("m_pNVRAM_3A->rAWBNVRAM[%d].rCalData.rGoldenGain.i4R = %d\n", m_i4AWBNvramIdx, m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4R);
    MY_LOG("m_pNVRAM_3A->rAWBNVRAM[%d].rCalData.rGoldenGain.i4G = %d\n", m_i4AWBNvramIdx, m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4G);
    MY_LOG("m_pNVRAM_3A->rAWBNVRAM[%d].rCalData.rGoldenGain.i4B = %d\n", m_i4AWBNvramIdx, m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4B);
    MY_LOG("m_pNVRAM_3A->rAWBNVRAM[%d].rCalData.rUnitGain.i4R = %d\n", m_i4AWBNvramIdx, m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4R);
    MY_LOG("m_pNVRAM_3A->rAWBNVRAM[%d].rCalData.rUnitGain.i4G = %d\n", m_i4AWBNvramIdx, m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4G);
    MY_LOG("m_pNVRAM_3A->rAWBNVRAM[%d].rCalData.rUnitGain.i4B = %d\n", m_i4AWBNvramIdx, m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4B);
...
MBOOL AwbMgr::queryHBinInfo()
{
    ...
    // query HBIN info
    if (MFALSE == pPipe->sendCommand(NSImageio::NSIspio::EPIPECmd_GET_HBIN_INFO, m_i4SensorIdx, (MINT32)&rNormalPipe_HBIN_Info, MNULL))
    {
        // Error Handling
       ...
       for (awbMode = LIB3A_AWB_MODE_AUTO; awbMode < LIB3A_AWB_MODE_NUM; awbMode++)
		{
            ...
            m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][awbMode].i4Cos = m_rAWBInitInput.rAWBNVRAM.rRotationMatrix.i4Cos;
            m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][awbMode].i4Sin = m_rAWBInitInput.rAWBNVRAM.rRotationMatrix.i4Sin;
		}
        ...
        // Tungsten
        m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINR[AWB_LIGHT_TUNGSTEN] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4RightBound;
        m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINL[AWB_LIGHT_TUNGSTEN] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4LeftBound;
        m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WIND[AWB_LIGHT_TUNGSTEN] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4LowerBound;
        m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINU[AWB_LIGHT_TUNGSTEN] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4UpperBound;

        // Warm fluorescent
        m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINR[AWB_LIGHT_WARM_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINL[AWB_LIGHT_WARM_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WIND[AWB_LIGHT_WARM_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINU[AWB_LIGHT_WARM_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4UpperBound;

		// Fluorescent
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINR[AWB_LIGHT_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINL[AWB_LIGHT_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WIND[AWB_LIGHT_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINU[AWB_LIGHT_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4UpperBound;

		// CWF
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINR[AWB_LIGHT_CWF] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINL[AWB_LIGHT_CWF] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WIND[AWB_LIGHT_CWF] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINU[AWB_LIGHT_CWF] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4UpperBound;

		// Daylight
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINR[AWB_LIGHT_DAYLIGHT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINL[AWB_LIGHT_DAYLIGHT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WIND[AWB_LIGHT_DAYLIGHT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINU[AWB_LIGHT_DAYLIGHT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4UpperBound;

		// Shade
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINR[AWB_LIGHT_SHADE] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rShade.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINL[AWB_LIGHT_SHADE] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rShade.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WIND[AWB_LIGHT_SHADE] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rShade.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINU[AWB_LIGHT_SHADE] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rShade.i4UpperBound;

		// Daylight fluorescent
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINR[AWB_LIGHT_DAYLIGHT_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINL[AWB_LIGHT_DAYLIGHT_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WIND[AWB_LIGHT_DAYLIGHT_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINU[AWB_LIGHT_DAYLIGHT_FLUORESCENT] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4UpperBound;

		// Strobe
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINR[AWB_LIGHT_STROBE] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINL[AWB_LIGHT_STROBE] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WIND[AWB_LIGHT_STROBE] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_AUTO].i4AWBXY_WINU[AWB_LIGHT_STROBE] = m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4UpperBound;

        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4RightBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4RightBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4LeftBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4LeftBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4LowerBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4LowerBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4UpperBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rTungsten.i4UpperBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4RightBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4RightBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4LeftBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4LeftBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4LowerBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4LowerBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4UpperBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rWarmFluorescent.i4UpperBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4RightBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4RightBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4LeftBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4LeftBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4LowerBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4LowerBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4UpperBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rFluorescent.i4UpperBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4RightBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4RightBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4LeftBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4LeftBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4LowerBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4LowerBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4UpperBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rCWF.i4UpperBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4RightBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4RightBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4LeftBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4LeftBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4LowerBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4LowerBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4UpperBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylight.i4UpperBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4RightBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4RightBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4LeftBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4LeftBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4LowerBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4LowerBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4UpperBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rDaylightFluorescent.i4UpperBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4RightBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4RightBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4LeftBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4LeftBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4LowerBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4LowerBound);
        MY_LOG("[%d][AWBStatConfig] m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4UpperBound = %d\n", m_eSensorDev, m_rAWBInitInput.rAWBNVRAM.rAWBLightArea.rStrobe.i4UpperBound);
		...
		{
			m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][i].i4AWBXY_WINR[PWB_REFERENCE_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rReferenceArea.i4RightBound;
			m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][i].i4AWBXY_WINL[PWB_REFERENCE_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rReferenceArea.i4LeftBound;
			m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][i].i4AWBXY_WIND[PWB_REFERENCE_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rReferenceArea.i4LowerBound;
			m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][i].i4AWBXY_WINU[PWB_REFERENCE_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rReferenceArea.i4UpperBound;
		}

		// Daylight neutral area
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_DAYLIGHT].i4AWBXY_WINR[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rDaylight.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_DAYLIGHT].i4AWBXY_WINL[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rDaylight.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_DAYLIGHT].i4AWBXY_WIND[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rDaylight.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_DAYLIGHT].i4AWBXY_WINU[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rDaylight.i4UpperBound;

		// Cloudy daylight neutral area
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_CLOUDY_DAYLIGHT].i4AWBXY_WINR[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rCloudyDaylight.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_CLOUDY_DAYLIGHT].i4AWBXY_WINL[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rCloudyDaylight.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_CLOUDY_DAYLIGHT].i4AWBXY_WIND[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rCloudyDaylight.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_CLOUDY_DAYLIGHT].i4AWBXY_WINU[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rCloudyDaylight.i4UpperBound;

		// Shade neutral area
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_SHADE].i4AWBXY_WINR[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rShade.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_SHADE].i4AWBXY_WINL[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rShade.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_SHADE].i4AWBXY_WIND[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rShade.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_SHADE].i4AWBXY_WINU[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rShade.i4UpperBound;

		// Twilight neutral area
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_TWILIGHT].i4AWBXY_WINR[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rTwilight.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_TWILIGHT].i4AWBXY_WINL[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rTwilight.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_TWILIGHT].i4AWBXY_WIND[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rTwilight.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_TWILIGHT].i4AWBXY_WINU[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rTwilight.i4UpperBound;

		// Twilight neutral area
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_FLUORESCENT].i4AWBXY_WINR[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rFluorescent.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_FLUORESCENT].i4AWBXY_WINL[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rFluorescent.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_FLUORESCENT].i4AWBXY_WIND[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rFluorescent.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_FLUORESCENT].i4AWBXY_WINU[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rFluorescent.i4UpperBound;

		// Warm fluorescent neutral area
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_WARM_FLUORESCENT].i4AWBXY_WINR[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rWarmFluorescent.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_WARM_FLUORESCENT].i4AWBXY_WINL[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rWarmFluorescent.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_WARM_FLUORESCENT].i4AWBXY_WIND[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rWarmFluorescent.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_WARM_FLUORESCENT].i4AWBXY_WINU[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rWarmFluorescent.i4UpperBound;

		// Incandescent neutral area
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_INCANDESCENT].i4AWBXY_WINR[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rIncandescent.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_INCANDESCENT].i4AWBXY_WINL[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rIncandescent.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_INCANDESCENT].i4AWBXY_WIND[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rIncandescent.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_INCANDESCENT].i4AWBXY_WINU[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rIncandescent.i4UpperBound;

		// Gray world neutral area
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_GRAYWORLD].i4AWBXY_WINR[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rGrayWorld.i4RightBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_GRAYWORLD].i4AWBXY_WINL[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rGrayWorld.i4LeftBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_GRAYWORLD].i4AWBXY_WIND[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rGrayWorld.i4LowerBound;
		m_rAWBStatCfg[AWB_STROBE_MODE_ON][sensorMode][LIB3A_AWB_MODE_GRAYWORLD].i4AWBXY_WINU[PWB_NEUTRAL_AREA_INDEX] = m_rAWBInitInput.rAWBNVRAM.rPWBLightArea.rGrayWorld.i4UpperBound;
    }
...
MBOOL AwbMgr::AWBInit(Param_T &rParam)
{
    ...
    if (m_bAWBCalibrationBypassed) {
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4R = 0;
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4G = 0;
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rGoldenGain.i4B = 0;
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4R = 0;
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4G = 0;
        m_pNVRAM_3A->rAWBNVRAM[m_i4AWBNvramIdx].rCalData.rUnitGain.i4B = 0;
    }
