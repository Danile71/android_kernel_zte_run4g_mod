...
#else
#define LOG_TAG "flash_cct_quick.cpp"
...
{
    logI("g_flashQuickCalibrationResult = %d ln=%d\n", g_flashQuickCalibrationResult, __LINE__);
    return g_flashQuickCalibrationResult;
}

int FlashMgrM::cctCalibrationQuick(FlashExePara* para, FlashExeRep* rep)
{
#define STATE_INIT 0
#define STATE_AE 1
