...
public:
    ...
    int cctSetSpModeLock(int senorDev, int bLock);
    int cctSetSpModeCalibration(int senorDev);
    int cctSetSpModeQuickCalibration(int senorDev);
	int cctSetSpModeQuickCalibration2(int senorDev);
    int cctSetSpModeNormal(int senorDev);
    int cctGetQuickCalibrationResult(int senorDev);
