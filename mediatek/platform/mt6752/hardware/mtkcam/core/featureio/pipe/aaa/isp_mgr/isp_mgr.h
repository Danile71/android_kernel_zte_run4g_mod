...
protected:
     ...
     , m_eSensorDev(eSensorDev)
    {
        ...
        /*
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_Capture, eSoftwareScenario_Main_Pure_Raw_Stream); // FIXME: main2
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Preview, eSoftwareScenario_Main2_N3D_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Video, eSoftwareScenario_Main2_N3D_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_N3D_Capture, eSoftwareScenario_Main2_N3D_Stream);
        } 
       */
