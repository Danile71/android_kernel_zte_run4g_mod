...
apply_TG1(MINT32 i4SensorIndex)
{
    ...
    INormalPipe* pPipe = INormalPipe::createInstance(i4SensorIndex,"isp_mgr_ae_stat_tg1");

    // get module handle
    if (MFALSE == pPipe->sendCommand(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE, 
                           NSImageio::NSIspio::EModule_AE, (MINT32)&handle, (MINT32)(&("isp_mgr_ae_stat_tg1")))) {
        //Error Handling
...
lbExit:
    ...
    // release handle
    if (MFALSE==pPipe->sendCommand(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("isp_mgr_ae_stat_tg1")), MNULL)) {            
        // Error Handling  
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE fail");
    }
...
apply_TG2(MINT32 i4SensorIndex)
{
    ...
    INormalPipe* pPipe = INormalPipe::createInstance(i4SensorIndex,"isp_mgr_ae_stat_tg2");

    // get module handle
    if (MFALSE == pPipe->sendCommand(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE, 
                           NSImageio::NSIspio::EModule_AE_D, (MINT32)&handle, (MINT32)(&("isp_mgr_ae_stat_tg2")))) {
        //Error Handling
        MY_ERR("EPIPECmd_GET_MODULE_HANDLE fail");
        goto lbExit;
    }
...
lbExit:
    ...
    // release handle
    if (MFALSE==pPipe->sendCommand(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("isp_mgr_ae_stat_tg2")), MNULL)) {            
        // Error Handling  
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE fail");
    }
