...
apply_TG1()
{
    ...
    INormalPipe* pPipe = INormalPipe::createInstance(m_i4SensorIndex,"isp_mgr_awb_stat_tg1");
...
lbExit:
    ...
    // release handle
    if (MFALSE==pPipe->sendCommand(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("isp_mgr_awb_stat_tg1")), MNULL))
    {            
        // Error Handling  
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE fail");
    }
...
apply_TG2()
{
    ...
    INormalPipe* pPipe = INormalPipe::createInstance(m_i4SensorIndex,"isp_mgr_awb_stat_tg2");

    // get module handle
    if (MFALSE == pPipe->sendCommand(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE, 
                           NSImageio::NSIspio::EModule_AWB_D, (MINT32)&handle, (MINT32)(&("isp_mgr_awb_stat_tg2"))))
    {
        //Error Handling
        MY_ERR("EPIPECmd_GET_MODULE_HANDLE fail");
        goto lbExit;
...
lbExit:
    ...
    // release handle
    if (MFALSE==pPipe->sendCommand(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("isp_mgr_awb_stat_tg2")), MNULL))
    {            
        // Error Handling  
        MY_ERR("EPIPECmd_SET_MODULE_CFG_DONE fail");
    }
