...
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
    ISP_MGR_T::getInstance(eSensorDev, eSensorTG).get(rParam);
}
...
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
    ISP_MGR_T::getInstance(eSensorDev, eSensorTG).put(rParam);
}
...
{
    typedef typename ISPType2Type<ISP_XXX_T>::type ISP_MGR_T;
    ISP_MGR_T::getInstance(eSensorDev, eSensorTG).reset();
    ISP_MGR_T::getInstance(eSensorDev, eSensorTG).get(rParam);
}
