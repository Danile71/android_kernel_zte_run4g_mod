...
{
    PUT_REG_INFO(CAM_MFB_LL_CON2, ll_con2);
    PUT_REG_INFO(CAM_MFB_LL_CON3, ll_con3);
    PUT_REG_INFO(CAM_MFB_LL_CON4, ll_con4);
    PUT_REG_INFO(CAM_MFB_LL_CON5, ll_con5);
    PUT_REG_INFO(CAM_MFB_LL_CON6, ll_con6);
...
{
    GET_REG_INFO(CAM_MFB_LL_CON2, ll_con2);
    GET_REG_INFO(CAM_MFB_LL_CON3, ll_con3);
    GET_REG_INFO(CAM_MFB_LL_CON4, ll_con4);    
    GET_REG_INFO(CAM_MFB_LL_CON5, ll_con5);
    GET_REG_INFO(CAM_MFB_LL_CON6, ll_con6);
