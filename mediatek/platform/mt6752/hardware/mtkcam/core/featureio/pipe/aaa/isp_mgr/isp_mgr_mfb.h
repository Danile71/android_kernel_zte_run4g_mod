...
private:
    ...
    enum
    {
        ERegInfo_CAM_MFB_LL_CON2,
        ERegInfo_CAM_MFB_LL_CON3,
        ERegInfo_CAM_MFB_LL_CON4,
        ERegInfo_CAM_MFB_LL_CON5,
        ERegInfo_CAM_MFB_LL_CON6,
        ERegInfo_NUM
    };
...
protected:
    ISP_MGR_MFB(ESensorDev_T const eSensorDev)
        ...
        , m_bEnable(MTRUE)      
        , m_u4StartAddr(REG_ADDR(CAM_MFB_LL_CON2))
    {
 
        // register info addr init
        INIT_REG_INFO_ADDR(CAM_MFB_LL_CON2); // 0x0968
        INIT_REG_INFO_ADDR(CAM_MFB_LL_CON3); // 0x096C
        INIT_REG_INFO_ADDR(CAM_MFB_LL_CON4); // 0x0970
        INIT_REG_INFO_ADDR(CAM_MFB_LL_CON5); // 0x0974
        INIT_REG_INFO_ADDR(CAM_MFB_LL_CON6); // 0x0978
    }
