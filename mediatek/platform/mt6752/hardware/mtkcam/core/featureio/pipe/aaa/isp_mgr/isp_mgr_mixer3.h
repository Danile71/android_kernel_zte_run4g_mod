...
private:
    ...
    enum
    {
        ERegInfo_CAM_MIX3_CTRL_0,
        ERegInfo_CAM_MIX3_CTRL_1,
        ERegInfo_CAM_MIX3_SPARE,
        ERegInfo_NUM
    };
...
protected:
    ISP_MGR_MIXER3(ESensorDev_T const eSensorDev)
        ...
        , m_bEnable(MTRUE)      
        , m_u4StartAddr(REG_ADDR(CAM_MIX3_CTRL_0))
    {
 
        // register info addr init
        INIT_REG_INFO_ADDR(CAM_MIX3_CTRL_0); // 0x0CB0
        INIT_REG_INFO_ADDR(CAM_MIX3_CTRL_1); // 0x0CB4
        INIT_REG_INFO_ADDR(CAM_MIX3_SPARE);  // 0x0CB8  
    }
