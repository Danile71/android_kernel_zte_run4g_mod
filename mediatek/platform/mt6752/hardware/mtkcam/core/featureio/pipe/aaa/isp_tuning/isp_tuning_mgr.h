...
public: // Operations.
     ...
     */
    MBOOL validate(MINT32 const i4SensorDev, MINT32 const i4FrameID, MBOOL const fgForce = MFALSE);
     ...
     * @param [in] fgForce TRUE: force validation
     */
    MBOOL validatePerFrame(MINT32 const i4SensorDev, MINT32 const i4FrameID, MBOOL const fgForce = MFALSE);
     ...
     */
    MBOOL getDebugInfo(MINT32 const i4SensorDev, NSIspExifDebug::IspExifDebugInfo_T& rIspExifDebugInfo, MBOOL const fgReadFromHW);
