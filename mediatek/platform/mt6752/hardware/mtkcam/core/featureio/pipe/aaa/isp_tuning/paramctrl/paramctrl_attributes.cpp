...
setAEInfo(AE_INFO_T const &rAEInfo)
{
    ...
    if(checkParamChange(m_rIspCamInfo.rAEInfo.bGammaEnable, rAEInfo.bGammaEnable)) {
        MY_LOG_IF(m_bDebugEnable, "[+m_rIspCamInfo.rAEInfo.bGammaEnable](old, new)=(%d, %d)", m_rIspCamInfo.rAEInfo.bGammaEnable, rAEInfo.bGammaEnable);
        m_rIspCamInfo.rAEInfo.bGammaEnable = rAEInfo.bGammaEnable;    
    }
