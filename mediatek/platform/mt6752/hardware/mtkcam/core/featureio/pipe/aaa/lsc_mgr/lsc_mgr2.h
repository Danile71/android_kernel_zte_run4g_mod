...
public:
    ...
    static LscMgr2*         createInstance(ESensorDev_T const eSensorDev, MINT32 i4SensorIdx, ESensorTG_T eSensorTG, NVRAM_CAMERA_ISP_PARAM_STRUCT& rIspNvram);
    ...
    MRESULT                 getDebugInfo(SHADING_DEBUG_INFO_T &rShadingDbgInfo);
    ...
    MINT32                  setLscRatio(MINT32 i4Rto);
    MVOID                   updateLsc();
...
protected:
    ...
    MINT32                          m_i4OtpState;
    MUINT32                         m_u4CTIdx;
    MUINT32                         m_u4BaseAddr;
    MUINT32                         m_u4LogEn;
    MINT32                          m_i4Rto;
    MINT32                          m_i4RtoApplied;
