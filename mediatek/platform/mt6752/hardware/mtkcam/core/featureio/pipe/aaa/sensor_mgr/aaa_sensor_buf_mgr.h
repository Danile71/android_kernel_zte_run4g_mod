 ...
 ************************************************************************************************/
#ifndef _AAO_SENSOR_BUF_MGR_H_
#define _AAO_SENSOR_BUF_MGR_H_
...
private:    ////    Disallowed.
    ...
    IAEBufMgr(IAEBufMgr const&);
    //  Copy-assignment operator is disallowed.
    IAEBufMgr& operator=(IAEBufMgr const&);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    static IAEBufMgr& getInstance()
    {
        static IAEBufMgr singleton;
        return singleton;
    }
    ...
    MBOOL AAStatEnable(MINT32 const i4SensorDev, MBOOL En);
