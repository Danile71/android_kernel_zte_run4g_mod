...
//**********************************************************************************************************************************//
    ...
    gMyAsdInitInfo.pDeciderTuningInfo->IdxWeightBlScd= ASDThres2.s2IdxWeightBlScd;
    gMyAsdInitInfo.pDeciderTuningInfo->IdxWeightLsAe = ASDThres2.s2IdxWeightLsAe;
    gMyAsdInitInfo.pDeciderTuningInfo->IdxWeightLsAwb= ASDThres2.s2IdxWeightLsAwb;
    gMyAsdInitInfo.pDeciderTuningInfo->IdxWeightLsAf = ASDThres2.s2IdxWeightLsAf;
    gMyAsdInitInfo.pDeciderTuningInfo->IdxWeightLsScd= ASDThres2.s2IdxWeightLsScd;
    gMyAsdInitInfo.pDeciderTuningInfo->TimeWeightType = (ASD_DECIDER_TIME_WEIGHT_TYPE_ENUM) ASDThres1.u1TimeWeightType;
    gMyAsdInitInfo.pDeciderTuningInfo->TimeWeightRange = (ASD_DECIDER_TIME_WEIGHT_RANGE_ENUM) ASDThres1.u1TimeWeightRange;
    ...
    gMyAsdInitInfo.pDeciderTuningInfo->EvLoThrOutdoor= ASDThres2.s2EvLoThrOutdoor;
    gMyAsdInitInfo.pDeciderTuningInfo->EvHiThrOutdoor= ASDThres2.s2EvHiThrOutdoor;
    gMyAsdInitInfo.pDeciderTuningInfo->ScoreThrNight = ASDThres1.u1ScoreThrNight;
    gMyAsdInitInfo.pDeciderTuningInfo->ScoreThrBacklit = ASDThres1.u1ScoreThrBacklit;
    gMyAsdInitInfo.pDeciderTuningInfo->ScoreThrPortrait = ASDThres1.u1ScoreThrPortrait;
    gMyAsdInitInfo.pDeciderTuningInfo->ScoreThrLandscape = ASDThres1.u1ScoreThrLandscape;
    gMyAsdInitInfo.pDeciderTuningInfo->BacklitLockEnable = ASDThres2.boolBacklitLockEnable;
    gMyAsdInitInfo.pDeciderTuningInfo->BacklitLockEvDiff= ASDThres2.s2BacklitLockEvDiff;
      
    MY_LOGD("ASD_Custom:  IdxWeightBlAe(1):%d, IdxWeightBlScd(8):%d, EvLoThrNight(50):%d \n", gMyAsdInitInfo.pDeciderTuningInfo->IdxWeightBlAe, gMyAsdInitInfo.pDeciderTuningInfo->IdxWeightBlScd,
                   gMyAsdInitInfo.pDeciderTuningInfo->EvLoThrNight);
#endif                   
//**********************************************************************************************************************************//
...
//       MtkCameraFaceMetadata* FDResultInfo=(MtkCameraFaceMetadata*) FDResult;
	  ...
	  ASD_DECIDER_INFO_STRUCT gMyDeciderInfo;
		...
		gMyDeciderInfo.InfoFd.FdFaceNum=Face_Num;
		gMyDeciderInfo.InfoFd.FdMainFaceX0=0;  // for positive > 0
		gMyDeciderInfo.InfoFd.FdMainFaceY0=0;  // for positive > 0
		gMyDeciderInfo.InfoFd.FdMainFaceX1=0;  // for positive > 0
		gMyDeciderInfo.InfoFd.FdMainFaceY1=0;  // for positive > 0
