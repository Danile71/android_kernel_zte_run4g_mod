...
********************************************************************************/
MINT32
halFACEBEAUTIFY::mHalSTEP2(void* ImgSrcAddr, void* FaceMetadata, MTKPipeFaceBeautyPos* BeautifiedFacePos, void* FaceBeautyResultInfo
)
{	  
    MRESULT Retcode = S_FACEBEAUTY_OK;
    MY_LOGD("[mHalSTEP2] + \n");    
    ...
    for (int i; i<15; i++)
    {
        FaceBeautyProcInfo.fb_pos[i][0] = BeautifiedFacePos[i].x;                  
        FaceBeautyProcInfo.fb_pos[i][1] = BeautifiedFacePos[i].y;                  
    }
...
********************************************************************************/
MINT32 
halFACEBEAUTIFY::mHalSTEP1(void* ImgSrcAddr, void *ImgDstAddr, void* FaceBeautyResultInfo
)
{
    MY_LOGD("[mHalSTEP1] + \n");            
    MRESULT Retcode = S_FACEBEAUTY_OK;  
    ...
    FaceBeautyProcInfo.Step1DstImgAddr = (MUINT8*)ImgDstAddr;
