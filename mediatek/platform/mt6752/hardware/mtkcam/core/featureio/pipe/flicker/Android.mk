...
LOCAL_C_INCLUDES:= \
    ...
    $(MTK_PATH_PLATFORM)/hardware/include/mtkcam/algorithm/libflicker \
    $(MTK_PATH_PLATFORM)/hardware/include/mtkcam/featureio \
    ...
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/core/featureio/pipe/aaa/sensor_mgr \
    $(MTK_PATH_PLATFORM)/hardware/hardware/include/mtkcam/algorithm/lib3a \
    $(MTK_PATH_PLATFORM)/hardware/hardware/include/mtkcam/algorithm/liblsctrans \
    $(MTK_PATH_PLATFORM)/hardware/hardware/include/mtkcam/algorithm/libtsf\
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware \
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/core/drv/imgsensor \
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/core/imageio/inc
