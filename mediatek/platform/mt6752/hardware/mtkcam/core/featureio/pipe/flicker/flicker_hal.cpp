...
#define logE(fmt, arg...) XLOGD("MError: func=%s line=%d: "fmt, __FUNCTION__, __LINE__, ##arg)
//=====================================================
// variable
//=====================================================
...
MINT32 FlickerHal::init(MINT32 i4SensorOpenIndex)
{
    ...
    err = pHalSensorObj->sendCommand(m_sensorDev,SENSOR_CMD_GET_PIXEL_CLOCK_FREQ, (int)&m_u4SensorPixelClkFreq, 0, 0);
    if(err != 0)
    {
        logI("No plck. \n");
    }
    ...
    err = pHalSensorObj->sendCommand(m_sensorDev,SENSOR_CMD_GET_FRAME_SYNC_PIXEL_LINE_NUM, (int)&m_u4PixelsInLine, 0, 0);
    if(err != 0)
    {
...
MINT32 FlickerHal::setFlickerDrv(MBOOL flicker_en)
{
    ...
    if (0 == pipeSendCommand(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,NSImageio::NSIspio::EModule_FLK,
                                  (MINT32)&handle, (MINT32)(&("FlickerHal::setFlickerDrv()"))))
    {
    ...
    else       //disable flicker
    {
	 ...
	 if (0==pipeSendCommand(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("FlickerHal::setFlickerDrv()")), MNULL))
    {
        logE("setFlickerDrv");
        return -1;
    }
...
MINT32 FlickerHal::setFlickerWinConfig(FLKWinCFG_T* ptFlkWinCfg)
{
    ...
    retv = pipeSendCommand(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,
                                ...
                                (MINT32)&handle, (MINT32)(&("FlickerHal::setFlickerWinConfig()")));
    if(retv==0)
    {
    ...
    retv = pipeSendCommand(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("FlickerHal::setFlickerWinConfig()")), MNULL);
    if(retv==0)
        logE("setFlickerWinConfig");
    return ret;
}
    ...
    unsigned long flicker_DMA_address ,MINT32 DMASize )
{
    ...
    if (0 == pipeSendCommand(NSImageio::NSIspio::EPIPECmd_GET_MODULE_HANDLE,
                                  ...
                                  (MINT32)&handle, (MINT32)(&("FlickerHal::setFlickerDMAConfig()")))    )
    {
        logE("setFlickerWinConfig");
    }
    else
    ...
    if (0==pipeSendCommand(NSImageio::NSIspio::EPIPECmd_RELEASE_MODULE_HANDLE, handle, (MINT32)(&("FlickerHal::setFlickerDMAConfig()")), MNULL))
    {
        logE("setFlickerDMAConfig");
    }
    return ret;
...
MINT32 FlickerHal::setWindowInfo(int* blkH, int*blkW)
{
	...
	MINT32 tgW;
	MINT32 tgH;
    pipeSendCommand(NSImageio::NSIspio::EPIPECmd_GET_TG_OUT_SIZE, m_sensorId, (MINT32)(&tgW), (MINT32)(&tgH));
    int imgW;
    int imgH;
    //--------------------------------------------
    // get sensor info
