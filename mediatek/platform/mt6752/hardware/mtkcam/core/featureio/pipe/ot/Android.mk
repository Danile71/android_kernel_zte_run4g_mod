...
LOCAL_C_INCLUDES:= \
	 ...
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/core/featureio/pipe/ot \
     ...
     $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/mtkcam/algorithm/libot \
...
LOCAL_MODULE := libfeatureiopipe_ot
