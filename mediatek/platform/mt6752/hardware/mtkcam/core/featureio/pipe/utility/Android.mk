...
LOCAL_C_INCLUDES:= \
   ...
   $(TOP)/$(MTK_PATH_SOURCE)/hardware/include \
	 $(TOP)/$(MTK_PATH_SOURCE)/hardware/include/mtkcam/v1/featureio \
	 $(TOP)/$(MTK_PATH_SOURCE)/external/mpo/inc \
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include \
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/core/featureio/pipe/utility/utility \
   $(TOP)/$(MTK_PATH_PLATFORM)/hardware/jpeg/inc \
...
LOCAL_MODULE := libcam.featureio.pipe.utility
