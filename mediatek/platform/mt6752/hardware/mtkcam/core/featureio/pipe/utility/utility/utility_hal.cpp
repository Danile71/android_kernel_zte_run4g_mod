                  ...
                  , MUINT32     quality)
{
    ...
    pMPOImageInfo->imageBuf = (char*)srcBuff.virtAddr;
    pMPOImageInfo->imageSize = u4JpegSize ;
    pMPOImageInfo->sourceType = SOURCE_TYPE_BUF;
    CAM_LOGD("[createPanoJpegImg] out");
    return ret;
}
