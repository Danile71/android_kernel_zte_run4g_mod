...
#ifndef _UTILITY_HAL_H_
#define _UTILITY_HAL_H_
...
*
********************************************************************************/
class halUTILITY: public halUTILITYBase 
{
public:
    //
    static halUTILITYBase* getInstance();
    ...
    //
    // ~halUTILITY () -
    //! \brief Utility base descontrustor 
    //
    /////////////////////////////////////////////////////////////////////////    
    virtual ~halUTILITY();
...
private:
    MBOOL    createJpegImgWithThumbnail(NSCamHW::ImgBufInfo const &rYuvImgBufInfo, IMEM_BUF_INFO jpgBuff, MUINT32 &u4JpegSize, MUINT32 quality);
    MBOOL    createJpegImg(NSCamHW::ImgBufInfo const & rSrcBufInfo
                     , MUINT32 quality
                     , bool fIsAddSOI
