...
protected:
    ...
    virtual int _waitIrq( int type, int userEnum,unsigned int irq );
...
public:
    ...
    virtual int enqueueBuf( MUINT32 const dmaChannel, stISP_BUF_INFO bufInfo, MVOID* private_data );
...
private:
    ...
    MUINT32         m_p1NotifyObj[p1Notify_node];
...
public:
    ...
    MBOOL   P1Notify_Mapping(MUINT32 cmd,MUINT32 obj);
public:
    MUINT32 BurstQNum;
    MUINT32 DupQIdx;
};
