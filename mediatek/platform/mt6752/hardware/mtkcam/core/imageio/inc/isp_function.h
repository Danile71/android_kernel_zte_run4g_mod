...
public:
    ISP_RGB_PIPE():en_p2(0),magicNum(0),dupCqIdx(0),burstQueIdx(0),drvScenario(0),sub_mode(0),CQ(CAM_ISP_CQ_NONE),rrzRatio(1.0),rrzCropX(0),rrzCropY(0),enFgMode(0){};
...
public:
    ...
    Nr3DCfg nr3dCfg;
public:
    ISP_YUV_PIPE():en_p2(0),magicNum(0),dupCqIdx(0),burstQueIdx(0),drvScenario(0),sub_mode(0),CQ(CAM_ISP_CQ_NONE),sl2cCrzRatio(1.0),lceInputW(0),lceInputH(0),fe_ctrl(0x0){};
    ~ISP_YUV_PIPE(){};
...
public:
    ...
    int p2_dma_enable;
public:
    ISP_MDP_PIPE():mdp_imgxo_p2_en(0),CQ(CAM_ISP_CQ_NONE),magicNum(0),dupCqIdx(0),burstQueIdx(0),drvScenario(-1),isWaitBuf(MTRUE),p2_dma_enable(0){};
    ~ISP_MDP_PIPE(){};
...
public:
    CAM_CRZ_PIPE():conf_cdrz(0),conf_rotDMA(0),CQ(CAM_ISP_CQ_NONE),tpipeMode(CRZ_DRV_MODE_TPIPE),dupCqIdx(0),burstQueIdx(0){};
public:
    virtual int checkBusy( unsigned long* param ){return 0;}
...
public:
    CAM_TDRI_PIPE():dupCqIdx(0),burstQueIdx(0),enTdri(0),CQ(CAM_ISP_CQ_NONE),tcm_en(0),tdr_en(0),magicNum(0),drvScenario(0),sub_mode(0),lceInputW(0),lceInputH(0){};
...
public:
    ...
    /*
        ...
        */
    virtual MINT32 enqueueHwBuf( MUINT32 dmaChannel, stISP_BUF_INFO bufInfo,MINT32 enqueCq =0,MINT32 dupCqIdx =0 );
    virtual MINT32 enqueueHwBuf( MUINT32 dmaChannel, stISP_BUF_INFO bufInfo, MVOID* private_data );
    /*
        * dequeueMdpFrameEnd
