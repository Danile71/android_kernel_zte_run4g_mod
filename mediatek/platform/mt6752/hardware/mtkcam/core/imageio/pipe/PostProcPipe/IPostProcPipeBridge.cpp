...
public:     ////    Buffer Quening.
    ...
    //
    virtual MBOOL   endequeFrameCtrl(EPIPE_BUFQUECmd cmd,MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 timeout=0);//christopher
    //
...
public:     ////    Settings.
    virtual MBOOL   configPipe(vector<PortInfo const*>const& vInPorts, vector<PortInfo const*>const& vOutPorts,\
                                    MINT32 burstQIdx,MINT32 const dupCqIdx,MVOID* const pCookie,vector<ModuleParaInfo>const& vModuleParams);
...
{
    Mutex::Autolock _lock(mLock);
    return  getImp()->configPipe(vInPorts, vOutPorts,burstQIdx,dupCqIdx,pCookie,vModuleParams);
}
/*******************************************************************************
*
********************************************************************************/
...
*
********************************************************************************/
MBOOL IPostProcPipeBridge::endequeFrameCtrl(EPIPE_BUFQUECmd cmd,MUINT32 callerID,MINT32 p2burstQIdx,MINT32 p2dupCQIdx,MINT32 timeout)
{
    Mutex::Autolock _lock(mLock);
    return  getImp()->endequeFrameCtrl(cmd , callerID,p2burstQIdx,p2dupCQIdx, timeout);
}
/*******************************************************************************
* ICmd
********************************************************************************/
