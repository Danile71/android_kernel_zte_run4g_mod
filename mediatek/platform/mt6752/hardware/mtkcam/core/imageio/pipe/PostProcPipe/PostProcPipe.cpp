...
MINT32 u4PortID[DMA_PORT_TYPE_NUM][DMA_OUT_PORT_NUM] = {/*0*/{(MINT32)EPortIndex_IMG2O, (MINT32)EPortIndex_IMG3O, (MINT32)EPortIndex_WDMAO, (MINT32)EPortIndex_WROTO, (MINT32)EPortIndex_JPEGO, (MINT32)EPortIndex_FEO, (MINT32)EPortIndex_VIPI},
                                                        /*1*/{(MINT32)EPortIndex_IMG2O, (MINT32)EPortIndex_IMG3O, (MINT32)EPortIndex_WDMAO, (MINT32)EPortIndex_WROTO, (MINT32)EPortIndex_VIPI,  (MINT32)-1,             (MINT32)-1},
                                                        /*2*/{(MINT32)EPortIndex_WDMAO, (MINT32)EPortIndex_WROTO, (MINT32)EPortIndex_JPEGO, (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*3*/{(MINT32)EPortIndex_WDMAO, (MINT32)EPortIndex_WROTO, (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*4*/{(MINT32)EPortIndex_IMG2O, (MINT32)EPortIndex_IMG3O, (MINT32)EPortIndex_VIPI,  (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*5*/{(MINT32)EPortIndex_IMG2O, (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*6*/{(MINT32)EPortIndex_IMG3O, (MINT32)EPortIndex_VIPI,  (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        /*7*/{(MINT32)EPortIndex_FEO,   (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,               (MINT32)-1,             (MINT32)-1},
                                                        };

 Scen_Map_CropPathInfo_STRUCT mCropPathInfo[]
	=	{
    //eDrvScenario_CC
    {eDrvScenario_CC,              (MUINT32)(ECropGroupIndex_NONE),                &(u4PortID[6][0])},
    {eDrvScenario_CC,              (MUINT32)(ECropGroupIndex_1),                   &(u4PortID[5][0])},
    {eDrvScenario_CC,              (MUINT32)(ECropGroupIndex_2),                   &(u4PortID[3][0])},
    //eDrvScenario_CC_SShot
    {eDrvScenario_CC_SShot,        (MUINT32)(ECropGroupIndex_1),                   &(u4PortID[4][0])},
    {eDrvScenario_CC_SShot,        (MUINT32)(ECropGroupIndex_2),                   &(u4PortID[3][0])},
    //eDrvScenario_VSS
    {eDrvScenario_VSS,             (MUINT32)(ECropGroupIndex_NONE),                &(u4PortID[6][0])},
    {eDrvScenario_VSS,             (MUINT32)(ECropGroupIndex_1),                   &(u4PortID[5][0])},
    {eDrvScenario_VSS,             (MUINT32)(ECropGroupIndex_2),                   &(u4PortID[3][0])},
    //eDrvScenario_CC_MFB_Blending
    {eDrvScenario_CC_MFB_Blending, (MUINT32)(ECropGroupIndex_1),                   &(u4PortID[4][0])},
    //eDrvScenario_CC_MFB_Mixing
    {eDrvScenario_CC_MFB_Mixing,   (MUINT32)(ECropGroupIndex_1),                   &(u4PortID[4][0])},
    ...
    {eDrvScenario_CC_vFB_Normal,   (MUINT32)(ECropGroupIndex_1),                   &(u4PortID[6][0])},
    {eDrvScenario_CC_vFB_Normal,   (MUINT32)(ECropGroupIndex_1|ECropGroupIndex_2), &(u4PortID[3][0])},
    //eDrvScenario_CC_vFB_FB
    {eDrvScenario_CC_vFB_FB,       (MUINT32)(ECropGroupIndex_1),                   &(u4PortID[6][0])},
    {eDrvScenario_CC_vFB_FB,       (MUINT32)(ECropGroupIndex_1|ECropGroupIndex_2), &(u4PortID[3][0])},
    //eDrvScenario_IP
    {eDrvScenario_IP,              (MUINT32)(ECropGroupIndex_NONE),                &(u4PortID[6][0])},
    //eDrvScenario_CC_RAW
    {eDrvScenario_CC_RAW,          (MUINT32)(ECropGroupIndex_NONE),                &(u4PortID[6][0])},
...
uninit()
{
    ...
    buf_info.virtAddr = (MUINT32)pJpgConfigVa;
				...
				MINT32 const burstQIdx,MINT32 const dupCqIdx,MVOID* const pCookie,vector<ModuleParaInfo>const& vModuleParams)
{
	...
	if(dupCqIdx>=ISP_DRV_P2_CQ_DUPLICATION_NUM || dupCqIdx<0)
	{
		PIPE_ERR("exception cqGroupSetIdx(%d)",dupCqIdx);
		return MFALSE;
	}
	int ret = 0;
...
//    }
    ...
    for (MUINT32 i = 0 ; i < vInPorts.size() ; i++ )
	{
        ...
        switch(vInPorts[i]->index)
        {
			case EPortIndex_IMGI:
                ...
                PIPE_INF("[Imgi][crop_1](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,h,tarW,tarH)=(%d,%d,%d,%d)--[crop_2](x,f_x,y,f_y)=(%d,%d,%d,%d),(w,h,tarW,tarH)=(%d,%d,%d,%d),pass2_CQ(%d),dupCqIdx(%d)", \
                        ...
                        portInfo_imgi.crop2.w,portInfo_imgi.crop2.h,portInfo_imgi.resize1.tar_w,portInfo_imgi.resize1.tar_h,pass2_CQ,dupCqIdx);
        ...
        enqueInBuf(portID, rQBufInfo,pass2_CQ,dupCqIdx);
    }
    //
    for (MUINT32 i = 0 ; i < vOutPorts.size() ; i++ )
	{
        ...
        enqueOutBuf(portID, rQBufInfo,pass2_CQ,dupCqIdx);
    }
    /////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
	//
	for (MUINT32 i = 0 ; i < vModuleParams.size() ; i++ )
	{
        switch(vModuleParams[i].eP2module){
            case EP2Module_NR3D:
                if(reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct))
                {
                	en_p2 |= CAM_CTL_EN_P2_NR3D_EN;
	                m_camPass2Param.nr3d_cfg.ctrl_lmtOutCntTh=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->ctrl_lmtOutCntTh;
					m_camPass2Param.nr3d_cfg.ctrl_onEn=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->ctrl_onEn;
					m_camPass2Param.nr3d_cfg.onOff_onOfStX=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->onOff_onOfStX;
					m_camPass2Param.nr3d_cfg.onOff_onOfStY=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->onOff_onOfStY;
					m_camPass2Param.nr3d_cfg.onSiz_onWd=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->onSiz_onWd;
					m_camPass2Param.nr3d_cfg.onSiz_onHt=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->onSiz_onHt;
					m_camPass2Param.nr3d_cfg.gain_weighting=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->gain_weighting;
			m_camPass2Param.nr3d_cfg.vipi_offst=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->vipi_offst;
			m_camPass2Param.nr3d_cfg.vipi_readW=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->vipi_readW;
			m_camPass2Param.nr3d_cfg.vipi_readH=reinterpret_cast<Nr3DCfg*>(vModuleParams[i].moduleStruct)->vipi_readH;
                ...
                break;
            case EP2Module_SRZ1:
            	if(reinterpret_cast<SrzSizeCfg*>(vModuleParams[i].moduleStruct))
                {
	            	en_p2|=CAM_CTL_EN_P2_SRZ1_EN;
	            	m_camPass2Param.srz1_cfg.inout_size.in_w=reinterpret_cast<SrzSizeCfg*>(vModuleParams[i].moduleStruct)->in_w;
		            m_camPass2Param.srz1_cfg.inout_size.in_h=reinterpret_cast<SrzSizeCfg*>(vModuleParams[i].moduleStruct)->in_h;
		            m_camPass2Param.srz1_cfg.inout_size.out_w=reinterpret_cast<SrzSizeCfg*>(vModuleParams[i].moduleStruct)->out_w;
		            m_camPass2Param.srz1_cfg.inout_size.out_h=reinterpret_cast<SrzSizeCfg*>(vModuleParams[i].moduleStruct)->out_h;
    ...
    if((stISP_BUF_INFO*)pCookie) {
        ...
        if((((stISP_BUF_INFO*)pCookie)->dma)==ISP_DMA_RRZO || (((stISP_BUF_INFO*)pCookie)->dma)==ISP_DMA_RRZO_D){

            rrzCropX = (MUINT32)(((stISP_BUF_INFO*)pCookie)->rrz_info.srcX);
            rrzCropY = (MUINT32)(((stISP_BUF_INFO*)pCookie)->rrz_info.srcY);
            if((((stISP_BUF_INFO*)pCookie)->rrz_info.dstH)) {
                rrzRatio = (MFLOAT)(((stISP_BUF_INFO*)pCookie)->rrz_info.dstH) / (((stISP_BUF_INFO*)pCookie)->rrz_info.srcH);
            } else {
                PIPE_ERR("[Error]wrong dstH(%d),pCookie(0x%x),rrz_info(0x%x)",(((stISP_BUF_INFO*)pCookie)->rrz_info.dstH),pCookie,&(((stISP_BUF_INFO*)pCookie)->rrz_info));
            }
            PIPE_DBG("[rrz]pCookie(0x%x),src(%d,%d,%d,%d),dst(%d,%d)",pCookie, \
                (((stISP_BUF_INFO*)pCookie)->rrz_info.srcX),(((stISP_BUF_INFO*)pCookie)->rrz_info.srcY),(((stISP_BUF_INFO*)pCookie)->rrz_info.srcW), \
                (((stISP_BUF_INFO*)pCookie)->rrz_info.srcH),(((stISP_BUF_INFO*)pCookie)->rrz_info.dstW),(((stISP_BUF_INFO*)pCookie)->rrz_info.dstH));
        }
...
//                en_p2_dma |=  CAM_CTL_DMA_EN_VIPI_EN;
    ...
    PIPE_INF("Pass(%d),imgi.fmt(0x%x),meScenarioID(%d),isCropG1En(%d),m_CrzEn(%d),mdpSrcFmt(0x%x),mdp_src(%d,%d,%d,%d),en_p2_dma(0x%08x),crop1TableIdx(%d),mdpCheck1(%d),mdpCheck2(%d),drvScenario(%d)",\
    ...
    m_camPass2Param.croppara.mdp_Yin.w,m_camPass2Param.croppara.mdp_Yin.h,m_camPass2Param.croppara.mdp_Yin.stride,m_camPass2Param.croppara.mdp_UVin.stride,\
        en_p2_dma,crop1TableIdx,mdpCheck1,mdpCheck2,drvScenario);
    //
