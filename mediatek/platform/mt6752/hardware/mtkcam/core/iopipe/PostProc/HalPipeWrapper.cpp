...
SwHwScenarioPathMapping mSwHwPathMapping[eSoftwareScenario_total_num]=
{
    ...
    //
    {eSoftwareScenario_Main2_N3D_Stream,     "Main2_N3DStream",       NSImageio::NSIspio::eDrvScenario_CC_vFB_FB,          NSImageio::NSIspio::EPipePass_PASS2B,   EPathCQ_CQ2},
...
)
{
    ...
    callerPostProc=(MUINT32)NSImageio::NSIspio::IPostProcPipe::createInstance(mSwHwPathMapping[swScenario].hwPath);
