...
{   //must in this order cuz deque order
    ...
    EPostProcPortIdx_UFDI   ,
    EPostProcPortIdx_LCEI   ,
    EPostProcPortIdx_VIPI   ,
    EPostProcPortIdx_VIP2I  ,
    EPostProcPortIdx_VIP3I  ,     //5
    EPostProcPortIdx_IMGO   ,
    EPostProcPortIdx_MFBO   ,
    EPostProcPortIdx_FEO    ,
    EPostProcPortIdx_IMG3CO ,
    EPostProcPortIdx_IMG3BO ,       //10
    EPostProcPortIdx_IMG3O  ,
    EPostProcPortIdx_IMG2O  ,
    EPostProcPortIdx_JPEGO  ,
    EPostProcPortIdx_WROTO  ,
    EPostProcPortIdx_WDMAO  ,       //15
    EPostProcPortIdx_VENC_STREAMO ,
    //
    EPostProcPortIdx_NUM    = 17    //17
};
...
struct SwHwScenarioPathMapping
{
    ...
    NSImageio::NSIspio::EDrvScenario hwPath;
...
struct BufParamPackage
{
    ...
    NSImageio::NSIspio::EDrvScenario drvSce;
    ...
    , bufTag(_bufTag)
    , jpgo_idx(_jpgo_idx)
    , drvSce(NSImageio::NSIspio::eDrvScenario_CC)
    , dequedNum(0)
...
public:     ////                    Instantiation.
     ...
     */
    MBOOL                   init(MINT32 swScenario,MUINT32& callerPostProc);
    /**
