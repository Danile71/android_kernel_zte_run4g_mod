...
ESoftwareScenario const gSenDevSwScenMap[ENormalStreamTag_total][SENSOR_DEV_MAIN_3D+1]=
{
    {eSoftwareScenario_Main_Normal_Stream,eSoftwareScenario_Main_Normal_Stream,eSoftwareScenario_Sub_Normal_Stream,\
        eSoftwareScenario_total_num,eSoftwareScenario_total_num,eSoftwareScenario_total_num},//ENormalStreamTag_Prv
    {eSoftwareScenario_Main_Normal_Capture,eSoftwareScenario_Main_Normal_Capture,eSoftwareScenario_Sub_Normal_Capture,\
        eSoftwareScenario_total_num,eSoftwareScenario_total_num,eSoftwareScenario_total_num},//ENormalStreamTag_Cap
    ...
    MUINT32 openedSensorIndex)
{
    ...
    return new NormalStream(streamTag,openedSensorIndex);
    FUNCTION_LOG_END;
}
/*******************************************************************************
*
            ...
            , mSWScen(eSoftwareScenario_total_num)
{
   ...
   LOG_INF("tag/sidx/sdev(%d/0x%x/0x%x),swPipe cID(0x%x)",mStreamTag,openedSensorIndex,mOpenedSensor,(MUINT32)(&mDequeuedBufList));
}
...
init()
{
    ...
    else
    {
        ...
        mpHalPipeWrapper->init(mSWScen,(MUINT32&)(this->mpPostProcPipe));
    }
