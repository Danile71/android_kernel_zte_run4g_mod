...
public:     ////    Operations.
     ...
     *   
     *      eCodecType 
     *      [I] jpeg encode type: SW or HW
     *   
     *      u4TimeoutMs
     *      [I] timeout for waiting HW encoder available
     *      
     *      u4EncSize
...
private:
    ...
    MBOOL     getAlignment(MINT32 const eFmt, MUINT32* width, MUINT32* height);
    MBOOL     mapToJpgFmt(MINT32 imgfmt, MUINT32* jpgfmt, MUINT32* planenum);
    MBOOL     checkIfNeedImgTransform(
                  IImageBuffer const *pSrcBufInfo, 
                  IImageBuffer const * pDstBufInfo, 
                  MRect const rROI, 
                  MUINT32 const u4Transform
...
#endif  //  _MTK_PLATFORM_HARDWARE_MTKCAM_CORE_IOPIPE_SIMAGER_JPEG_CODEC_H_
