...
class LomoHalJniImp : public LomoHalJni
{
    public :
       ...
       /**
        ...
        /**
               ...
               *-MTRUE indicates success, otherwise indicates fail
             */
        virtual MINT32 LomoImageEnque( uint32_t* ppDstImgVA, MUINT32 ppEffectIdx)  ;
        /**
               *@brief post process effect with effectIdx and dst image VA (YUY2 to YV12)
               *
               *@param[in] ppDstImgMVA : post process dst image virtual addr
               ...
               *-MTRUE indicates success, otherwise indicates fail
             */
        virtual MINT32 LomoImageDeque(uint32_t* ppDstImgMVA, MUINT32 ppEffectIdx)  ;
 ...
 //       volatile MINT32  mInitCountLomoHalJni;
...
//        mutable Mutex mLockLomoHalJni;
        ...
        MUINT32 gu32pvCBVA[LOMO_HAL_JNI_MAX_PLANE];
        MUINT32 gu32pvCBMVA[LOMO_HAL_JNI_MAX_PLANE];
        
        MUINT32 gu32ppSrcImgWidth;
        MUINT32 gu32ppSrcImgHeight;
        MUINT32 gu32ppSrcImgVA[LOMO_HAL_JNI_MAX_PLANE];        
        MUINT32 gu32ppSrcImgMVA[LOMO_HAL_JNI_MAX_PLANE];
        
        MUINT32 gu32ppDstImgWidth;
        MUINT32 gu32ppDstImgHeight;
        MUINT32 gu32ppDstImgformat;
        MUINT32 gu32ppDstImgVA[LOMO_HAL_JNI_MAX_PLANE];        
        MUINT32 gu32ppDstImgMVA[LOMO_HAL_JNI_MAX_PLANE];
...
//        IImageBufferAllocator* allocator;
