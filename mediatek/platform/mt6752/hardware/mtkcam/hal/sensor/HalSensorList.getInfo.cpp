    ...
    for(idx=0; idx<1; idx++) {
        ...
        switch (idx) {
            case 0:
                ...
                pSensorDrv->sendCommand(SENSOR_MAIN, CMD_SENSOR_GET_MCLK_CONNECTION, &data1);
                sensorPara[idx].mclkSrc = data1;
                pSensorDrv->sendCommand(SENSOR_MAIN, CMD_SENSOR_GET_MIPI_SENSOR_PORT, &data1);
                sensorPara[idx].mipiPad = data1;
                
                sensorStaticInfo[idx].sensorDevID = pSensorDrv->getMainSensorID();
                pSensorDrv->sendCommand(SENSOR_MAIN, CMD_SENSOR_GET_SENSOR_ORIENTATION_ANGLE, &data1); 
                sensorStaticInfo[idx].orientationAngle = data1; 
                pSensorDrv->sendCommand(SENSOR_MAIN, CMD_SENSOR_GET_SENSOR_FACING_DIRECTION, &data1); 
                sensorStaticInfo[idx].facingDirection = data1;
                pSensorDrv->sendCommand(SENSOR_MAIN, CMD_SENSOR_GET_FAKE_ORIENTATION, &data1); 
                sensorStaticInfo[idx].fakeOrientation = data1;
                pSensorDrv->sendCommand(SENSOR_MAIN, CMD_SENSOR_GET_SENSOR_VIEWANGLE, &data1, &data2); 
                ...
                pSensorDrv->sendCommand(SENSOR_MAIN, CMD_SENSOR_GET_DEFAULT_FRAME_RATE_BY_SCENARIO, &data1, &data2);
            ...
            case 1:
                ...
                pSensorDrv->sendCommand(SENSOR_SUB, CMD_SENSOR_GET_MCLK_CONNECTION, &data1);
                sensorPara[idx].mclkSrc = data1;
                pSensorDrv->sendCommand(SENSOR_SUB, CMD_SENSOR_GET_MIPI_SENSOR_PORT, &data1);
                sensorPara[idx].mipiPad = data1;
                
                sensorStaticInfo[idx].sensorDevID = pSensorDrv->getSubSensorID();
                pSensorDrv->sendCommand(SENSOR_SUB, CMD_SENSOR_GET_SENSOR_ORIENTATION_ANGLE, &data1); 
                sensorStaticInfo[idx].orientationAngle = data1;                
                pSensorDrv->sendCommand(SENSOR_SUB, CMD_SENSOR_GET_SENSOR_FACING_DIRECTION, &data1); 
                sensorStaticInfo[idx].facingDirection = data1;
                pSensorDrv->sendCommand(SENSOR_SUB, CMD_SENSOR_GET_FAKE_ORIENTATION, &data1); 
                sensorStaticInfo[idx].fakeOrientation = data1;
                pSensorDrv->sendCommand(SENSOR_SUB, CMD_SENSOR_GET_SENSOR_VIEWANGLE, &data1, &data2); 
                sensorStaticInfo[idx].horizontalViewAngle =data1;
                sensorStaticInfo[idx].verticalViewAngle = data2;
                
                data1 = SENSOR_SCENARIO_ID_NORMAL_PREVIEW;
                pSensorDrv->sendCommand(SENSOR_SUB, CMD_SENSOR_GET_DEFAULT_FRAME_RATE_BY_SCENARIO, &data1, &data2);
                sensorStaticInfo[idx].previewFrameRate = data2;
                data1 = SENSOR_SCENARIO_ID_NORMAL_CAPTURE;
                pSensorDrv->sendCommand(SENSOR_SUB, CMD_SENSOR_GET_DEFAULT_FRAME_RATE_BY_SCENARIO, &data1, &data2);
                sensorStaticInfo[idx].captureFrameRate = data2;
            ...
            case 2:
                ...
                pSensorDrv->sendCommand(SENSOR_MAIN_2, CMD_SENSOR_GET_MCLK_CONNECTION, &data1);
                sensorPara[idx].mclkSrc = data1;
                pSensorDrv->sendCommand(SENSOR_MAIN_2, CMD_SENSOR_GET_MIPI_SENSOR_PORT, &data1);
                sensorPara[idx].mipiPad = data1;
                
                sensorStaticInfo[idx].sensorDevID = pSensorDrv->getMain2SensorID();
                pSensorDrv->sendCommand(SENSOR_MAIN_2, CMD_SENSOR_GET_SENSOR_ORIENTATION_ANGLE, &data1); 
                sensorStaticInfo[idx].orientationAngle = data1;                
                pSensorDrv->sendCommand(SENSOR_MAIN_2, CMD_SENSOR_GET_SENSOR_FACING_DIRECTION, &data1); 
                sensorStaticInfo[idx].facingDirection = data1;
                pSensorDrv->sendCommand(SENSOR_MAIN_2, CMD_SENSOR_GET_FAKE_ORIENTATION, &data1); 
                sensorStaticInfo[idx].fakeOrientation = data1;
                pSensorDrv->sendCommand(SENSOR_MAIN_2, CMD_SENSOR_GET_SENSOR_VIEWANGLE, &data1, &data2); 
                sensorStaticInfo[idx].horizontalViewAngle =data1;
                sensorStaticInfo[idx].verticalViewAngle = data2;

                data1 = SENSOR_SCENARIO_ID_NORMAL_PREVIEW;
                pSensorDrv->sendCommand(SENSOR_MAIN_2, CMD_SENSOR_GET_DEFAULT_FRAME_RATE_BY_SCENARIO, &data1, &data2);
                sensorStaticInfo[idx].previewFrameRate = data2;
                data1 = SENSOR_SCENARIO_ID_NORMAL_CAPTURE;
                pSensorDrv->sendCommand(SENSOR_MAIN_2, CMD_SENSOR_GET_DEFAULT_FRAME_RATE_BY_SCENARIO, &data1, &data2);
                sensorStaticInfo[idx].captureFrameRate = data2;
