 ...
 *  Static Metadata
 ******************************************************************************/
#define STATIC_METADATA_BEGIN(GROUP, SENSORNAME) \
    extern "C" \
    MBOOL \
    buildSensorStaticMetadata_##GROUP##_##SENSORNAME( \
        Info const&     rInfo, \
        IMetadata&      rMetadata \
    ) \
    {
...
#define PREFIX_FUNCTION_STATIC_METADATA "buildSensorStaticMetadata"
