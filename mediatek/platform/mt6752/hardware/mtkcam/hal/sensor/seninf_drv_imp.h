...
private:
    ...
    unsigned long *mpCSI2RxAnalog0RegAddr;    
    unsigned long *mpCSI2RxAnalog1RegAddr;    
    unsigned long *mpCSI2RxAnalog2RegAddr;    
    unsigned long *mpGpioHwRegAddr;
    unsigned long *mpPLLHwRegAddr;        //ToDo:remove
    unsigned long *mpIPllCon0RegAddr;     //ToDo:remove
    MINT32 mDevice;
    int tg1GrabWidth;
    int tg1GrabHeight;
    int tg2GrabWidth;
