...
#ifndef _MTK_HAL_CAMADAPTER_INC_CALLBACK_ZOOM_H_
#define _MTK_HAL_CAMADAPTER_INC_CALLBACK_ZOOM_H_
//
#include <Callback/ICallBackZoom.h>
/*******************************************************************************
*
*******************************************************************************/
class CallBackZoom : public ICallBackZoom
{
    public:
