...
)
{
    ...
    {
        MY_LOGD("onCB_RawImage : mEnRaw16CB == 1 ");
		...
		MyDngopImgInfo.BIT_NUM = 10;//rSensorParam.u4Bitdepth , buffer bit num
        ...
        else
        {
            ...
            pmem = mpCamMsgCbInfo->mRequestMemory(-1, u4DataSize, 1, NULL);
            if  ( pmem )
            {
