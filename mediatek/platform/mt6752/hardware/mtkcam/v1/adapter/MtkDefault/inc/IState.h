...
#ifndef _MTK_HAL_CAMADAPTER_MTKDEFAULT_INC_ISTATE_H_
#define _MTK_HAL_CAMADAPTER_MTKDEFAULT_INC_ISTATE_H_
//
...
public:     ////            Interfaces
    ...
    //
    virtual status_t        onHandlePreviewCapture()            = 0;
    virtual status_t        onHandlePreviewCaptureDone()        = 0;
    virtual status_t        onHandleCancelPreviewCapture()      = 0;    
    //
    virtual status_t        onHandleStartRecording()            = 0;
    virtual status_t        onHandleStopRecording()             = 0;
    virtual status_t        onHandleVideoSnapshot()             = 0;
    virtual status_t        onHandleVideoSnapshotDone()         = 0;
    virtual status_t        onHandleCancelVideoSnapshot()       = 0;
};
...
public:     ////            State Enum.
                            enum ENState
                            {
                                ...
                                eState_PreCapture,
                                eState_Capture,
                                eState_PreviewCapture,
                                eState_Recording,
                                eState_VideoSnapshot
                            };
...
public:     ////            Interfaces
    ...
    //
    virtual status_t        onStartRecording(IStateHandler* pHandler)       = 0;
    virtual status_t        onStopRecording(IStateHandler* pHandler)        = 0;
};
...
public:     ////            Instantiation.
    ...
    static  IStateManager*  createInstance();
...
#endif // _MTK_HAL_CAMADAPTER_MTKDEFAULT_INC_ISTATE_H_
