...
#ifndef _MTK_HAL_CAMADAPTER_MTKDEFAULT_INC_ZIPIMAGECALLBACKTHREAD_H_
#define _MTK_HAL_CAMADAPTER_MTKDEFAULT_INC_ZIPIMAGECALLBACKTHREAD_H_
//
#include <queue>
using namespace std;
//
...
#endif  //_MTK_HAL_CAMADAPTER_MTKDEFAULT_INC_ZIPIMAGECALLBACKTHREAD_H_
