...
#-----------------------------------------------------------
LOCAL_SRC_FILES += MtkStereoCamAdapter.cpp
LOCAL_SRC_FILES += MtkStereoCamAdapter.3A.cpp
LOCAL_SRC_FILES += MtkStereoCamAdapter.Preview.cpp
LOCAL_SRC_FILES += MtkStereoCamAdapter.Record.cpp
LOCAL_SRC_FILES += MtkStereoCamAdapter.Capture.cpp
LOCAL_SRC_FILES += MtkStereoCamAdapter.CaptureCallback.cpp
LOCAL_SRC_FILES += MtkStereoCamParameter.cpp
LOCAL_SRC_FILES += CaptureCmdQueThread.cpp
LOCAL_SRC_FILES += ZipImageCallbackThread.cpp
...
#-----------------------------------------------------------
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.camadapter.mtkstereo.state
#
LOCAL_STATIC_LIBRARIES += 

#-----------------------------------------------------------
LOCAL_MODULE := libcam.camadapter.mtkstereo
