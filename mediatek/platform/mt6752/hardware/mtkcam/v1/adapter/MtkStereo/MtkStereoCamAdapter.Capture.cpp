...
onCaptureThreadLoop()
{
    ...
    //
    {
        ...
        else
        {
            ...
            jpegParam.mi4JpsWidth               = 3840; // TODO: fix hardcode
            jpegParam.mi4JpsHeight              = 1080;
            //
            ...
            ret =   
                ...
                &&  pShot->sendCommand(eCmd_setPrvBufHdl, (uint32_t)mpDefaultBufHdl, sizeof(DefaultBufHandler))
                &&  ( setCapBufMgr ? 
                        pShot->sendCommand(eCmd_setCapBufMgr, (uint32_t)mpCapBufMgr, sizeof(CapBufMgr), (uint32_t)mpCapBufMgr_Main2) :
                        MTRUE )
