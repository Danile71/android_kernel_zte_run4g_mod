...
public:     ////    Interfaces.
    ...
    virtual bool    sendCommand(uint32_t const  cmd, uint32_t const  arg1, uint32_t const  arg2, uint32_t const  arg3 = 0);
...
public:  ////    Invoked by capture().
    ...
    virtual MBOOL   doFaceDetection(IImageBuffer* Srcbufinfo, int u4SrcWidth, int u4SrcHeight, int u4PostviewWidth, int u4PostviewHeight);
