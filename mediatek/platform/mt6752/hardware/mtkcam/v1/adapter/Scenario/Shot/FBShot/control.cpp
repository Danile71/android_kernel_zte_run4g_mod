...
InitialAlgorithm(MUINT32 srcWidth, MUINT32 srcHeight, MINT32 gBlurLevel, MINT32 FBTargetColor)
{
    ...
    FaceBeautyEnvInfo.WorkingBufAddr = (MUINT32) mpWorkingBuferr;
...
{
    NG_TRACE_BEGIN("STEP1");
    MBOOL   ret = MFALSE;
    IImageBuffer* tmpSTEP1s, *tmpSTEP1d;
