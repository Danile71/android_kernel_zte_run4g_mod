...
#ifndef _MTK_CAMERA_INCLUDE_CAMNODE_DEFAULT_BUF_HANDLER_H_
#define _MTK_CAMERA_INCLUDE_CAMNODE_DEFAULT_BUF_HANDLER_H_
//
...
class DefaultBufHandler : public ICamBufHandler
{
    public:     ////    Instantiation.
        static DefaultBufHandler*   createInstance(
                                        const char*                 userName,
    ...
    public:     ////    Info 
        ...
        virtual MBOOL   mapPort(
                            ...
                            MUINT32         timeout = 0, // unit is 10ms
