...
public:     ////                    Instantiation.
    ...
    ShotParam&                      operator=(ShotParam const& rhs)
                                    {
                                        miPictureFormat     = rhs.miPictureFormat;
                                        mi4PictureWidth     = rhs.mi4PictureWidth;
                                        mi4PictureHeight    = rhs.mi4PictureHeight;
                                        //
                                        miPostviewDisplayFormat = rhs.miPostviewDisplayFormat;
                                        miPostviewClientFormat  = rhs.miPostviewClientFormat;
                                        ...
                                        mu4Transform        = rhs.mu4Transform;
                                        //
                                        mu4MultiFrameBlending = rhs.mu4MultiFrameBlending;
                                        //
                                        ms8StereoFileName   = rhs.ms8StereoFileName;
                                        return  (*this);
                                    }
};
    ...
    JpegParam&                      operator=(JpegParam const& rhs)
                                    {
                                        ...
                                        //
                                        mi4JpsWidth         = rhs.mi4JpsWidth;
                                        mi4JpsHeight        = rhs.mi4JpsHeight;
                                        return  (*this);
                                    }
};
