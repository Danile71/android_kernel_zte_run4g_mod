...
//********************************************************************************************//
    unsigned int srcWidth=0,  srcHeight=0;
...
//********************************************************************************************//
    ...
    if(plane == 1)
    {
        ...
        mpFDHalObj->halFDDo(0, (MINT32)dst_rgb,  (MINT32)dst_y, rDoSD, Rotation_Info, (MINT32)rQueNode.getImgBuf()->getPhyAddr());
    }
    else
        mpFDHalObj->halFDDo(0, (MINT32)dst_rgb,  (MINT32)rQueNode.getImgBuf()->getVirAddr(), rDoSD, Rotation_Info, (MINT32)rQueNode.getImgBuf()->getPhyAddr());
    ...
    {
        if(plane == 1)
            mpGDHalObj->halGSDo((MINT32)dst_y, Rotation_Info);
        else
            mpGDHalObj->halGSDo((MINT32)rQueNode.getImgBuf()->getVirAddr(), Rotation_Info);
    }
...
{    
    ...
    plane = Format::queryPlaneCount(Format::queryImageFormat(a_rQueNode->getImgFormat().string()));
