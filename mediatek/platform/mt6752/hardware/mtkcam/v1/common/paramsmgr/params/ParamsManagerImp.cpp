...
#undef FALSE
    ...
    MINT32 i4VHDR = getVHdr();
    MY_LOGD("HDR Mode Values:%d", i4VHDR);

    if (1 == sensorStaticInfo.iHDRSupport || i4VHDR != 0)
        iHDRSupport |= 1;
    ...
    mParameters.set(MtkCameraParameters::KEY_ENG_VIDEO_HDR_SUPPORTED, iHDRSupport);
    //
    ...
    mParameters.set(MtkCameraParameters::KEY_ENG_VIDEO_RAW_DUMP_RESIZE_TO_4K2K_SUPPORTED, CameraParameters::FALSE);
    mParameters.set(MtkCameraParameters::KEY_ENG_VIDEO_RAW_DUMP_CROP_CENTER_2M_SUPPORTED, CameraParameters::FALSE);
