...
static void show_emi_mpu(void)
{
    ...
    pr_err("Region 1 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 1 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = (reg_value2 >> 6) & 0x7;
    d7 = (reg_value2 >> 9) & 0x7;
    pr_err("Region 2 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 2 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = ((reg_value2>>16) >> 6) & 0x7;
    d7 = ((reg_value2>>16) >> 9) & 0x7;
    pr_err("Region 3 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 3 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = (reg_value2 >> 6) & 0x7;
    d7 = (reg_value2 >> 9) & 0x7;
    pr_err("Region 4 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 4 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = ((reg_value2>>16) >> 6) & 0x7;
    d7 = ((reg_value2>>16) >> 9) & 0x7;
    pr_err("Region 5 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 5 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = (reg_value2 >> 6) & 0x7;
    d7 = (reg_value2 >> 9) & 0x7;
    pr_err("Region 6 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 6 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = ((reg_value2>>16) >> 6) & 0x7;
    d7 = ((reg_value2>>16) >> 9) & 0x7;
    pr_err("Region 7 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 7 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = (reg_value2 >> 6) & 0x7;
    d7 = (reg_value2 >> 9) & 0x7;
    pr_err("Region 8 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 8 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = ((reg_value2>>16) >> 6) & 0x7;
    d7 = ((reg_value2>>16) >> 9) & 0x7;
    pr_err("Region 9 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 9 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = (reg_value2 >> 6) & 0x7;
    d7 = (reg_value2 >> 9) & 0x7;
    pr_err("Region 10 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 10 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = ((reg_value2>>16) >> 6) & 0x7;
    d7 = ((reg_value2>>16) >> 9) & 0x7;
    pr_err("Region 11 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 11 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = (reg_value2 >> 6) & 0x7;
    d7 = (reg_value2 >> 9) & 0x7;
    pr_err("Region 12 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 12 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = ((reg_value2>>16) >> 6) & 0x7;
    d7 = ((reg_value2>>16) >> 9) & 0x7;
    pr_err("Region 13 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 13 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = (reg_value2 >> 6) & 0x7;
    d7 = (reg_value2 >> 9) & 0x7;
    pr_err("Region 14 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 14 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
    ...
    d6 = ((reg_value2>>16) >> 6) & 0x7;
    d7 = ((reg_value2>>16) >> 9) & 0x7;
    pr_err("Region 15 --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n", permission[d0],  permission[d1],  permission[d2], permission[d3]);
    pr_err("Region 15 --> d4 = %s, d5 = %s, d6 = %s, d7 = %s\n", permission[d4],  permission[d5],  permission[d6], permission[d7]);
...
{
    u32 dbg_s, dbg_t, dbg_r, dbg_p, dbg_pqry;
    ...
    printk(KERN_INFO "It's a MPU violation.\n");
    
    dbg_s = readl(IOMEM(EMI_MPUS));
    dbg_t = readl(IOMEM(EMI_MPUT));
    dbg_r = readl(IOMEM(EMI_MPUR));
    dbg_p = readl(IOMEM(EMI_MPUP));
	
    printk(KERN_ALERT "Clear status.\n");
    ...
    /*FIXME: skip ca53 violation to trigger root-cause KE*/
     if ((0 != dbg_s) && (__id2mst(master_ID) != MST_ID_APMCU_0) && (__id2mst(master_ID) != MST_ID_APMCU_1))
     {
        ...
        aee_kernel_exception("EMI MPU", "EMI MPU violation.\nEMI_MPUS = 0x%x, EMI_MPUT = 0x%x, EMI_MPUP = 0x%x, EMI_MPUR = 0x%x, module is %s.\n", dbg_s, dbg_t+emi_physical_offset, dbg_p, dbg_r, master_name);    
    }
#endif
...
void acquire_dram_setting(struct basic_dram_setting *pasrdpd)
{
    ...
    if(!emi_base) {
        printk(KERN_CRIT, "Cannot map EMI register region\n");
        return;
    }    
...
#if 0
    printk(KERN_CRIT "[EMI MPU] emi_physical_offset = 0x%x \n", emi_physical_offset);
    printk(KERN_CRIT "[EMI MPU] EMI_MPUA = 0x%x \n", readl(IOMEM(EMI_MPUA)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUB = 0x%x \n", readl(IOMEM(EMI_MPUB)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUC = 0x%x \n", readl(IOMEM(EMI_MPUC)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUD = 0x%x \n", readl(IOMEM(EMI_MPUD)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUE = 0x%x \n", readl(IOMEM(EMI_MPUE)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUF = 0x%x \n", readl(IOMEM(EMI_MPUF)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUG = 0x%x \n", readl(IOMEM(EMI_MPUG)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUH = 0x%x \n", readl(IOMEM(EMI_MPUH)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUA2 = 0x%x \n", readl(IOMEM(EMI_MPUA2)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUB2 = 0x%x \n", readl(IOMEM(EMI_MPUB2)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUC2 = 0x%x \n", readl(IOMEM(EMI_MPUC2)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUD2 = 0x%x \n", readl(IOMEM(EMI_MPUD2)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUE2 = 0x%x \n", readl(IOMEM(EMI_MPUE2)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUF2 = 0x%x \n", readl(IOMEM(EMI_MPUF2)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUG2 = 0x%x \n", readl(IOMEM(EMI_MPUG2)));
    printk(KERN_CRIT "[EMI MPU] EMI_MPUH2 = 0x%x \n", readl(IOMEM(EMI_MPUH2)));
#endif
...
static void emi_wp_clr_status(void)
{
    ...
    if (result)
        printk(KERN_CRIT "[EMI_WP] Clear WP status fail!!!!!!!!!!!!!!\n");
}
...
void emi_wp_get_status(void)
{
   ...
   if ((value & 0x80000000) == 0){
        printk(KERN_CRIT "[EMI_WP] No watch point hit\n");
        return;
    }

    master_ID = (value & EMI_WP_AXI_ID);
    printk(KERN_CRIT "[EMI_WP] Violation master ID is 0x%x.\n", master_ID);
    printk(KERN_CRIT "[EMI_WP] Violation Address is : 0x%X\n", readl(IOMEM(EMI_CHKER_ADR))+ emi_physical_offset);

    master_name = __id2name(master_ID);   
    printk(KERN_CRIT "[EMI_WP] EMI_CHKER = 0x%x, module is %s.\n", value, master_name);    

    value = readl(IOMEM(EMI_CHKER_TYPE));    
    printk(KERN_CRIT "[EMI_WP] Transaction Type is : %d beat, %d byte, %s burst type (0x%X)\n", (value & 0xF)+1, 1 << ((value >> 4) & 0x7), (value >> 7 & 1) ? "INCR": "WRAP", value);
...
static int emi_wp_set(unsigned int enable, unsigned int address, unsigned int range, unsigned int rw)
{
    if (address < emi_physical_offset){
        printk(KERN_CRIT "[EMI_WP] Address error, you can't set address less than 0x%X\n", emi_physical_offset);
        return -1;
    }
    if (range < 4 || range > 32){
        printk(KERN_CRIT "[EMI_WP] Range error, you can't set range less than 16 bytes and more than 4G bytes\n");
        return -1;
    }
...
ssize_t emi_wp_vio_store(struct device_driver *driver, const char *buf, size_t count)
{
    ...
    if ((strlen(buf) + 1) > MAX_EMI_MPU_STORE_CMD_LEN) {
        printk(KERN_CRIT "emi_wp_store command overflow.");
        return count;
    }
    printk(KERN_CRIT "emi_wp_store: %s\n", buf);
    ...
    end_addr = start_addr + (1 << range)     - 1;
        printk(KERN_CRIT "Set EMI_WP: address: 0x%x, range:%d, start addr: 0x%x, end addr: 0x%x,  rw: %d .\n", wp_addr, range, start_addr, end_addr, rw);
    }
        ...
        printk(KERN_CRIT "Unknown emi_wp command.\n");
    }
...
static int __init emi_mpu_mod_init(void)
{
    ...
    if(EMI_BASE_ADDR == NULL) {  
        ...
        if(node) {
            ...
            printk("get EMI_BASE_ADDR @ %p, irq = %d\n", EMI_BASE_ADDR, mpu_irq);
        } else {
    ...
    if (0 == enable_4G()) {
        ...
        printk(KERN_CRIT "[EMI MPU] Not 4G mode \n");
    }
    else {//enable 4G mode
        emi_physical_offset = 0;
        printk(KERN_CRIT "[EMI MPU] 4G mode \n");
    }
    ...
    if (ret) {
        printk(KERN_CRIT "Fail to create MPU config sysfs file.\n");
    }    
#ifdef ENABLE_EMI_CHKER    
    ...
    if (ret) {
        printk(KERN_CRIT "Fail to create pgt scan sysfs file.\n");
    }
#ifdef ENABLE_EMI_WATCH_POINT
    ret = driver_create_file(&emi_mpu_ctrl, &driver_attr_emi_wp_vio);
    if (ret) {
        printk(KERN_CRIT "Fail to create WP violation monitor sysfs file.\n");
    }
#endif    
#endif
