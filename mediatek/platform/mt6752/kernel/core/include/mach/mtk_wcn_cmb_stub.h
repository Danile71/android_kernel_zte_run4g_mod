...
//#define MTK_WCN_CMB_AUD_IO_NAMING_STYLE_2 1   // Audio GPIO naming style for 6592
#define MTK_WCN_CMB_AUD_IO_NAMING_STYLE_3 1   // Audio GPIO naming style for 6595
...
typedef unsigned int (*wmt_get_drv_status)(unsigned int);//for DVFS driver do 1v autok
#endif
