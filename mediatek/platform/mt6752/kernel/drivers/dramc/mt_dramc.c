...
#else
    //Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x028), Reg_Readl((CHA_DRAMCAO_BASE + 0x028)) & (~(0x01<<30)));     // cha DLLFRZ=0
    Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x1dc), Reg_Readl((CHA_DRAMCAO_BASE + 0x1dc)) & (~(0x01<<25)));       // DCMEN = 0
    Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x828), Reg_Readl((CHA_DRAMCAO_BASE + 0x828)) & (~(0x01<<25)));       // DCMEN = 0 (shuffle)      
    Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x044), Reg_Readl((CHA_DRAMCAO_BASE + 0x044)) | (0x01<<12));            // MANUDLLFRZ = 1
    Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x820), Reg_Readl((CHA_DRAMCAO_BASE + 0x820)) | (0x01<<12));            // MANUDLLFRZ = 1 (shuffle)    
    mcDELAY_US(4);
    u4HWTrackR0 = Reg_Readl((CHA_DRAMCNAO_BASE + 0x374));        // cha r0 
    u4HWTrackR1 = Reg_Readl((CHA_DRAMCNAO_BASE + 0x378));        // cha r1
    Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x044), Reg_Readl((CHA_DRAMCAO_BASE + 0x044)) & (~(0x01<<12)));       // MANUDLLFRZ = 0
    Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x820), Reg_Readl((CHA_DRAMCAO_BASE + 0x820)) & (~(0x01<<12)));       // MANUDLLFRZ = 0 (shuffle)
    Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x1dc), Reg_Readl((CHA_DRAMCAO_BASE + 0x1dc)) | (0x01<<25));            // DCMEN = 1
    Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x828), Reg_Readl((CHA_DRAMCAO_BASE + 0x828)) | (0x01<<25));            // DCMEN = 1 (shuffle)    
    //Reg_Sync_Writel((CHA_DRAMCAO_BASE + 0x028), Reg_Readl((CHA_DRAMCAO_BASE + 0x028)) |(0x01<<30));          // cha DLLFRZ=1
#endif		
	}
#endif
