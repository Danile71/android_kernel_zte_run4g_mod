...
#if 0
/**
 * @brief Initialize gpu_utilization debugfs entry
 */
mali_error kbasep_gpu_utilization_debugfs_init(struct kbase_device *kbdev);

/**
 * @brief Terminate gpu_utilization debugfs entry
 */
void kbasep_gpu_utilization_debugfs_term(struct kbase_device *kbdev);
#endif /// #if 0
...
kbase_pm_dvfs_action mtk_get_dvfs_action(void);
