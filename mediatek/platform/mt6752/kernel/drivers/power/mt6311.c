...
kal_uint32 mt6311_read_byte(kal_uint8 cmd, kal_uint8 *returnData)
{
    ...
    if (ret < 0)
    {
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_read_byte] ret=%d\n", ret);
...
kal_uint32 mt6311_write_byte(kal_uint8 cmd, kal_uint8 writeData)
{
    ...
    new_client->ext_flag=((new_client->ext_flag ) & I2C_MASK_FLAG ) | I2C_PUSHPULL_FLAG;

    ret = i2c_master_send(new_client, write_data, 2);
    if (ret < 0)
    {
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_write_byte] ret=%d\n", ret);
...
{
#if 0
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_read_interface] HW no mt6311\n");
    *val = 0;
    return 1;
#else
    ...
    //xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_read_interface] Reg[%x]=0x%x\n", RegNum, mt6311_reg);

    mt6311_reg &= (MASK << SHIFT);
    *val = (mt6311_reg >> SHIFT);

    //xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_read_interface] val=0x%x\n", *val);
...
{
#if 0
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_config_interface] HW no mt6311\n");
    return 1;
#else
    kal_uint8 mt6311_reg = 0;
    kal_uint32 ret = 0;
    ...
    ret = mt6311_read_byte(RegNum, &mt6311_reg);
    //xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_config_interface] Reg[%x]=0x%x\n", RegNum, mt6311_reg);

    mt6311_reg &= ~(MASK << SHIFT);
    mt6311_reg |= (val << SHIFT);

    ret = mt6311_write_byte(RegNum, mt6311_reg);
    //xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_config_interface] write Reg[%x]=0x%x\n", RegNum, mt6311_reg);

    // Check
    //ret = mt6311_read_byte(RegNum, &mt6311_reg);
    //xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_config_interface] Check Reg[%x]=0x%x\n", RegNum, mt6311_reg);
...
kal_uint32 update_mt6311_chip_id(void)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[update_mt6311_chip_id] id_l=0x%x, id_r=0x%x, id=0x%x\n", id_l, id_r, id);
...
kal_uint32 mt6311_get_chip_id(void)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_get_chip_id] g_mt6311_cid=0x%x\n", g_mt6311_cid);
...
void mt6311_hw_init(void)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_hw_init] 20140513, CC Lee\n");
    ...
    {
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_hw_init] 6311 PMIC Chip = 0x%x\n",mt6311_get_chip_id());
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_hw_init] 2014-11-3\n");
        ...
        ret = mt6311_config_interface(0x15,0x1,0x1,5); // [5:5]: RG_WDTRSTB_EN; CC, initial WDRSTB setting.
        ret = mt6311_config_interface(0x93,0x1,0x1,0); // [0:0]: VDVFS11_VSLEEP_EN; Johnson, sleep mode for HW/SW control, before sleep HW voltage setting. (TOP control)
        ret = mt6311_config_interface(0x6A,0x2,0x7,0); // [2:0]: QI_VDVFS11_VSLEEP; Setting by low power owner=0.7V, Johnson (000=0.6V, 001=0.7V)
        ret = mt6311_config_interface(0x8B,0x1,0x7F,0); // [6:0]: VDVFS11_SFCHG_RRATE; Johnson, for DVFS slew rate rising=0.67us
        ret = mt6311_config_interface(0x8C,0x5,0x7F,0); // [6:0]: VDVFS11_SFCHG_FRATE; Johnson, for DVFS slew rate, falling 2.0us
        ret = mt6311_config_interface(0x94,0x3,0x3,0); // [1:0]: VDVFS11_TRANS_TD; Johnson, for DVFS sof change, falling 50us
        ret = mt6311_config_interface(0x94,0x1,0x3,4); // [5:4]: VDVFS11_TRANS_CTRL; Johnson, for DVFS sof change, falling only
        ret = mt6311_config_interface(0x88,0x0,0x1,1); // [1:1]: VDVFS11_VOSEL_CTRL; Johnson, Sleep SW control from SPM, after Vosel_on(sequence)
        ret = mt6311_config_interface(0x88,0x0,0x1,0); // [0:0]: VDVFS11_EN_CTRL; Johnson, Sleep SW control from SPM, after Vosel_on (sequence)
        ...
        #if 1
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311] [0x%x]=0x%x\n", 0x04, mt6311_get_reg_value(0x04));
    ...
    {
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_hw_init] Unknown PMIC Chip (0x%x)\n",mt6311_get_chip_id());
    }
    //--------------------------------------------------------
}
...
void mt6311_hw_component_detect(void)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_hw_component_detect] exist=%d\n", g_mt6311_hw_exist);
}

int is_mt6311_sw_ready(void)
{
    //xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC","g_mt6311_driver_ready=%d\n", g_mt6311_driver_ready);
...
{
    //xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC","g_mt6311_hw_exist=%d\n", g_mt6311_hw_exist);
...
{
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[wake_up_pmic_mt6311]\n");
...
{
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt_pmic_eint_irq_mt6311] receive interrupt\n");
    wake_up_pmic_mt6311();
    return ;
}
...
{
    //kal_uint32 ret=0;
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_lbat_min_int_handler]....\n");
...
{
    //kal_uint32 ret=0;
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_lbat_max_int_handler]....\n");
...
{
	thr_l_int_status=0;
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_clr_thr_l_int_status]....\n");
}

void mt6311_clr_thr_h_int_status(void)
{
	thr_h_int_status=0;
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_clr_thr_h_int_status]....\n");
}
kal_uint32 mt6311_get_thr_l_int_status(void)
{
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_get_thr_l_int_status]....\n");
...
{
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_get_thr_h_int_status]....\n");
...
void mt6311_thr_l_int_handler(void)
{
    //kal_uint32 ret=0;
    thr_l_int_status =1;
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_thr_l_int_handler]....\n");
    //return thr_l_int_status;
...
void mt6311_thr_h_int_handler(void)
{
    //kal_uint32 ret=0;
    thr_h_int_status =1;
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_thr_h_int_handler]....\n");
...
{
    //kal_uint32 ret=0;
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6311_buck_oc_int_handler]....\n");
...
static void mt6311_int_handler(void)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[MT6311_INT] mt6311_int_status_val_0=0x%x\n", mt6311_int_status_val_0);
...
static int pmic_thread_kthread_mt6311(void *x)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[MT6311_INT] enter\n");
    ...
    while (1) {
        ...
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[MT6311_INT] after ,mt6311_int_status_val_0=0x%x\n", mt6311_int_status_val_0);
...
void mt6311_eint_setting(void)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[CUST_EINT] CUST_EINT_MT_PMIC_MT6311_NUM=%d\n", g_eint_pmic_mt6311_num);
...
void mt6311_eint_init(void)
{
    //---------------------
#if defined(CONFIG_MTK_FPGA)
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[MT6311_EINT] disable when CONFIG_MTK_FPGA\n");
#else
    ...
    if (IS_ERR(pmic_6311_thread_handle))
    {
        ...
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[MT6311_EINT] creation fails\n");
    }
    else
    {
        wake_up_process(pmic_6311_thread_handle);
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[MT6311_EINT] kthread_create Done\n");
    }

    //mt6311_eint_setting();
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[MT6311_EINT] TBD\n");
#endif
...
void cpu_low_power_setting(void)
{
        ...
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[cpu_low_power_setting] define PMIC_VDVFS_CUST_ENABLE\n");
    #else
        //turn off mt6325 VPROC
        pmic_config_interface(0x04B4,0x0,0x1,0); // [0:0]: VDVFS11_EN
        pmic_config_interface(0x04C6,0x0,0x1,11); // [11:11]: VDVFS11_VSLEEP_SEL
        pmic_config_interface(0x04C6,0x1,0x1,10); // [10:10]: VDVFS11_R2R_PDN
        pmic_config_interface(0x04C6,0x0,0x1,8); // [8:8]: VDVFS11_VSLEEP_EN
        pmic_config_interface(0x04DA,0x0,0x1,0); // [0:0]: VDVFS12_EN
        ...
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[cpu_low_power_setting] [0x%x]=0x%x,[0x%x]=0x%x,[0x%x]=0x%x,[0x%x]=0x%x\n",
            0x04B4, upmu_get_reg_value(0x04B4),
            0x04C6, upmu_get_reg_value(0x04C6),
            0x04DA, upmu_get_reg_value(0x04DA),
            0x04EC, upmu_get_reg_value(0x04EC)
            );
    #endif
}
...
static int mt6311_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_driver_probe] \n");
    ...
    if(g_mt6311_hw_exist==1)
    {
        ...
        #if 1
        cpu_low_power_setting();
        #endif
    }
    g_mt6311_driver_ready=1;

    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_driver_probe] g_mt6311_hw_exist=%d, g_mt6311_driver_ready=%d\n",
    ...
    if(g_mt6311_hw_exist==0)
    {
        ...
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_driver_probe] return err\n");
        return err;
    }
...
{
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[show_mt6311_access] 0x%x\n", g_reg_value_mt6311);
...
static ssize_t store_mt6311_access(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[store_mt6311_access] \n");

    if(buf != NULL && size != 0)
    {
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[store_mt6311_access] buf is %s and size is %d \n",buf,size);
        reg_address = simple_strtoul(buf,&pvalue,16);

        if(size > 4)
        {
            reg_value = simple_strtoul((pvalue+1),NULL,16);
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[store_mt6311_access] write mt6311 reg 0x%x with value 0x%x !\n",reg_address,reg_value);
        ...
        else
        {
            ...
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[store_mt6311_access] read mt6311 reg 0x%x with value 0x%x !\n",reg_address,g_reg_value_mt6311);
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[store_mt6311_access] Please use \"cat mt6311_access\" to get value\r\n");
        }
    }
    return size;
}
...
{
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[show_mt6311_vosel_pin] g_mt6311_vosel_pin=%d\n", g_mt6311_vosel_pin);
    return sprintf(buf, "%u\n", g_mt6311_vosel_pin);
}
static ssize_t store_mt6311_vosel_pin(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[store_mt6311_vosel_pin] \n");

    val = simple_strtoul(buf,&pvalue,16);
    g_mt6311_vosel_pin = val;

    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[store_mt6311_vosel_pin] g_mt6311_vosel_pin(%d)\n", g_mt6311_vosel_pin);
...
static int mt6311_user_space_probe(struct platform_device *dev)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","******** mt6311_user_space_probe!! ********\n" );
...
static int __init mt6311_init(void)
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_init] mt6311_AUTO_DETECT_DISABLE\n");
    g_mt6311_hw_exist=0;
    g_mt6311_driver_ready=1;
    ...
    {
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_init] init start. ch=%d!!\n", mt6311_BUSNUM);

        i2c_register_board_info(mt6311_BUSNUM, &i2c_mt6311, 1);

        if(i2c_add_driver(&mt6311_driver)!=0)
        {
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_init] failed to register mt6311 i2c driver.\n");
        }
        else
        {
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_init] Success to register mt6311 i2c driver.\n");
        }

        // mt6311 user space access interface
        ret = platform_device_register(&mt6311_user_space_device);
        if (ret) {
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","****[mt6311_init] Unable to device register(%d)\n", ret);
            return ret;
        }
        ret = platform_driver_register(&mt6311_user_space_driver);
        if (ret) {
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","****[mt6311_init] Unable to register driver (%d)\n", ret);
            return ret;
        }
    }
    #else
    {
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_init] DCT no define EXT BUCK\n");
        g_mt6311_hw_exist=0;
        g_mt6311_driver_ready=1;
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[mt6311_init] g_mt6311_hw_exist=%d, g_mt6311_driver_ready=%d\n",
            g_mt6311_hw_exist, g_mt6311_driver_ready);
    }
    #endif
