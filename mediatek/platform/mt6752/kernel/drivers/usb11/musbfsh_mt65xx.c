...
void usb11_hs_internalR_setting(void)
{
	u32 dev_info,data;
	
  	dev_info = get_devinfo_with_index(16);
	dev_info = (dev_info >> 24) & 0x1F;
	data = USB11PHY_READ32(0x04);
	data = (data & ~(0x00F80000)) | (dev_info << 19);
	USB11PHY_WRITE32(0x04,data);
}
void usb11_hs_slew_rate_cal(void){
