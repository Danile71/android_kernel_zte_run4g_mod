...
#define SDC_CFG_POPENCNT        (0xff << 12)    /* RW */
...
#define MSDC_EMMC50_CFG1_PSHCNT          (0x3  << 24)
#define MSDC_EMMC50_CFG1_PSHPSSEL        (0xff << 27)
#define MSDC_EMMC50_CFG1_DSCFG           (0xff << 28)
#define MSDC_EMMC50_CFG1_SPARE1          (0xff << 29)
 ...
 */
#define IO_CONFIG_LEFT_base         (0x10002000)    /* IO Config left side base     */
#define IO_CONFIG_BOTTOM_base       (0x10002400)    /* IO Config bottom side base   */
#define IO_CONFIG_RIGHT_base        (0x10002800)    /* IO Config right side base    */
#define IO_CONFIG_TOP_base          (0x10002C00)    /* IO Config top side base      */
...
extern void msdc_emmc_hard_reset(void);
