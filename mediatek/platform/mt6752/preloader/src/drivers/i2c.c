...
{
	/* Open SCP I2C clock */
	DRV_SetReg32(SCP_CLK_CG_CTRL, I2C_BCLK_CG_BIT | I2C_MCLK_CG_BIT);

	/* Set GPIO for I2C2 */
	#if defined(GPIO_I2C2_SCA_PIN) && defined(GPIO_I2C2_SCA_PIN_M_SCL)
	mt_set_gpio_mode(GPIO_I2C2_SCA_PIN, GPIO_I2C2_SCA_PIN_M_SCL);
	mt_set_gpio_pull_enable(GPIO_I2C2_SCA_PIN, GPIO_PULL_ENABLE);
	mt_set_gpio_pull_select(GPIO_I2C2_SCA_PIN, GPIO_PULL_UP);
	#endif

	#if defined(GPIO_I2C2_SDA_PIN) && defined(GPIO_I2C2_SDA_PIN_M_SDA)
	mt_set_gpio_mode(GPIO_I2C2_SDA_PIN, GPIO_I2C2_SDA_PIN_M_SDA);
	mt_set_gpio_pull_enable(GPIO_I2C2_SDA_PIN, GPIO_PULL_ENABLE);
	mt_set_gpio_pull_select(GPIO_I2C2_SDA_PIN, GPIO_PULL_UP);
	#endif

	#if defined(GPIO_I2C3_SCA_PIN) && defined(GPIO_I2C3_SCA_PIN_M_SCL)
	mt_set_gpio_mode(GPIO_I2C3_SCA_PIN, GPIO_I2C3_SCA_PIN_M_SCL);
	#endif

	#if defined(GPIO_I2C3_SDA_PIN) && defined(GPIO_I2C3_SDA_PIN_M_SDA)
	mt_set_gpio_mode(GPIO_I2C3_SDA_PIN, GPIO_I2C3_SDA_PIN_M_SDA);
	#endif
