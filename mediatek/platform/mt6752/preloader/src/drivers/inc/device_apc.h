...
#define MD1_AHB_0                       (0x3 << 30)//0   
#define MD1_AXI_1                       (0x3 << 0)//1   
#define MD1_AXI_2                       (0x3 << 2)//1
#define MD2_AHB_0                       (0x3 << 6)//1  
#define MD2_AXI_1                       (0x3 << 8) //1     
#define MD2_AXI_2                       (0x3 << 10)//1
#define CONNSYS                         (0x3<<12)//1
#define MD32                            (0x3 << 22)//0
#define MFG                             (0x7 << 18)//1
