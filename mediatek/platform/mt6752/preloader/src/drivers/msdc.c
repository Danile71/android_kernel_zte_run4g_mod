...
static void msdc_dump_clock_sts(struct mmc_host *host)
{
    ...
    printf(" pdn, mux[0x10000070][bit23, 16~19 for msdc0, bit31, 16~19 for msdc1]=0x%x\n", MSDC_READ32(0x10000070));
  #endif
}
...
static void msdc_dump_ldo_sts(struct mmc_host *host)
{
    ...
    printf(" VEMC_EN[0x0A18][bit1 should be 1]=0x%d, VEMC_VOL[0x0A4A][bit9 should be 1]=0x%x\n", ldo_en, ldo_vol);
  #endif
}
#endif
...
void msdc_set_smt(struct mmc_host *host, int set_smt)
{
    switch(host->id){
        ...
        case 2:
            if (set_smt)
                MSDC_WRITE32(MSDC2_SMT_CFG_SET, MSDC2_SMT_ALL_MASK);
            else
                MSDC_WRITE32(MSDC2_SMT_CFG_CLR, MSDC2_SMT_ALL_MASK);
            break;
...
void msdc_set_sr(struct mmc_host *host, int clk, int cmd, int dat, int rst, int ds)
{
    switch(host->id){
        ...
        case 2:
            MSDC_SET_FIELD(MSDC2_SR_CFG_BASE, MSDC2_SR_ALL_MASK, clk);
            break;
...
void msdc_set_rdtdsel(struct mmc_host *host, bool sd_18)
{
    switch(host->id){
        case 0:
            MSDC_SET_FIELD(MSDC0_TDSEL_BASE, MSDC0_TDSEL_ALL_MASK ,0x0);
        ...
        case 2:
            if (sd_18){
                MSDC_SET_FIELD(MSDC2_TDSEL_BASE, MSDC2_TDSEL_ALL_MASK ,0xA);
                MSDC_SET_FIELD(MSDC2_RDSEL_BASE, MSDC2_RDSEL_ALL_MASK ,0x0);
            } else{
                MSDC_SET_FIELD(MSDC2_TDSEL_BASE, MSDC2_TDSEL_ALL_MASK ,0xA);
                MSDC_SET_FIELD(MSDC2_RDSEL_BASE, MSDC2_RDSEL_ALL_MASK ,0xC);
            }
            break;
...
static void msdc_pin_pnul(struct mmc_host *host, int mode)
{
    switch(host->id){
        case 0:
            if (!mode)
                MSDC_WRITE32(MSDC0_PULL_EN_CFG_CLR, MSDC0_PULL_EN_CMD_DAT_MASK);
            break;

        case 1:
            if (!mode)
                MSDC_WRITE32(MSDC1_PULL_EN_CFG_CLR, MSDC1_PULL_EN_CMD_DAT_MASK);
            break;

        case 2:
            if (!mode)
                MSDC_WRITE32(MSDC2_PULL_EN_CFG_CLR, MSDC2_PULL_EN_CMD_DAT_MASK);
            break;
    ...
    switch(host->id){
        case 0:
            if (mode) {
                ...
                MSDC_SET_FIELD(MSDC0_PULL_SEL_CFG_BASE, MSDC0_PULL_SEL_ALL_MASK, 0x7FE);
            } else {
                MSDC_WRITE32(MSDC0_PULL_SEL_CFG_CLR, MSDC0_PULL_SEL_ALL_MASK);
            }
            ...
            MSDC_WRITE32(MSDC0_PULL_EN_CFG_SET, 0xC013FE);
            break;

        case 1:
            if (mode) {
                MSDC_SET_FIELD(MSDC1_PULL_SEL_CFG_BASE, MSDC1_PULL_SEL_ALL_MASK, 0x3E);
            } else {
                MSDC_WRITE32(MSDC1_PULL_SEL_CFG_CLR, MSDC1_PULL_SEL_ALL_MASK);
            }
            //Write to MSDC1_PULL_EN_CFG_SET directly
            MSDC_WRITE32(MSDC1_PULL_EN_CFG_SET, 0xFC0);
            break;

        case 2:
            if (mode) {
                MSDC_SET_FIELD(MSDC2_PULL_SEL_CFG_BASE, MSDC2_PULL_SEL_ALL_MASK, 0x3E);
            } else {
                MSDC_WRITE32(MSDC2_PULL_SEL_CFG_CLR, MSDC2_PULL_SEL_ALL_MASK);
            }
            //Write to MSDC2_PULL_EN_CFG_SET directly
            MSDC_WRITE32(MSDC2_PULL_EN_CFG_SET, 0xFC0);
            break;

        case 3:
            if (mode) {
                //CLK pull down with 50K, CMD/DATs pull up with 10K
                MSDC_SET_FIELD(MSDC3_PULL_SEL_CFG_BASE, MSDC3_PULL_SEL_ALL_MASK, 0x3E);
                MSDC_WRITE32(MSDC3_PULL_EN_CFG_SET, 0x7E);
            } else {
                //All pull down with 50K
                MSDC_WRITE32(MSDC3_PULL_SEL_CFG_CLR, MSDC3_PULL_SEL_ALL_MASK);
                MSDC_WRITE32(MSDC3_PULL_EN_CFG_SET, 0xFC0);
            }
            break;
...
void msdc_set_driving(struct mmc_host *host, struct msdc_cust *msdc_cap, bool sd_18)
{
    switch (host->id){
        case 0:
            if (sd_18) {
                MSDC_SET_FIELD(MSDC0_DRVING_BASE, MSDC0_CLK_DRVING, msdc_cap->clk_18v_drv);
                MSDC_SET_FIELD(MSDC0_DRVING_BASE, MSDC0_CMD_RST_DSL_DRVING, msdc_cap->cmd_18v_drv);
                MSDC_SET_FIELD(MSDC0_DRVING_BASE, MSDC0_DAT0_7_DRVING, msdc_cap->dat_18v_drv);
            } else {
                MSDC_SET_FIELD(MSDC0_DRVING_BASE, MSDC0_CLK_DRVING, msdc_cap->clk_drv);
                MSDC_SET_FIELD(MSDC0_DRVING_BASE, MSDC0_CMD_RST_DSL_DRVING, msdc_cap->cmd_drv);
                MSDC_SET_FIELD(MSDC0_DRVING_BASE, MSDC0_DAT0_7_DRVING, msdc_cap->dat_drv);
            }
            break;
        ...
        case 1:
            if (sd_18) {
                ...
                MSDC_SET_FIELD(MSDC1_DRVING_BASE, MSDC1_DAT0_3_DRVING, msdc_cap->dat_18v_drv);
            } else {
                ...
                MSDC_SET_FIELD(MSDC1_DRVING_BASE, MSDC1_DAT0_3_DRVING, msdc_cap->dat_drv);
            }
            break;

        case 2:
            if (sd_18) {
                MSDC_SET_FIELD(MSDC2_DRVING_BASE, MSDC2_CLK_DRVING, msdc_cap->clk_18v_drv);
                MSDC_SET_FIELD(MSDC2_DRVING_BASE, MSDC2_CMD_DRVING, msdc_cap->cmd_18v_drv);
                MSDC_SET_FIELD(MSDC2_DRVING_BASE, MSDC2_DAT0_3_DRVING, msdc_cap->dat_18v_drv);
            } else {
                MSDC_SET_FIELD(MSDC2_DRVING_BASE, MSDC2_CLK_DRVING, msdc_cap->clk_drv);
                MSDC_SET_FIELD(MSDC2_DRVING_BASE, MSDC2_CMD_DRVING, msdc_cap->cmd_drv);
                MSDC_SET_FIELD(MSDC2_DRVING_BASE, MSDC2_DAT0_3_DRVING, msdc_cap->dat_drv);
            }
            break;
...
void msdc_get_driving(struct mmc_host *host,struct msdc_cust *msdc_cap, bool sd_18)
{
    switch(host->id){
        case 0:
            if (sd_18) {
                MSDC_GET_FIELD(MSDC0_DRVING_BASE, MSDC0_CLK_DRVING, msdc_cap->clk_18v_drv);
                MSDC_GET_FIELD(MSDC0_DRVING_BASE, MSDC0_CMD_RST_DSL_DRVING, msdc_cap->cmd_18v_drv);
                MSDC_GET_FIELD(MSDC0_DRVING_BASE, MSDC0_DAT0_7_DRVING, msdc_cap->dat_18v_drv);
            } else {
                MSDC_GET_FIELD(MSDC0_DRVING_BASE, MSDC0_CLK_DRVING, msdc_cap->clk_drv);
                MSDC_GET_FIELD(MSDC0_DRVING_BASE, MSDC0_CMD_RST_DSL_DRVING, msdc_cap->cmd_drv);
                MSDC_GET_FIELD(MSDC0_DRVING_BASE, MSDC0_DAT0_7_DRVING, msdc_cap->dat_drv);
            }
            break;
        ...
        case 1:
            if (sd_18) {
                ...
                MSDC_GET_FIELD(MSDC1_DRVING_BASE, MSDC1_DAT0_3_DRVING, msdc_cap->dat_18v_drv);
            } else {
                ...
                MSDC_GET_FIELD(MSDC1_DRVING_BASE, MSDC1_DAT0_3_DRVING, msdc_cap->dat_drv);
            }
            break;

        case 2:
            if (sd_18) {
                MSDC_GET_FIELD(MSDC2_DRVING_BASE, MSDC2_CLK_DRVING, msdc_cap->clk_18v_drv);
                MSDC_GET_FIELD(MSDC2_DRVING_BASE, MSDC2_CMD_DRVING, msdc_cap->cmd_18v_drv);
                MSDC_GET_FIELD(MSDC2_DRVING_BASE, MSDC2_DAT0_3_DRVING, msdc_cap->dat_18v_drv);
            } else {
                MSDC_GET_FIELD(MSDC2_DRVING_BASE, MSDC2_CLK_DRVING, msdc_cap->clk_drv);
                MSDC_GET_FIELD(MSDC2_DRVING_BASE, MSDC2_CMD_DRVING, msdc_cap->cmd_drv);
                MSDC_GET_FIELD(MSDC2_DRVING_BASE, MSDC2_DAT0_3_DRVING, msdc_cap->dat_drv);
            }
            break;
...
void msdc_set_timeout(struct mmc_host *host, u64 ns, u32 clks)
{
    ...
    MSG(OPS, "[SD%d] Set read data timeout: %dns %dclks -> %d x 1048576 cycles, mode:%d, clk_freq=%dKHz\n",
...
void msdc_config_clock(struct mmc_host *host, int ddr, u32 hz, u32 hs_timing)
{
    ...
    MSDC_SET_FIELD(MSDC_CFG, MSDC_CFG_CKMOD_HS400 | MSDC_CFG_CKMOD |
                   MSDC_CFG_CKDIV, (hs400_src << 10) | (mode << 8) | div);
...
void msdc_emmc_hard_reset(void)
{
    u32 base = MSDC0_BASE;
...
void msdc_set_pad_init(struct mmc_host *host)
{
    switch (host->id) {
        ...
        case 0:
             ...
             */
            MSDC_SET_FIELD(MSDC0_PULL_EN_CFG_BASE, MSDC0_PULL_EN_ALL_MASK, 0xC013FE);
             ...
             */
            MSDC_SET_FIELD(MSDC0_GPIO_MODE0_ADDR,
             ...
             */
            MSDC_SET_FIELD(MSDC0_GPIO_MODE1_ADDR,
        ...
        case 1:
             ...
             */
            MSDC_SET_FIELD(MSDC1_GPIO_MODE1_ADDR,
             ...
             */
            MSDC_SET_FIELD(MSDC1_GPIO_MODE2_ADDR, MSDC1_DAT2_PINMUX_BITS | MSDC1_DAT3_PINMUX_BITS, 0x11);

            /*
             * Set CLK pinmux after all other pinmux have been set
             * set gpio to msdc mode. (clk in GPIO_MODE1)
             */
            MSDC_SET_FIELD(MSDC1_GPIO_MODE1_ADDR, MSDC1_CLK_PINMUX_BITS, 0x1);
            break;
        ...
        case 2:
             ...
             * set pull enable.
             */
            MSDC_WRITE32(MSDC2_PULL_EN_CFG_SET,
             ...
             * set pull_sel to pull up cmd/dat. (clk default low).
             */
            MSDC_WRITE32(MSDC2_PULL_SEL_CFG_CLR, MSDC2_CLK_PULL_SEL);
            MSDC_WRITE32(MSDC2_PULL_SEL_CFG_SET,
                    MSDC2_CMD_PULL_SEL |
                    MSDC2_DAT0_PULL_SEL | MSDC2_DAT1_PULL_SEL | MSDC2_DAT2_PULL_SEL | MSDC2_DAT3_PULL_SEL);

            /*
             * set gpio to msdc mode. (clk/cmd/dat0/dat1 in GPIO_MODE8)
             */
            MSDC_SET_FIELD(MSDC2_GPIO_MODE8_ADDR,
                    MSDC2_CMD_PINMUX_BITS |
                    MSDC2_DAT0_PINMUX_BITS | MSDC2_DAT1_PINMUX_BITS, 0x222);

            /*
             * set gpio to msdc mode. (dat2/dat3 in GPIO_MODE9)
             */
            MSDC_SET_FIELD(MSDC2_GPIO_MODE9_ADDR, MSDC2_DAT2_PINMUX_BITS | MSDC2_DAT3_PINMUX_BITS, 0x22);

            /*
             * Set CLK pinmux after all other pinmux have been set
             * set gpio to msdc mode. (clk in GPIO_MODE8)
             */
            MSDC_SET_FIELD(MSDC2_GPIO_MODE8_ADDR, MSDC2_CLK_PINMUX_BITS, 0x2);
            break;
        ...
        case 3:
             ...
             * set pull enable.
             */
            MSDC_WRITE32(MSDC3_PULL_EN_CFG_SET,
             ...
             * set pull_sel to pull up cmd/dat. (clk default low).
             */
            MSDC_WRITE32(MSDC3_PULL_SEL_CFG_CLR, MSDC3_CLK_PULL_SEL);
            MSDC_WRITE32(MSDC3_PULL_SEL_CFG_SET,
                    MSDC3_CMD_PULL_SEL |
                    MSDC3_DAT0_PULL_SEL | MSDC3_DAT1_PULL_SEL | MSDC3_DAT2_PULL_SEL | MSDC3_DAT3_PULL_SEL);

            /*
             * set gpio to msdc mode. (clk/cmd/dat0/dat1/dat2/date3 in GPIO_MODE12)
             */
            MSDC_SET_FIELD(MSDC3_GPIO_MODE12_ADDR,
                    MSDC3_CMD_PINMUX_BITS |
                    MSDC3_DAT0_PINMUX_BITS | MSDC3_DAT1_PINMUX_BITS |
                    MSDC3_DAT2_PINMUX_BITS | MSDC3_DAT3_PINMUX_BITS, 0x11111);

            /*
             * Set CLK pinmux after all other pinmux have been set
             * set gpio to msdc mode. (clk in GPIO_MODE8)
             */
            MSDC_SET_FIELD(MSDC3_GPIO_MODE12_ADDR, MSDC3_CLK_PINMUX_BITS, 0x1);
            break;
