...
/******************************************************************************
 * pmic_wrap_init.c - MTK PMIC Wrapper Driver
 *
...
S32 pwrap_init ( void )
{
  ...
  //###############################
  mt_set_gpio_mode(GPIO40 | 0x80000000, GPIO_MODE_01);  // MI
  mt_set_gpio_mode(GPIO41 | 0x80000000, GPIO_MODE_01);  // MO
  mt_set_gpio_mode(GPIO38 | 0x80000000, GPIO_MODE_01);  // CK
  mt_set_gpio_mode(GPIO39 | 0x80000000, GPIO_MODE_01);  // CS
 ...
 //check Wtiet test default value
  ...
  //###############################
	...
	WRAP_WR32(PMIC_WRAP_HARB_HPRIO, MDINF | WACS0 | DVFSINF
					| WACS2 | WACS_P2P);
...
#ifdef SLV_6325  
    //###############################
    // 6325 PMIC SLV Setting 
    // To be accessed in suspend mode
    //###############################
    pwrap_write_nochk(MT6325_RG_SPI_CON, 0x1);
#endif
  return 0;
}
